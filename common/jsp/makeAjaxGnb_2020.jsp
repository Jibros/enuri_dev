...
*/
	...
	if(stype.equals("banner")){
		URL topMenuUrl = new URL("http://"+serverIp+"/common/jsp/Ajax_Gnb_Src_2021.jsp?stype=banner");
	    ...
	    for(int i=0; i<gnb_list_0.length; i++){
			topMenuUrl = new URL("http://"+serverIp+"/common/jsp/Ajax_Gnb_Src_2021.jsp?g_seq=" + g_seq[i]);
			...
			strTopMenuFileName = "/was/lena/1.3/depot/lena-application/ROOT/common/jsp/CateList_2020_" + i + ".html";
			...
			uploadFile("CateList_2020_" + i + ".html","/was/lena/1.3/depot/lena-application/ROOT/common/jsp/");
	    }

        topMenuUrl = new URL("http://"+serverIp+"/common/jsp/Ajax_Gnb_Src_2021.jsp?stype=allCate");
        ...
        strTopMenuFileName = "/was/lena/1.3/depot/lena-application/ROOT/common/jsp/AllCateList_2020.html";
        topMenuStream = new FileOutputStream(strTopMenuFileName, false);
        ...
        uploadFile("AllCateList_2020.html","/was/lena/1.3/depot/lena-application/ROOT/common/jsp/");
