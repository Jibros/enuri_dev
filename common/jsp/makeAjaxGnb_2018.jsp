...
<%@ page import="com.enuri.bean.main.GNB_List_Proc3"%>
<%
	...
	if(stype.equals("banner")){
		URL topMenuUrl = new URL("http://"+request.getServerName()+"/common/jsp/Ajax_Gnb_Src_2018.jsp?stype=banner");
		...
		uploadFile("nGnbBanner_data_2018.json","/was/lena/1.3/depot/lena-application/ROOT/common/js/eb/");

		out.println("<script>alert('정상반영되었습니다.');</script>");
	}else{
	    GNB_List_Proc3     GNB_List_Proc       = new GNB_List_Proc3();
        ...
        int[] g_seq = {1,2,3,4,5,6,7,8};

	    for(int i=0; i<gnb_list_0.length; i++){
			topMenuUrl = new URL("http://"+request.getServerName()+"/common/jsp/Ajax_Gnb_Src_2018.jsp?g_seq=" + g_seq[i]);
			...
			strTopMenuFileName = "/was/lena/1.3/depot/lena-application/ROOT/common/jsp/CateList_2018_" + i + ".html";
			...
			uploadFile("CateList_2018_" + i + ".html","/was/lena/1.3/depot/lena-application/ROOT/common/jsp/");
	    }

        topMenuUrl = new URL("http://"+request.getServerName()+"/common/jsp/Ajax_Gnb_Src_2018.jsp?stype=allCate");
        ...
        strTopMenuFileName = "/was/lena/1.3/depot/lena-application/ROOT/common/jsp/AllCateList_2018.html";
        topMenuStream = new FileOutputStream(strTopMenuFileName, false);
        ...
        uploadFile("AllCateList_2018.html","/was/lena/1.3/depot/lena-application/ROOT/common/jsp/");

        out.println("<script>alert('정상반영되었습니다.');window.open('http://dev.enuri.com/jca/nGNB/gnbViewAllServer.html');</script>");
	}
%>
<%!
   ...
   // ipList.add("100.100.100.62");
    ...
    for(int i = 0; i<ipList.size() ;i++){
        try{
	        ...
	        System.out.println("gnb"+(String)ipList.get(i)+" 전송 완료");
