...
//		out.println("<script>alert('151에서만 실행하십시오!');</script>");
	...
	if(stype.equals("banner")){
		URL topMenuUrl = new URL("http://"+serverIp+"/wide/main/ajax/Ajax_Gnb_Src_2021_main.jsp?stype=banner");
	    ...
	    for(int i=0; i<gnb_list_0.length; i++){
			topMenuUrl = new URL("http://"+serverIp+"/wide/main/ajax/Ajax_Gnb_Src_2021_main.jsp?g_seq=" + g_seq[i]);
			...
			strTopMenuFileName = "/was/lena/1.3/depot/lena-application/ROOT/wide/main/ajax/main_CateList_2021_" + i + ".html";
			...
			uploadFile("main_CateList_2021_" + i + ".html","/was/lena/1.3/depot/lena-application/ROOT/wide/main/ajax/");
	    }

        topMenuUrl = new URL("http://"+serverIp+"/wide/main/ajax/Ajax_Gnb_Src_2021_main.jsp?stype=allCate");
        ...
        strTopMenuFileName = "/was/lena/1.3/depot/lena-application/ROOT/wide/main/ajax/AllCateList_2021.html";
        topMenuStream = new FileOutputStream(strTopMenuFileName, false);
        ...
        uploadFile("AllCateList_2021.html","/was/lena/1.3/depot/lena-application/ROOT/wide/main/ajax/");
        ...
        strTopMenuFileName = "/was/lena/1.3/depot/lena-application/ROOT/wide/main/ajax/TopAllCate_2021.html";
        topMenuStream = new FileOutputStream(strTopMenuFileName, false);
        ...
        uploadFile("TopAllCate_2021.html","/was/lena/1.3/depot/lena-application/ROOT/wide/main/ajax/");
