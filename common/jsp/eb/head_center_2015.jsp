<%
/**
페이지설명 : GNB 센터정렬 버전일때 head.jsp 대신 include
**/
%>
<link rel="stylesheet" type="text/css" href="<%=ConfigManager.ENURI_COMMON%>/common/css/eb/default_main.css">
<link rel="stylesheet" type="text/css" href="<%=ConfigManager.ENURI_COMMON%>/common/css/eb/common_main.css">
<%
