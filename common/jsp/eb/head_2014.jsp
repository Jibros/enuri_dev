<%
	String strIsMain = "";
	if (request.getServletPath().trim().indexOf("/Index100") >= 0){
		strIsMain = "_main";
	}	
%>
...
<%
	//}
%>
<script type="text/javascript" src="<%=ConfigManager.ENURI_COMMON%>/common/js/eb/ui.js"></script>
...
var isServer151 = "<%=request.getServerName().trim().equals("dev.enuri.com")?"1":"0"%>";
