		...
		for(int i=0; i<gnb_list_0.length; i++){
			...
			if(gnb_list_1!=null && gnb_list_1.length>0){
			    for(int j=0; j<gnb_list_1.length; j++){
		    		...
		    		String cate = StringUtils.replace(gnb_list_1[j].getG_link(), "/list.jsp?cate=" , "");
		    		String g_link = StringUtils.defaultString(gnb_list_1[j].getG_link());
		    		...
		    		if(gnb_list_1[j].getG_link()!=""){
		    			sbGnbList.append("			<a href=\""+g_link+"\">");
		    		}
