...
// layout conf
// -----------
xcMonthNames=["1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"];
xcMonthShortNames=["1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"];
xcMonthPrefix="";
xcMonthSuffix="";
...
// names for days
xcWeekdayNames=["일요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일", "일요일"];
xcWeekdayShortNames=["일", "월", "화", "수", "목", "금", "토", "일"];
xcWeekdayDisplay=["일", "월", "화", "수", "목", "금", "토", "일"];

// foot links
xcFootTags=["오늘", "삭제", "Back", "닫기", "Reset", "_Today_", "_Back_", "_Reset_"];
xcFootTagSwitch=[1, 2, 0, 0, 0, 0, 0, 0]; // [today, clear, back, close, reset, _today_, _back_, _reset_] non-zero:display order, 0:off
...
xcWindowWidth=215;
xcWindowHeight=195;
xcWindowTemplate="js/xc2_template.html"
