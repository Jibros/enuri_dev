...
function initialize() 
{
	...
	TextEditor.document.write(document.all.FROMDB.value);
...
//	if(document.all.content_type[1].checked)
//	{
//		alert('에디터 형태를 HTML 로 선택하고 사용하세요');
//		document.all.sourceview.checked = false;
//		return;
//	}
...
function go_text(){
	...
	if(document.all.sourceview.checked)
	{
		...
		document.all.content_type[0].checked = true;
		return;
	}
