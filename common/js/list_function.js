...
function showFactory()
{
	...
	*/					
	if (document.getElementById("LayerFactorySelect").style.display == "inline")
	{
		...
		document.getElementById("divFactioryTitle").src = ImageServer+"/images/button/tab_jejosa.gif";					
		document.getElementById("divPriceTitle").src = ImageServer+"/images/button/tab_price.gif";
		hideTopBorder();
	}
	else
	{
		document.getElementById("LayerFactorySelect").style.display = "inline";
		document.getElementById("divFactioryTitle").src = ImageServer+"/images/button/tab_jejosa_1.gif";
		document.getElementById("divPriceTitle").src = ImageServer+"/images/button/tab_price_2.gif";				
		showTopBorder();
		logInsert('83');		
	}
...
function showPrice(msg)
{
	if (msg == "")
	{
    	...
    	*/
    	...
    	else
    	{
    		...
    		document.getElementById("divPriceTitle").src = ImageServer+"/images/button/tab_price_1.gif";
			document.getElementById("divFactioryTitle").src = ImageServer+"/images/button/tab_jejosa_2.gif";					
    		showTopBorder();		
    		logInsert('82');
    	}
    ...
    else
    {
		...
		var newWin = window.open("/include/Incpricerangemsg.jsp",null,"width=400,height=115,top="+sTop+",left="+sLeft+",status=no,toolbar=no,menubar=no,location=no");
		newWin.focus();
    }
	hideMiddelParPreviewGoods();    
