...
(function($) {
     ...
     * @param {function}         options.notDay 일(日) 계산이 필요없는 경우 (시간으로 모두 나와야 하는 경우)
     */
    var TimerManager = function(targetContainer, options) {
        ...
        _init = function() {
            ...
            if(options.startDate instanceof Function) {
                startTime = options.startDate.apply(self);
            ...
            if(options.endDate instanceof Function) {
                endTime = options.endDate.apply(self);
