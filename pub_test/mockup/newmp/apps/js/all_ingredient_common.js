...
*********************************/
var layout = new dhx.Layout("allIngredientsLayout", config);

    // GRID 세팅
    layout.getCell("ingreGroupGrid").attach(ingreGroupGrid); // 성분그룹 GRID
    layout.getCell("ingreTitleGrid").attach(ingreTitleGrid); // 성분타이틀 GRID
    layout.getCell("ingreItemGrid").attach(ingreItemGrid); // 성분 GRID    
    layout.getCell("ingreSameGrid").attach(ingreSameGrid); // 동의어 GRID

    layout.getCell("ingreGroupHeader").attach(ingreGroupHeader); // 성분그룹 헤더
    layout.getCell("ingreTitleHeader").attach(ingreTitleHeader); // 성분타이틀 헤더
    layout.getCell("ingreItemHeader").attach(ingreItemHeader); // 성분 헤더
    layout.getCell("ingreSameHeader").attach(ingreSameHeader); // 동의어 헤더
