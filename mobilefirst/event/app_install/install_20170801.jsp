...
<body style="background-color:#f4eddb !important">
...
<div id="wrap">
	...
	<ul>
		<li><img src="http://imgenuri.enuri.gscdn.com/images/event/2017/app_img/app_first_1010_top.jpg" width="100%" alt="" id="btntop"></li>
		<li><img src="http://imgenuri.enuri.gscdn.com/images/event/2017/app_img/app_first_0929_bottom.jpg" width="100%" alt="" id="btnbottom"></li>
	</ul>
</div>
...
var chkId = "<%=chkId%>";
	$("#btntop").click(function(){
		ga('send','event','mf_event','앱첫설치레이어','첫구매(추석)');
