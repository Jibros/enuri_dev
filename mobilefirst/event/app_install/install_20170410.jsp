...
<body style="background-color:#D2EB9A !important">
...
<div id="wrap">
	...
	<ul>
		<li><img src="http://imgenuri.enuri.gscdn.com/images/event/2017/app_img/app_first_0711_top.jpg" width="100%" alt="" id="btntop"></li>
		<li><img src="http://imgenuri.enuri.gscdn.com/images/event/2017/app_img/app_first_0410_bottom.jpg" width="100%" alt="" id="btnbottom"></li>
	</ul>
</div>
...
$(function() {	
	...
	ga('send', 'pageview', {
		'page': '/mobilefirst/event/app_install/install_20170410.jsp',
		'title': 'mf_앱첫설치레이어'
	}); 
	
var chkId = "<%=chkId%>";
	$("#btntop").click(function(){
		ga('send','event','mf_event','앱첫설치레이어','첫구매');
		window.location.href = "/mobilefirst/evt/welcome_event.jsp?tab=1&freetoken=event";
 	});
 	$("#btnbottom").click(function(){
		ga('send','event','mf_event','앱첫설치레이어','룰렛');
		window.location.href = "/mobilefirst/evt/welcome_event.jsp?tab=3&freetoken=event";
 	});
});
