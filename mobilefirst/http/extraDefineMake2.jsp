...
<%
	...
	//if(!id.equals("supersons")&&!id.equals("mho")&&!id.equals("kyr6192143")&&!id.equals("hello")&&!id.equals("baegopha1230")&&!id.equals("jtj134"))
	{
...
<body>
	<%
		...
		try {
			...
			out.println("1");
			Object obj = parser
					.parse(new FileReader("/was/lena/1.3/depot/lena-application/ROOT/mobilefirst/ajax/appAjax/getDefine_new_Extra_ajax.jsp"));
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="aos_buftab_img"
						...
						FILE>>extratab_bg_YYYYMMDD_aos.jpg(720x970)</br>
					</td>
					<td><input type="text" name="ios_buftab_img"
						...
						FILE>>extratab_bg_YYYYMMDD_ios.jpg(720x970)</br>						
					</td>
				</tr>
				<tr>
					<td>버퍼탭 링크</td>
