...
<%
	...
	try {
		...
		if(strGcate.equals("0")) strGcate = ChkNull.chkStr(request.getParameter("cate"), "0"); //  CPP카테고리

// 		String tempStrGcate = strGcate.equals("9") ? "7" : strGcate;
		String tempStrGcate = strGcate;
		String pages[] = {
				...
				"0",
				"getPlan",
				"http://localhost/mobilefirst/ajax/cppAjax/getPlan.jsp?gcate=" + tempStrGcate,
				//이건 데브를 봐야지만 됨 (노)

				"httpobject",
				"0",
				"getShoppingGuide",
				"http://localhost/mobilefirst/ajax/cppAjax/getShoppingGuide.jsp?gcate=" + tempStrGcate,
...
// 				obj = getJSONObjectfromHttp("http://localhost/mobilefirst/ajax/cppAjax2/getNews_2018.jsp?gcate=" + strGcate);
			...
			try {
				...
				obj = getJSONObjectfromHttp("http://localhost/mobilefirst/http/json/cppJson_2022_" + strGcate + ".json");
	...
	if (makeJson != null)  out.println(makeJson.toString());
%>
