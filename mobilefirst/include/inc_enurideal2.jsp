...
<%
	...
	if(vReturn){
		...
		if(request.getServerName().indexOf("dev.enuri.com")>-1){
			//urlGo("http://27.122.133.180:8080/mobilefirst/api/crazy_deal_ctu_send.jsp?devYN=Y");	
			urlGo("/mobilefirst/api/crazy_deal_ctu_send.jsp?devYN=Y");	
		}else{
			urlGo("/mobilefirst/api/crazy_deal_ctu_send.jsp");
		}
	}
	*/
	JSONObject json = new JSONObject();
	json.put("resultMsg", vReturn);
