...
<%
	...
	if("H".equals(kncd) &&  "1".equals(kind)  ){
		...
		if("B".equals(kncd) && !cate.equals("")){
			//태블릿/모바일, 유아/식품, 가구/생활, 패션/화장품
			//if(cate.equals("0304|22|0360") || cate.equals("10|15|19") || cate.equals("14|18") || cate.equals("12|16|18") ){
...
/*
	...
	JSONArray jSONArray = new JSONArray();
	jSONArray = mgp.getDealBestGoods(spm_cd, kncd, cate);
