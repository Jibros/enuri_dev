...
if(goods_data!=null && goods_data.length>0) {
     ...
     for(int i=0; i<goods_data.length; i++) {
           ...
           String modelnm = goods_data[i].getModelnm().replaceAll("\"", "\\\\\"");
           ...
           String middleImageUrl = ImageUtil.getImageSrc(CutStr.cutStr(ca_code,4), modelno, imgchk, p_pl_no, p_imgurl, p_imgurlflag);
           ...
           String strConstrain = goods_data[i].getStrConstrain();
           //String strConstrain = "";
           String p_imgurl2 = goods_data[i].getP_imgurl2();
           // 500이미지로 변경
           if(smallFinderIdx>-1){
           ...
           if(!strConstrain.equals("5")){
                ...
                middleImageUrl = goods_data[i].getP_imgurl2();
           }
