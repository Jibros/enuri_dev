...
String cate = ChkNull.chkStr(request.getParameter("category"), "");
...
if(StringUtils.isEmpty(cate)) {
	...
	JSONArray categories = save_goods_proc.getSaveGoodsCategories(strUserId);
	object.put("category", categories);
	out.println(object.toString(4));
		...
		goods_data = save_goods_proc.getSaveGoodListWithCategory(minAppId, minAppType, strUserId, cate);
