...
<div class="family">
	...
	<ul class="today_list sdeal" id="today_list"></ul>
	<ul class="mart_list timon" id="mart_list"></ul>
</div>
...
$(function() {
	...
	ga('send', 'pageview', {
		'page': '/mobilefirst/api/familyapp.jsp',
		'title': 'mf_티머니 제휴'
	}); 
});
...
function getBaselist(param){
	...
	if(param == 1){
		...
		template += "<li id=\"deal_3\"><a href=\"javascript:///\" onclick=\"getBaselist(3);\"><img src=\"http://img.enuri.info/images/m_home/f_app03.png\" alt=\"슈퍼딜\" /></a></li>";
		template += "<li id=\"deal_4\"><a href=\"javascript:///\" onclick=\"getBaselist(4);\"><img src=\"http://img.enuri.info/images/m_home/f_app04.png\" alt=\"슈퍼딜\" /></a></li>";
		template += "<li id=\"deal_5\"><a href=\"javascript:///\" onclick=\"getBaselist(5);\"><img src=\"http://img.enuri.info/images/m_home/f_app05.png\" alt=\"슈퍼딜\" /></a></li>";
	}else if(param == 2){
		shop_code = "536";
		shop_name = "슈퍼딜";
