...
//QDx5bIClmpDtc_5ib9uGwdp7hLbCuPACw79x583ga27t9oAOJuz8dGlAscvZrsxz3ziiAYCdJlIfbeXFfv962rBEY9OiHzAZLm9KeiY6iNq1zhmf40CtDtAhTxMxpqshKKDn_P9BnWK3KuL5mzE6lc1VhnUYdSDQGj90_6dkRM8
	...
	String strCa_code = goods_data_pop.getCa_code();


	///////////////////////////////// 이미지 가져오는 부분 추가 
	String strImgchk = goods_data_pop.getImgchk();
	long lngP_pl_no = goods_data_pop.getP_pl_no();
	String strP_imgurl = goods_data_pop.getP_imgurl();
	String strP_imgurlflag = goods_data_pop.getP_imgurlflag();
	//모델명 변경 2015.10.12.
	...
	if(isAdultCate(strCate4) && !cb.GetCookie("MEM_INFO", "ADULT").equals("1")){
				//strImageurl = ConfigManager.IMG_ENURI_COM+"/2012/list/19_2.gif";
		strImageurl = ConfigManager.IMG_ENURI_COM + "/images/mobilenew/images/contents/img_19.jpg";
	}
...
//try {
	if(aszPlist != null && aszPlist.length > 0){
		...
		out.println("	\"strimage\":  \"" + strImageurl + "\",");
		out.println("	\"strimagemiddle\":  \"" + strImageurl_middle + "\",");
