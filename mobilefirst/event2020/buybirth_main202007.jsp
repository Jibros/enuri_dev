                    ...
                    <div class="inner">
						<div class="txt_box">
							<ul>
								...
								<li><strong>혜택 지급일 <span class="point">:</span></strong> <%= dateFormatter.format(prevFormat.parse(dday)) %>  </li>
							</ul>
						</div>
                    </div>
                    <!-- // -->
					...
					<div class="caution-wrap">
						...
						<div class="moreview" style="display: ;">
							...
							<div class="txt">
                                ...
                                <ul class="txt_indent">
                                    <li>이벤트 대상 : 이벤트 기간 내 스탬프 1회 이상 참여 후 7월 생일 이벤트 신청한 고객</li>
                                    ...
                                    <li>혜택 지급일 :&nbsp;<%= dateFormatter.format(prevFormat.parse(dday)) %><br>
                                ...
                                <ul class="txt_indent">
                                    <li>참여방법 : 에누리 가격비교 모바일 앱 로그인 → 적립대상 쇼핑몰 이동 →&nbsp;<span class="stress">1만원 이상 구매</span>&nbsp;→ 스탬프 1회 이상 참여 → 생일 이벤트 신청<br>
                                        ※ 이벤트 참여의 경우 PC 및 모바일 앱/웹에서 로그인 후에도 가능합니다. </li>
                                    ...
                                    <li>본 이벤트는 본인인증 및 생년월일 정보 활용 동의 후 참여 가능합니다.</li>
                                    <li>생일은 본인인증시 수집된 정보를 기준으로 하며, 이후 임의 변경시 변경된 생일은 반영되지 않습니다. (※ 부정참여로 간주)</li>
                                    <li>본 이벤트는 생일 이벤트로 연간 1회만 참여 가능합니다.</li> 
                                    ...
                                    <li><span class="stress">이벤트 대상 제외 :</span>&nbsp;아래의 경우에는 이벤트 대상 및 혜택 지급에서 제외됩니다.<br>
                                        <ul>
                                            ...
                                            <li>- 참여한 스탬프의 실제 구매금액이 1만원 미만의 구매일 경우</li>
                                            <li>- 참여한 스탬프가 구매적립 제외 카테고리 구매일 경우 </li>
                                            <li>- 스탬프 참여 후 취소/환불/교환/반품한 경우</li>
                                            <li>- 참여한 스탬프가 해외직구 상품 구매일 경우</li>
                                        </ul>
                                    </li>
                                </ul>
...
<div id="evt2" class="comeback">
	<div class="contents">
		<h2>컴백! 오랜만 이에요!</h2>
		<p class="blind">구매만 하면 무조건! 맥도날드 모짜렐라 치즈스틱 2조각 공짜!</p>
		<div class="comeback_img">맥도날드 모짜렐라 치즈스틱 2조각 e머니 2,000포인트</div>
		...
		<div class="comeback__cont">
			<div class="inner">
				<div class="txt_box">
					<ul>
						<li><strong>이벤트 대상 <span class="point">:</span></strong> 2020년 5월 1일 이후<br> 구매이력 없는 회원 대상</li>
			...
			<div class="caution-wrap">
				...
				<div class="moreview" style="display: ;">
							...
							<div class="txt">
                                <strong>이벤트 대상 및 혜택</strong>
                                <ul class="txt_indent">
                                    <li>이벤트 대상 : 2016년 2월 1일 ~ 2020년 4월 30일 이내 에누리 모바일 앱을 통한 구매이력 있으나,&nbsp;2020년 5월 1일&nbsp;이후 구매이력 없는 고객 (※ 1천원 이상 구매 후 컴백 이벤트 신청한 고객)</li>
                                    <li>이벤트 기간 : 2020년 7월 1일 ~ 8월 2일</li>
                                    <li>이벤트 혜택 : 맥도날드 모짜렐라 치즈스틱 2조각 (e머니 2,000점)</li>
                                ...
                                <strong>이벤트 참여방법 및 유의사항</strong>
                                <ul class="txt_indent">
                                    <li>참여방법 : 에누리 가격비교 모바일 앱 로그인 → 적립대상 쇼핑몰 이동 →&nbsp;<span class="stress">1천원 이상 구매</span>&nbsp;→ 컴백 이벤트 신청<br>
                                        ※ 이벤트 참여의 경우 PC 및 모바일 앱/웹에서 로그인 후에도 가능합니다. </li>
                                    <li>적립대상 쇼핑몰 : G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프, 쿠팡, GS SHOP, CJmall, SSG (신세계몰, 신세계백화점, 이마트몰, 트레이더스), 에누리 해외직구관, SK스토아<br>
                                        <span class="stress">※ 구매 유의사항 및 구매적립 제외 카테고리는 이벤트 페이지 하단 'e머니 구매혜택' 유의사항을 꼭 확인하세요.</span></li>
