...
<div id="tab2" class="nuripang_stamp">
	<div class="inner">
		...
		<div class="view_cont">
			...
			<ul class="info_list">
                <li><strong>· 이벤트 기간 :</strong> <%= dateFormatter.format(prevFormat.parse(startDate)) %> ~ 8월 31일</li>
                <li><strong>· 혜택 지급일 :</strong> <%= dateFormatter.format(prevFormat.parse(dday)) %></li>
            </ul>
		</div>
	</div>
					...
					<dl>
						...
						<dd>
							<ul>
								...
								<li>이벤트 혜택 : 스탬프 참여횟수별 차등 적립 (최대 e머니 2,300점)<br>
									<span class="stress">※ 가전 대상 카테고리 상품 구매 시, e머니 500점 추가 적립! 가전 대상 카테고리를 확인하세요. (혜택 지급일 당일 별도 추가 적립)</span>
								</li>
								...
								<li>
									가전 대상 카테고리<br>
									<table class="evt_noti_tb" style="width:100%;max-width:600px;">												
										<tbody>
											<tr>
