...
<%
String strFb_img = ConfigManager.IMG_ENURI_COM+ "/images/event/2020/winter/sns_1200_630.jpg";
...
<div class="floating_bnr">
	<a href="javascript:///" id="floating_bnr"><img src="http://img.enuri.info/images/event/2020/winter/fl_bnr.png"; alt="월동 준비하고 온열 테이블 받자"></a>
	<!-- 닫기 -->
...
<div class="toparea">
	...
	<div class="visual">
		...
		<div class="inner">
			<span class="txt_01">월동 준비</span>
			<h2>겨울에-누리다</h2>
			<span class="txt_02">2020. 10. 26 ~ 2020. 11. 22</span>
		</div>
		<div class="obj_snow">
			<div class="bg_snow snow_obj_01"></div>
			<div class="bg_snow snow_obj_02"></div>
		</div>
		<!-- // -->
	...
	<div class="section navtab">
		<div class="navtab_inner">
			<ul class="navtab_list">
				<li><a href="/mobilefirst/event2020/winter_2020_evt.jsp" class="navtab_item--01"><span class="tx_sm">매일매일</span>100% 당첨</a></li>
            	<li><a href="/mobilefirst/event2020/winter_2020_deal.jsp" class="navtab_item--02"><span class="tx_sm">내돈내산</span>특가EVENT</a></li>
            	<li><a href="/mobilefirst/event2020/winter_2020.jsp" class="navtab_item--03"><span class="tx_sm">월동 준비하고</span>온열테이블 받자!</a></li>
			</ul>
		</div>
	</div>
	<!-- //탭 -->
...
var vEvent_title = "20년 월동통합기획전";
var gaLabel = [  vEvent_title+"_PV"
				,vEvent_title+"_상단탭_매일참여 이벤트"
				...
				,vEvent_title+"_타임딜_공유이벤트 참여"
				,vEvent_title+"_타임딜_구매이벤트 참여"
				,vEvent_title+"_겨울잠준비_탭_온수매트/전기매트"
				,vEvent_title+"_겨울잠준비_탭_난방텐트"
				,vEvent_title+"_겨울잠준비_탭_침구세트"
				,vEvent_title+"_겨울잠준비_상품보기"
				,vEvent_title+"_겨울잠준비_상품더보기"
				,vEvent_title+"_난방비절약_탭_가습기"
				,vEvent_title+"_난방비절약_탭_단열필름"
				,vEvent_title+"_난방비절약_탭_암막커튼"
				,vEvent_title+"_난방비절약_상품클릭"
				,vEvent_title+"_난방비절약_상품더보기"
				,vEvent_title+"_소형난방템_탭_히터/온풍기"
				,vEvent_title+"_소형난방템_탭_USB온열기"
				,vEvent_title+"_소형난방템_탭_손난로/온열팩"
				,vEvent_title+"_소형난방템_상품클릭"
				,vEvent_title+"_소형난방템_상품더보기"
				,vEvent_title+"_겨울먹거리_탭_겨울간식"
				,vEvent_title+"_겨울먹거리_탭_E쿠폰"
				,vEvent_title+"_겨울먹거리_탭_김장"
				,vEvent_title+"_겨울먹거리_상품클릭"
				,vEvent_title+"_겨울먹거리_상품더보기"
				,vEvent_title+"_겨울의류_탭_패딩/다운"
				,vEvent_title+"_겨울의류_탭_방한용품"
				,vEvent_title+"_겨울의류_탭_내복"
				,vEvent_title+"_겨울의류_상품클릭"
				,vEvent_title+"_겨울의류_상품더보기"
				,vEvent_title+"_띠배너"
				 ];
...
$(document).ready(function(){
	...
	$("#floating_bnr").click(function(){
		ga_log(5);
		location.href = "/mobilefirst/event2020/winter_2020_deal.jsp?tab=05";
		return false;
	});
...
if(oc == "sns" && app != 'Y'){
	var url = "enuri://freetoken/?url=http%3A%2F%2Fm.enuri.com%2Fmobilefirst%2Fevent2020%2Fwinter_2020.jsp";
	$('.lay_only_mw').show();
}
...
window.onload = function(){
	...
	if(evntPage.indexOf("_evt") > -1){
		...
		$("#txtURL").text("http://m.enuri.com/mobilefirst/event2020/winter_2020_evt.jsp?oc=sns");
	}else if(evntPage.indexOf("_deal") > -1){
		$(".navtab_inner .navtab_list .navtab_item--02").parent("li").addClass("is-on");
		$("#txtURL").text("http://m.enuri.com/mobilefirst/event2020/winter_2020_deal.jsp?oc=sns");
	}else{
		$(".navtab_inner .navtab_list .navtab_item--03").parent("li").addClass("is-on");
		$("#txtURL").text("http://m.enuri.com/mobilefirst/event2020/winter_2020.jsp?oc=sns");
	}
...
function shareSns(param){
	var share_url = "";
	if(evntPage.indexOf("_evt") > -1){
		share_url = "http://" + location.host + "/mobilefirst/event2020/winter_2020_evt.jsp?oc=sns";
	}else if(evntPage.indexOf("_deal") > -1){
		share_url = "http://" + location.host + "/mobilefirst/event2020/winter_2020_deal.jsp?oc=sns";
	}else{
		share_url = "http://" + location.host + "/mobilefirst/event2020/winter_2020.jsp?oc=sns";
	}
	var share_title = "[에누리 가격비교] 겨울에누리다!";
