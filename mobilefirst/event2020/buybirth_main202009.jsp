	...
	<div class="contents">
	    ...
	    <!-- 20190918 : 추가 -->
			<div class="inner">
				<div class="txt_box">
					<ul>
                        <li><strong>이벤트 기간 <span class="point">:</span></strong> 2020년 9월 1일 ~ 10월 4일</li>
						<li><strong>혜택 지급일 <span class="point">:</span></strong> 2020년 11월 26일</li>
					</ul>
				</div>
			</div>
			<!-- // -->
					...
					<div class="evt_notice--cont">
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<ul>
										<li>이벤트 대상 : 이벤트 기간 내 스탬프 1회 이상 참여 후 9월 생일 이벤트 신청한 고객</li>
...
<div id="evt2" class="comeback">
	<div class="contents">
		<h2>오랜만에누리다!</h2>
		<p class="blind">구매만 하면 무조건! 맥도날드 모짜렐라 치즈스틱 공짜!</p>
		<div class="comeback_img">모짜렐라 치즈스틱 e머니 2,000포인트</div>
		...
		<div class="comeback__cont">
			<div class="inner">
				<div class="txt_box">
					<ul>
                        <li><strong>이벤트 대상 <span class="point">:</span></strong> 2020년 7월 1일 이후<br> 구매이력 없는 회원 대상</li>
						<li><strong>유 의 사 항 <span class="point">:</span></strong> e쿠폰으로 교환할 수 있는 <br> e머니로 지급됩니다.</li>
					</ul>
				</div>
			</div>
			<div class="com__evt_notice">
					...
					<div class="evt_notice--cont">
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<ul>
										<li>이벤트 대상 : 2016년 2월 1일 ~ 2020년 6월 30일 이내 에누리 모바일 앱을 통한 구매이력 있으나,&nbsp;2020년 7월 1일&nbsp;이후 구매이력 없는 고객 (※ 1천원 이상 구매 후 컴백 이벤트 신청한 고객)</li>
										<li>이벤트 기간 : 2020년 9월 1일 ~ 10월 4일</li>
