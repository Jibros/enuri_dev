						...
						<div class="moreview" style="display: ;">
							...
							<div class="txt">
                                ...
                                <ul class="txt_indent">
                                    ...
                                    <li>혜택 지급일 :&nbsp;<%= dateFormatter.format(prevFormat.parse(dday)) %>
                                        <ul>
                                ...
                                <strong>이벤트 혜택 상세</strong>
                                <strong>일반상품 </strong>
                                <ul class="txt_indent">
                                    <li>일반상품 1천만원 이상 구매 시 최대 200만점 추가적립 <span class="stress">(※ 순금, 순은, 돌반지, 골드바, 실버바 구매시에도 가능)</span></li>
                                ...
                                <ul class="txt_indent">
                                    ...
                                    <li>이벤트 기간 내 구매 건 중 2020년 8월 31일까지의 구매확정(배송완료)건 기준으로 이벤트 대상자 선정됩니다.</li>
