...
<div id="tab4" class="addsave_wrap">
	...
	<div class="inner">
		<div class="imgbox">
			...
			<div class="top_area">
				<h2>구매혜택 03, 최대 3만점 추가 적립 - 받고 또 받는 카테고리 혜택!</h2>
			</div>

			<div class="addsave__cont">
				<img src="http://img.enuri.info/images/event/2020/buy_stamp/sep/evt3_cont.png" alt="e머니 30,000점">
			</div>
			...
			<div class="info_list">
				<ul>
					<li>· 이벤트 기간 : 2020년 11월 2일~ 11월 30일</li>
					<li>· 혜택 지급일 : 2021년 1월 21일</li>
			...
			<div class="evt_notice--cont">
				<div class="evt_notice--continner">
					<dl>								
						...
						<dd>
							<ul>
								<li>이벤트 대상 : 이벤트 기간 내 대상 카테고리 상품 구매 후 최대 3만점 추가적립 이벤트 신청한 고객 (※ 대상 카테고리 확인)</li>
								<li>이벤트 기간 : 2020년 11월 2일 ~ 11월 30일</li>
								<li>이벤트 혜택 : 카테고리별 차등 추가 적립(최대 e머니 30,000점)</li>
								<li>혜택 지급일 :&nbsp;2021년 1월 21일<br>
								...
								<li>
									...
									<table class="evt_noti_tb">
										...
										<tbody>
											...
											<tr><td>미러리스 디카</td><td>0.3%</td><td>1%</td><td>30,000</td></tr>
											<tr><td>렌즈,필터</td><td>0.3%</td><td>1%</td><td>30,000</td></tr>
											<tr><td>노트북</td><td>0.8%</td><td>1%</td><td>30,000</td></tr>
											<tr><td>휴대폰,스마트폰</td><td>0.3%</td><td>1%</td><td>20,000</td></tr>
											<tr><td>태블릿PC,전자책</td><td>0.3%</td><td>1%</td><td>20,000</td></tr>
											<tr><td>스포츠의류&gt;다운,패딩</td><td>1.0%</td><td>1%</td><td>10,000</td></tr>
											<tr><td>등산의류,잡화&gt;다운패딩</td><td>1.0%</td><td>1%</td><td>10,000</td></tr>
											<tr><td>복합기,프린터,스캐너</td><td>0.8%</td><td>1%</td><td>3,000</td></tr>
											<tr><td>홍삼,건강식품</td><td>1.0%</td><td>1%</td><td>3,000</td></tr>
											<tr><td>공구,전동드릴</td><td>1.0%</td><td>1%</td><td>3,000</td></tr>
											<tr><td>이어폰,헤드폰</td><td>0.3%</td><td>1%</td><td>2,000</td></tr>
											<tr><td>복사용지</td><td>0.8%</td><td>1%</td><td>1,000</td></tr>
											<tr><td>농산물</td><td>1.0%</td><td>1%</td><td>1,000</td></tr>
											<tr><td>커피,차</td><td>1.0%</td><td>1%</td><td>1,000</td></tr>
											<tr><td>생수,음료</td><td>1.0%</td><td>1%</td><td>1,000</td></tr>
										</tbody>
									</table>
								</li>
							</ul>
					...
					<dl>
						...
						<dd>
							<ul>
								<li>참여방법 : 에누리 가격비교 모바일 앱 로그인 → 적립대상 쇼핑몰 이동 →&nbsp;<span class="stress">대상 카테고리 구매</span>&nbsp;→ 최대 3만점 추가적립 이벤트 신청<br>
