	...
	<div class="caution-wrap">
		...
		<div class="moreview">
			<div class="txt">
				<dl class="txtlist">
					<dt>이벤트 대상 및 혜택</dt>
					<dd>이벤트 대상 : 에누리 가격비교 모바일 앱에서 구매이력 없는 고객 (※ 100원딜 상품 또는 1만원 이상 첫 구매 후 첫구매 페이백 이벤트 신청한 고객)</dd>
					<dd>이벤트 기간 : 첫 구매일로부터 30일 이내 </dd>
					<dd>이벤트 혜택 : e머니 9,900점</dd>
					<dd>혜택 지급일 :&nbsp;구매일로부터 최대 30일 이내 적립 (※ 해외직구 상품 구매 시 최대 70일 소요)</dd>
					<dd><span class="stress">e머니 유효기간 : 적립일로부터 15일 (유효기간 만료 후 재적립 불가)</span><br>
						 ※ 적립된 e머니는 e쿠폰 스토어에서 다양한 쿠폰으로 교환가능합니다.</dd>
				</dl>
				<dl class="txtlist">
					<dt>이벤트 참여방법 및 유의사항</dt>
					<dd>참여방법 : 에누리 가격비교 모바일 앱 로그인 → <span class="stress">본 이벤트 페이지 내 100원딜 상품 첫 구매</span> →&nbsp;첫구매 페이백 이벤트 신청 <br>
						<span class="stress">※ 100원딜 상품 외에도 모바일 앱 로그인 후 적립대상 쇼핑몰 이동하여 1만원 이상 첫 구매 시 신청 가능합니다.</span></dd>
					<dd>적립대상 쇼핑몰 : G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프, 쿠팡, GS SHOP, CJmall, SSG (신세계몰, 신세계백화점, 이마트몰, 트레이더스), 에누리 해외직구관, SK스토아<br>
						<span class="stress">※ 구매 유의사항 및 구매적립 제외 카테고리는 유의사항 내 ▶e머니 구매적립 기준 및 유의사항◀을 꼭 확인하세요.</span></dd>
					<dd>인터파크 상품권의 경우 100원딜 상품만 이벤트 대상이며, 그 외 e머니 적립 제외 카테고리 상품으로 이벤트 대상에서 제외됩니다.</dd>
					<dd>본 이벤트는 ID당 1회 참여 가능합니다.  </dd>
					<dd>본 이벤트는 ID와 구매한 기기 모두 첫 구매일 경우에만 참여 가능합니다. (※ 구매한 기기에 구매이력 있으면 참여 불가)</dd>
					<dd>본 이벤트는 본인인증 및 이벤트 정보 활용 동의 후 참여 가능합니다.</dd>
					<dd><span class="stress">본 이벤트는 모바일 앱에서만 참여가 가능한 모바일 앱전용 프로모션 입니다.</span></dd>
					<dd><span class="stress">본 이벤트는 ID(본인인증), 첫 구매, 페이백 신청을 모두 동일한 모바일 기기에서 진행한 경우에만 혜택 지급 가능합니다.</span></dd>
					<dd>구매금액은 배송비, 설치비, 할인, 쇼핑몰 포인트 등 제외한 금액만 반영됩니다. </dd>
					<dd><span class="stress">이벤트 대상 제외 :</span> 아래의 경우에는 이벤트 대상 및 혜택 지급에서 제외됩니다. <br>
						<ul>
							...
							<li><span class="stress">- 친구초대 첫구매 혜택 받은 고객 (중복 지급 불가)</span></li>
						</ul>
					</dd>
				</dl>
				<dl class="txtlist">
					<dt>공통 이벤트 유의사항</dt>
					<dd>부정 참여 시 본 이벤트 대상 제외 및 혜택 지급이 취소될 수 있습니다. </dd>
					<dd>본 이벤트는 당사 사정에 따라 사전고지 없이 변경 또는 종료될 수 있습니다.</dd>
				</dl>
				<dl class="txtlist">
					<dt>▶e머니 구매적립 기준 및 유의사항◀</dt>						
					<dd>적립 e머니는 구매일로부터 10 ~ 30일간 취소/환불/교환/반품여부 확인 후 적립 됩니다.</dd>
					<dd><span class="stress">구매적립 e머니 유효기간 : 적립일로부터 60일 (유효기간 만료 후 재적립 불가)</span><br>
						※ 적립된 e머니는 e쿠폰 스토어에서 다양한 쿠폰으로 교환가능합니다.</dd>
					<dd>구매적립 e머니는 최소 10점(구매금액 1천원 이상)부터 적립되며, 1원 단위 e머니는 적립되지 않습니다.</dd>
					<dd>구매적립 e머니는 구매확정(구매일로부터 최대 30일) 시점부터 MY 에누리 적립내역 페이지에서 확인 가능합니다.</dd>
					<dd>구매금액은 배송비, 설치비, 할인, 쇼핑몰 포인트 등 제외한 금액만 반영됩니다. </dd>
					<dd>적립대상 쇼핑몰에서 장바구니에 여러 상품을 담아 한 번에 결제하는 경우, 구매건수는 1건이며 구매금액은 통합된 금액으로 e머니 적립 됩니다.</dd>
					<dd>구매적립 e머니는 카테고리별 차등 적립됩니다.<br><b>카테고리별 적립률</b>
						<div class="tb">
							<table>
								<colgroup>
				...
				<dl class="txtlist">
					<dt><span class="stress">[모바일쿠폰,상품권 ] 구매적립 기준</span></dt>
				...
				<dl class="txtlist">
					...
					<dd>에누리 가격비교에서 검색되지 않는 상품</dd>
					<dd>모바일쿠폰,상품권 : 상품권, 지역쿠폰, e교환권, e쿠폰 등 </dd>
					<dd>쇼핑몰 제휴 서비스(배달, 티켓, 해외직구 등) 및 일부 카테고리
						<ul>
				...
				<dl class="txtlist">
					<dt>공통 구매 유의사항</dt>
					<dd>아래의 경우에는 구매 확인 및 구매적립이 불가합니다. 
						<ul>
		...
		<div class="caution-wrap">
			...
			<div class="moreview">
				<div class="txt">
					<dl class="txtlist">
						<dt>이벤트 대상 및 혜택</dt>
						<dd>이벤트 대상 : 첫구매 페이백 신청한 고객 (※ 자동 적립)</dd>
						<dd>이벤트 기간 : 첫 구매일로부터 100일 이내</dd>
						<dd>이벤트 혜택 : 파워적립 구매건수별 차등 적립(최대 e머니 7,000점)</dd>
						<dd>혜택 지급일 :&nbsp;구매일로부터 최대 30일 이내 적립 (※ 해외직구 상품 구매 시 최대 70일 소요)</dd>
						<dd><span class="stress">e머니 유효기간 : 적립일로부터 15일 (유효기간 만료 후 재적립 불가)</span><br>
							 ※ 적립된 e머니는 e쿠폰 스토어에서 다양한 쿠폰으로 교환가능합니다.</dd>
					</dl>
					<dl class="txtlist">
						<dt>이벤트 참여방법 및 유의사항</dt>
						<dd>참여방법 : 에누리 가격비교 모바일 앱 로그인 → 적립대상 쇼핑몰 이동 →&nbsp;<span class="stress">첫구매일로부터 100일간 1만원 이상 구매 </span>&nbsp;→ 파워적립</dd>
						<dd>적립대상 쇼핑몰 : G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프, 쿠팡, GS SHOP, CJmall, SSG (신세계몰, 신세계백화점, 이마트몰, 트레이더스), 에누리 해외직구관, SK스토아<br>
							<span class="stress" style="letter-spacing:-.5px;">※ 구매 유의사항 및 구매적립 제외 카테고리는 100원딜 유의사항 내 ▶e머니 구매적립 기준 및 유의사항◀을 꼭 확인하세요.</span></dd>
						<dd>적립대상 쇼핑몰에서 장바구니에 여러 상품을 담아 한 번에 결제하는 경우, 구매건수는 1건으로 1개의 파워적립만 적립됩니다.</dd>
						<dd>이벤트 기간 내 1만원 이상 구매건수에 따라 혜택 지급됩니다. (※ 이벤트 대상 제외 확인)</dd>
						<dd><span class="stress">본 이벤트는 모바일 앱에서만 참여가 가능한 모바일 앱전용 프로모션 입니다.</span></dd>
						<dd><span class="stress">본 이벤트는 본인인증, 첫 구매, 페이백 신청, 100일간 구매 모두 동일한 모바일 기기에서 진행한 경우에만 지급 가능합니다.</span></dd>
						<dd>본 이벤트는 친구초대 첫구매 혜택 신청한 경우에도 파워적립 자동 참여됩니다.</dd>
						<dd>구매금액은 배송비, 설치비, 할인, 쇼핑몰 포인트 등 제외한 금액만 반영됩니다. </dd>
						<dd><span class="stress">이벤트 대상 제외 :</span> 아래의 경우에는 이벤트 대상 및 혜택 지급에서 제외됩니다. <br>
							<ul>
								<li>- 첫구매 페이백 이벤트 신청하지 않은 경우 </li>
