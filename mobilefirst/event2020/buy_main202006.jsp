						...
						<div class="moreview">
							...
							<div class="txt">
								...
								<ul class="txt_indent">
									...
									<li><b>당첨자 발표 및 적립일: <%= dateFormatter.format(prevFormat.parse(dday)) %></b>
								...
								<ul class="txt_indent">
									...
									<li>이벤트 기간 내의 구매내역 중 2020년 7월 31일까지의 구매확정금액(배송완료) 기준으로 당첨자 선정</li>
						...
						<div class="moreview">
							...
							<div class="txt">
								...
								<ul class="txt_indent">
									...
									<li>적립대상 쇼핑몰: G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프, 쿠팡, GS SHOP, CJmall, SSG (신세계몰, 신세계백화점, 이마트몰, 트레이더스), SK스토아</li>
									<li>구매금액은 배송비, 설치비, 할인, 쇼핑몰 포인트 등 제외한 상품 결제금액만 반영</li>
									<li>이벤트 기간 내의 구매내역 중 2020년 7월 31일까지의 구매확정금액(배송완료) 기준으로 추가적립</li>
