		...
		<div class="caution-wrap">
			...
			<div class="moreview">
				<div class="txt">
					...
					<dl class="txtlist">
						<dt>이벤트 대상자 및 혜택</dt>
						<dd><strong>이벤트 대상:</strong> 2020년 1월 1일 이후 100원딜 페이백 신청한 회원 대상 </dd>
	...
	<div class="otherbene">
		<div class="contents">
			...
			<ul class="banlist">
				...
				<li><a href="javascript:///" target="_blank" title="새창으로 이동"><img src="http://img.enuri.info/images/event/2019/w100deal/m_benefit_bn_03.jpg" alt="크레이지딜"></a></li>
			</ul>
