	...
	<div class="caution-wrap">
		...
		<div class="moreview">
			...
			<div class="txt">
				...
				<ul class="txt_indent">
					<li>참여방법: 에누리 가격비교 앱 로그인 &rarr; 적립대상 쇼핑몰 이동 &rarr; <span class="stress">1만원 이상 구매</span> &rarr; 스탬프 참여</li>
					<!-- 
					<li>
...
(function() {
	//스탬프 이벤트 정보
	var stampInfo = {
		eventCode : "2020020101",
		startDate : "20200203", //이벤트 시작날짜 꼭 넣어준다
		endDate : 	"20200301", //이벤트 종료 날짜
		total_stampcnt : 8,
