...
<div id="tab2" class="nuripang_stamp">
	<div class="inner">
		<div class="top_area">
			<h2>스탬프 모으기 </h2>
				<p class="blind">1만원 이상 구매하고 스탬프 찍으면 e머니 지급!</p>
		</div>
		<div class="view_cont">
			<h3>나의 스탬프 구매 현황</h3>
			<div class="state_stamp">
				...
				<div class="list" id="stampList">
					<ol>
						...
						<li class="e300_2"><i>2회</i><span class="btn ">300 추가적립 완료</span></li><!-- 완료 span class="stamp100"추가 -->
						<li class="e200_3"><i>3회</i><span class="btn ">200 추가적립 완료</span></li><!-- 선물1 span class="stamp200"추가 -->
						<li class="e200_4"><i>4회</i><span class="btn ">200 추가적립 완료</span></li><!-- 스탬프 클릭 span class="click"추가 -->
						...
						<li class="e500_8"><i>8회</i><span class="btn ">500 추가적립 완료</span></li><!-- 선물3 span class="stamp1000"추가 -->
					</ol>
				</div>	
				<!-- <div class="reward">
					<span class="ico_more">+</span>
					<p class="reward_txt">#최저가전에-누리다! 가전 구매하면 e500 추가 지급!</p>
					<span class="reward_img">bg</span>
				</div> -->
			</div>
			<ul class="info_list">
				<li><strong>· 이벤트 기간 :</strong> 2020년 12월 1일 ~ 2021년 1월 3일</li>
				<li><strong>· 혜택 지급일 :</strong> 2021년 2월 18일</li>
			</ul>
		</div>
	</div>
				...
				<div class="evt_notice--continner">
					<dl>
						...
						<dd>
							<ul>
								<!-- 200717 : 날짜/문구 변경 -->
								<li>이벤트 대상 : 이벤트 기간 내 1만원 이상 구매 후 스탬프 1~8회 참여한 고객</li>
								<li>이벤트 기간 : <%= dateFormatter.format(prevFormat.parse(startDate)) %> ~ <%= dateFormatter.format(prevFormat.parse(endDate)) %></li>
								<li>이벤트 혜택 : 스탬프 참여횟수별 차등 적립 (최대 e머니 2,500점)	</li>
								<li>혜택 지급일 :&nbsp;<%= dateFormatter.format(prevFormat.parse(dday)) %></li>
								<!-- // -->
								<li>
					...
					<dl>
						...
						<dd>
							<ul>
								<li>참여방법 : 에누리 가격비교 모바일 앱 로그인 → 적립대상 쇼핑몰 이동 →&nbsp;<span class="stress">1만원 이상 구매</span>&nbsp;→ 스탬프 이벤트 참여<br>
								...
								<li>적립대상 쇼핑몰에서 장바구니에 여러 상품을 담아 한 번에 결제하는 경우, 구매건수는 1건으로 1개의 스탬프만 생성됩니다.</li>
...
<div class="notice stamplayer stamp_first" id="stamp_complete" style="display:none;">
	<div class="dim"></div>
	<div class="notice_layer stamp_layer_open">
		<h4>스탬프 참여 완료!</h4>
		<div class="cont">
			<p class="txt"><strong>이번달 생일이시라면<br>생일 이벤트에도 응모하세요</strong></p>
			
			<a href="javascript:void(0);" class="btn btn_layclose" onclick="javascript:location.reload();">확인</a>
		</div>
		<a class="btn layclose2" href="javascript:void(0);" onclick="onoff('stamp_complete');return false"><em>팝업 닫기</em></a>
	</div>
</div>
<!-- //누리팡! 스탬프 -->
...
(function() {
	...
	var stampInfo = {
		eventCode : "<%=eventId%>",
		startDate : "<%=startDate%>", //이벤트 시작날짜 꼭 넣어준다
		endDate : 	"<%=endDate%>", //이벤트 종료 날짜
		total_stampcnt : 8,
