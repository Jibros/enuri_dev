...
if( ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPhone") > -1
	...
	response.sendRedirect("/event2020/newsemester_2020_evt.jsp");
	return;
}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/event/y2020/new_semester_pro_m.css"/>
...
<div id="eventWrap">
    ...
    <div id="floating_bnr" class="floating_bnr">
        <a href="/mobilefirst/event2020/newsemester_2020.jsp?tab=1" target="_blank" onclick="da_ga(5)"><img src="http://img.enuri.info/images/event/2020/new_semester_pro/fl_bnr.png" alt="매주 목요일 새학기 타임딜"></a>
        <!-- 닫기 -->
		...
		<div class="section floattab">
			<div class="contents">
				<ul class="floattab__list">
					<li><a href="#evt1" onclick="da_ga(2)" class="floattab__item floattab__item--01">내 친구 찾으면 커피빈 세트</a></li>
					<li><a href="#evt2" onclick="da_ga(3)" class="floattab__item floattab__item--02">새학기 준비하고 갤럭시 탭 당첨</a></li>
					<li><a href="javascript:///" onclick="go_ex();da_ga(4)" target="_blank" class="floattab__item floattab__item--03">인싸되는 새학기 쇼핑</a></li>
				</ul>
			</div>
		</div>
	...
	<div id="evt1" class="section evt_1st scroll">
		<div class="contents">
			<h2><img src="http://img.enuri.info/images/event/2020/new_semester_pro/m_event_01_tit.png" alt="개강 첫날! 내친구는 누구일까? 매일매일 커피빈 짝꿍세트 당첨!"></h2>
			<span class="evt_gift"><img src="http://img.enuri.info/images/event/2020/new_semester_pro/m_event_01_gift.jpg" alt="커피빈 환상의 짝꿍세트 (e11,100)"></span>
			<!-- 게임화면 -->
			<div class="game_wrap">
				<div class="game_main">	
					<!-- 친구들 -->
					<div class="obj_box">						
						<span class="buddy obj_buddy_01" title="내 친구는 누구일까요?">
							<span class="obj_body"></span><span class="obj_arm"></span>
						</span>
						<span class="buddy obj_buddy_02" title="내 친구는 누구일까요?">
							<span class="obj_body"></span><span class="obj_arm"></span>
						</span>
						<span class="buddy obj_buddy_03" title="내 친구는 누구일까요?">
							<span class="obj_body"></span><span class="obj_arm"></span>
						</span>
					</div>
					<span class="txt_game_01">개강 첫 날 학교로 가는길! 반갑게 인사하는 사람들 중 내친구를 찾아주세요!</span>
				</div>
			</div>
	...
	<div class="section pro_itemlist">
		<div class="contents">
			<h3 class="tit">인싸되는 <em>새학기 쇼핑 가이드</h3>
			
			<!-- 추천상품 탭 -->
			<ul class="pro_tabs">
				<li class="active"><a href="#protab1">새학기 패션</a></li>
				<li><a href="#protab2">새학기 가전</a></li>
				<li><a href="#protab3">새학기 가구</a></li>
				<li><a href="#protab4">새학기 문구</a></li>
			</ul>
			<!-- //추천상품 탭 -->
	...
	<div class="section evt_2rd scroll">
		<h3 class="tit">APP에서 설 선물구매하면</h3>
		<p class="blind">새학기 필수템 <em>갤럭시 탭 당첨!</p>
		<div class="contents">			
			<div class="evt2_area">
				<div class="evt2_area__inner">
					<div class="blind">
						<ol>
							<li>1등 [정품] 갤럭시탭A 10.1 2019 Wifi 32G (실물배송) 3명 추첨</li>
							<li>2등 [본도시락] 춘천식닭구이 도시락세트(e 8,400점) 15명 추첨</li>
							<li>3등 [베스킨라빈스] 싱글레귤러 (e 3,200점) 50명 추첨</li>
						</ol>				
					</div>
				</div>				
				<ul class="btn_wrap">
				...
				<ul class="evt_info">					
					<li>이벤트 참여 및 구매 기간 : 2020년 2월 10일 ~ 3월 8일 </li>
					<li>참여 방법 : APP &gt; 적립대상 쇼핑몰에서 구매하고 응모하기</li>
					<li>당첨자 발표 : 2020년 5월 21일 목요일 [에누리 앱 &gt; 이벤트/기획전 &gt; 이벤트 하단 당첨자 발표]</li>
		...
		<div class="caution-wrap">
			...
			<div class="moreview" style="border-bottom:1px solid #222">
				...
				<div class="txt">
					<dl class="txtlist">
						<dt>이벤트/구매 기간 :</dt>
						<dd>2020년 2월 10일 ~ 2020년 3월 8일</dd>
					</dl>

					<dl class="txtlist">
						<dt>당첨자 발표 및 적립</dt>
						<dd>2020년 5월 21일 [APP 이벤트/기획전 탭 > 이벤트 하단 당첨자 발표]</dd>
					</dl>
					
					<dl class="txtlist">
						<dt>경품 : </dt>
						<dd>1등 – 삼성전자 갤럭시탭A 10.1 2019 WiFi 32G - 3명 추첨  <strong class="emp">※제세공과금 당첨자 부담</strong></dd>
						<dd>2등 – 본도시락 춘천식닭구이 도시락세트 (e 8,400점) - 15명 추첨</dd>
						<dd>3등 – 베스킨라빈스 싱글레귤러 (e 3,200점) – 50명 추첨<br/><br/></dd>
		...
		<div class="cont_area">
			<div class="img_box">
				...
				<div class="result_01" style="display:none">
					<img src="http://img.enuri.info/images/event/2020/new_semester_pro/m_result_img_01.jpg" alt="축하해요~!! e머니 11,100점 적립 내일 또 만나요~" />
				</div>
				<!-- 꽝 - 교수님이셨네요 - 5점 적립 -->
				<div class="result_02" style="display:none">
					<img src="http://img.enuri.info/images/event/2020/new_semester_pro/m_result_img_02.jpg" alt="5점 적립~" />
				</div>
				<!-- 꽝 - 선배님이셨네요 - 5점적립 -->
				<div class="result_03" style="display:none">
					<img src="http://img.enuri.info/images/event/2020/new_semester_pro/m_result_img_03.jpg" alt="5점 적립~" />
				</div>
			</div>
...
function da_ga(num){
	...
	if(num == 2){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_탭_이벤트1");
	}else if(num == 3){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_탭_이벤트2");
	}else if(num == 4){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_탭_새학기쇼핑");
	}else if(num == 5){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_상단플로팅배너");
	}else if(num == 6){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_이벤트1참여");
	}else if(num == 7){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_상품탭_새학기패션");
	}else if(num == 8){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_상품탭_새학기가전");
	}else if(num == 9){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_상품탭_새학기가구");
	}else if(num == 10){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_상품탭_새학기문구");
	}else if(num == 11){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_상품클릭");
	}else if(num == 12){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_상품더보기");
	}else if(num == 13){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_기획전보러가기");	
	}else if(num == 14){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_구매응모하기");
	}else if(num == 15){
		ga('send', 'event', 'mf_event', vEvent_title, "20년 새학기프로모션_혜택배너");
	}
}
...
function go_ex(){
	window.open("/mobilefirst/event2020/newsemester_2020.jsp?tab=1");
}
...
$(document).ready(function() {
	...
	ga('send', 'pageview', {'page': vEvent_page,'title': '20 새학기_PV'});
	...
	$(".btn_goevt").click(function(){
		da_ga(13);
		window.open("/mobilefirst/event2020/newsemester_2020.jsp");
		return false;
	});
	...
	$(".sprite.btn_more").click(function(){
		var tabnum = nowTab+1;
		var goods_more = "/mobilefirst/event2020/newsemester_2020.jsp?tab="+tabnum;
		da_ga(12);
		window.open(goods_more); 
	});
	
	$("#snslayer li").click(function(){
		var shareUrl = "http://" + location.host + "/mobilefirst/event2020/newsemester_2020_evt.jsp";
		var shareTitle = "[에누리 가격비교]\새학기 이벤트!";
		var idx = $(this).index();
		...
		if(idx == 1) {
			 try{ 
				...
				Kakao.Link.sendDefault({
				      ...
				      content: {
				        title: shareTitle,
				        description: "새학기프로모션기에에누리다!\n새학기 준비하면,\n삼성 갤럭시탭 추첨증정!",
				        imageUrl: "<%= ConfigManager.IMG_ENURI_COM%>/images/mobilenew/images/sns_newsemester_1200_630.jpg",
				        link: {
...
function getEventAjaxData(params, callback){
	...
	if(!islogin()){
		...
		if(!getSnsCheck()){
			...
			var evtUrl = "/mobilefirst/evt/ajax/newsemester2020_setlist.jsp";
