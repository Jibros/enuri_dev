		...
		<div class="moreview">
			...
			<div class="txt">
				...
				<ul class="txt_indent">
					...
					<li><b>적립대상 쇼핑몰: </b>G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프, 쿠팡, GS SHOP, CJmall, SSG (신세계몰, 신세계백화점, 이마트몰, 트레이더스), SK스토아</li> 
					...
					<li>동일한 본인인증으로 가입한 ID의 경우 중복참여불가</li>
...
(function() {
	//스탬프 이벤트 정보
	var stampInfo = {
		eventCode : "2020060101",
		startDate : "20200601", //이벤트 시작날짜 꼭 넣어준다
		endDate : 	"20200630", //이벤트 종료 날짜
		total_stampcnt : 8,
