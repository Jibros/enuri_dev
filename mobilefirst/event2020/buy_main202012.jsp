...
<div class="wrap">
	...
	<div class="evt_content contents">	
									...
									<dl>
										...
										<dd>									
											<ul>
												...
												<!-- 201106 : 내용 수정 -->
												<li>이벤트 기간 내 구매 건 중 2021년 1월 31일까지의 구매확정(배송완료)건 기준으로 이벤트 대상자 선정됩니다.</li>
												<!-- // -->
		...
		<div class="bnr_wrap">
			...
			<a href="/mobilefirst/evt/vip_award.jsp" target="_blank" title="새 창에서 열립니다.">오직 VIP고객님만을 위한 2020 VIP AWARD - 입장하기 -</a>				
		</div>
