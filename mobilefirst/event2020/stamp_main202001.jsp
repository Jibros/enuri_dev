...
<div id="tab2" class="nuripang_stamp">
	<div class="inner">
		...
		<div class="view_cont">
			...
			<ul class="info_list">
                <li><strong>· 이벤트 기간 :</strong> 2019년 1월 2일~2020년 2월 2일</li>
                <li><strong>· 경품 지급일 :</strong> 2020년 3월 23일</li>
            </ul>
	...
	<div class="caution-wrap">
		...
		<div class="moreview">
			...
			<div class="txt">
				...
				<ul class="txt_indent">
					<li>
						참여방법: 에누리 가격비교 앱 로그인 &rarr; 적립대상 쇼핑몰 이동 &rarr; 
						<span class="stress">1만원 이상 구매</span>
						&rarr; 스탬프 참여
					</li>
					<!-- 
					<li>
					 ...
					 -->
					<li><b>적립대상 쇼핑몰: </b>G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프,<br/>쿠팡, GS SHOP, CJmall, SSG (신세계몰, 신세계백화점, 이마트몰, 트레이더스),마이크로소프트(스마트 스토어)</li> 
					...
					<li><b class="stress">경품지급 제외</b>: 아래의 경우 이벤트 참여는 가능하나 경품 지급대상에서 제외됩니다.
						<ul class="txt_indent">
							...
							<!-- <li>모바일 앱 &gt; 적립내역 페이지에서 구매적립 받지 않은 경우</li> -->
				...
				<ul class="txt_indent">
					...
					<li>에누리 가격비교 앱 미 로그인 후 구매한 경우 또는 에누리 가격비교 PC, 모바일 웹에서 구매한 경우
						<br>
						...
						<ul class="txt_indent">
							...
							<li>SSG: 도서/음반/문구/취미/여행, 모바일쿠폰/상품권 전체
...
(function() {
	//스탬프 이벤트 정보
	var stampInfo = {
		eventCode : "2020010101",
		startDate : "20200102", //이벤트 시작날짜 꼭 넣어준다
		endDate : 	"20200202", //이벤트 종료 날짜
		total_stampcnt : 8,
