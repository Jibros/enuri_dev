						...
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<ul>
										<!-- 200716 : 날짜/문구 변경 -->
										<li>이벤트 대상 : 이벤트 기간 내 스탬프 1회 이상 참여 후 8월 생일 이벤트 신청한 고객</li>
	...
	<div class="contents">
		...
		<div class="comeback__cont">
			<div class="inner">
				<div class="txt_box">
					<ul>
						<li><strong>이벤트 대상 <span class="point">:</span></strong> 2020년 6월 1일 이후<br> 구매이력 없는 회원 대상</li>
						...
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<ul>
										<!-- 200716 : 날짜/문구 변경 -->
										<li>이벤트 대상 : 2016년 2월 1일 ~ 2020년 5월 31일 이내 에누리 모바일 앱을 통한 구매이력 있으나,&nbsp;2020년 6월 1일&nbsp;이후 구매이력 없는 고객 (※ 1천원 이상 구매 후 컴백 이벤트 신청한 고객)</li>
