...
<div class="wrap">
	...
	<div class="evt_content contents">	
									...
									<dl>
										...
										<dd>									
											<ul>
												...
												<li>이벤트 기간 내 구매 건 중 2020년 12월 31일까지의 구매확정(배송완료)건 기준으로 이벤트 대상자 선정됩니다.</li>
		...
		<div class="bnr_wrap">
			<h3 class="blind">2020 VIP AWARD</h3>

			<div class="imgs">오직 VIP고객님만을 위한 2020 VIP AWARD - COMMING SOON -</div>				
		</div>
		<div id="evt2" class="evt-added">
			<div class="contents">
				...
				<div class="added__cont">
					...
					<div id="slidePop2" class="evt_notice--slide" style="display: none;">
						<div class="evt_notice--inner">
							<div class="evt_notice--head">유의사항</div>
							<div class="evt_notice--cont">
								<div class="evt_notice--continner">
	...
	if(navigator.userAgent.indexOf("Android") > -1){ // 안드로이드
		...
		if(uagentLow.search("android") > -1){
			...
			if (chrome25 && !kitkatWebview){
				location.href = "enuri://event?eventurl=&eventstartdate=&eventrepeatday=&eventdetailurl=http://m.enuri.com/mobilefirst/evt/buy_event.jsp";
			} else{
				location.href = "enuri://event?eventurl=&eventstartdate=&eventrepeatday=&eventdetailurl=http://m.enuri.com/mobilefirst/evt/buy_event.jsp";
			}
		}
		goApp = "enuri://event?eventurl=&eventstartdate=&eventrepeatday=&eventdetailurl=http://m.enuri.com/mobilefirst/evt/buy_event.jsp";
	}else{
		setTimeout( function() {
