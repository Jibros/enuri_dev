	...
	<div class="contents">
	    ...
	    <!-- 20190918 : 추가 -->
			<div class="inner">
				<div class="info_list">
					<ul>
						<li><strong>이벤트 대상 :</strong> 10월 생일인 스탬프 참여 고객</li>
		...
		<div class="comeback__cont">
			<div class="inner">						
				<div class="info_list">
					<!-- 200910 : 내용 수정 -->
					<ul>
						<li><strong>이벤트 대상 :</strong> 2020년 8월 1일 이후<br> 구매 이력이 없는 고객</li>
						<li><strong>이벤트 기간 :</strong> 2020년 10월 5일 ~ 11월 1일</li>
						...
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<!-- 200910 : 내용 수정 -->
									<ul>
										<li>이벤트 대상 : 2016년 2월 1일 ~ 7월 31일 이내 에누리 모바일 앱을 통한 구매이력 있으나,&nbsp;2020년 8월 1일 이후 구매이력 없는 고객 (※ 1천원 이상 구매 후 컴백 이벤트 신청한 고객)</li>
										<li>이벤트 기간 : 2020년 10월 5일 ~ 11월 1일</li>
