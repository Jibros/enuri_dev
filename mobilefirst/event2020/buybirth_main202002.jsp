					...
					<div class="caution-wrap">
						...
						<div class="moreview">
							...
							<div class="txt">
								...
								<ul class="txt_indent">
									<li><b>이벤트 대상: 스탬프 1회 이상 참여자 중 2월 생일인 회원 대상</b></li>
	...
	<div class="contents">
		...
		<div class="comeback__cont">
			<div class="inner">
				<div class="txt_box">
					<ul>
						<li><strong>이벤트 대상 <span class="point">:</span></strong> 2019년 12월 1일 이후<br> 구매이력 없는 회원 대상</li>
			...
			<div class="caution-wrap">
				...
				<div class="moreview">
					...
					<div class="txt">
								...
								<ul class="txt_indent">
									<li>2016년 2월 1일 이후 에누리 앱을 통하여 구매 및 적립이력 있으나, <span>2019년 12월 1일</span> 이후 구매이력 없는 회원 대상</li>
									<li>아래의 경우에는 이벤트 대상에 해당되지 않습니다<br>
										- 2016년 2월 1일~2019년 11월 30일 기간 내 구매이력 없는 회원<br>
										- <span>2019년 12월 1일</span> 이후 가입한 회원(신규가입자)<br>
										- <span>2019년 12월 1일</span> 이후 구매이력 있는 회원
									</li>
								</ul>
...
(function() {
	...
	$("#bitrhdayStamp").click(function(e){
		...
		if(<%=sdt%> > stampInfo.endDate){
			...
			$.post("/mobilefirst/evt/ajax/ajax_birthdayStamp_proc.jsp",{ procCode : 1,  sdt : <%= sdt %> , osType:"M" }, function(json){
	...
	$("#bitrhdayStamp_ins").click(function(e){
		...
		$.post("/mobilefirst/evt/ajax/ajax_birthdayStamp_proc.jsp",{ procCode : 2,  sdt : <%= sdt %> , osType:"M" }, function(json){
