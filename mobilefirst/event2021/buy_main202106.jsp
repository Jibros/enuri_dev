	...
	<div class="evt_content">
						...
						<div class="evt_notice--cont">
							<div class="evt_notice--continner">
								...
								<dl>
									...
									<dd>
										<ul>
											<li>참여방법 : 에누리 가격비교 모바일 앱 로그인 &rarr; 적립대상 쇼핑몰 이동 &rarr; <span class="stress">대상 카테고리 1천만원 이상 구매</span> &rarr; VIP맞춤적립 이벤트 신청<br/>
											...
											<li>이벤트 기간 내 구매 건 중 2021년 7월 31일까지의 구매확정(배송완료)건 기준으로 이벤트 대상자 선정됩니다.</li>
		...
		<div class="section crownsave" id="evt2">
			...
			<div class="crownsave_notice">
				<div class="contents">
					<ul class="event_info">
						<li>이벤트 신청 기간 : 2021년 5월 3일 ~ 2021년 5월 31일</li>
						<li>이벤트 구매 기간 : 2021년 5월 1일 ~ 2021년 7월 31일 (월별)</li>
						<li>이벤트 혜택 및 혜택 지급일<br />
							<ul class="sub">
								<li>2021년 5~6월 연속 구매 : e머니 2만점 / 2021년 8월 19일</li>
								<li>2021년 5~7월 연속 구매 : e머니 5만점 / 2021년 9월 16일</li>
							</ul>
						</li>
					</ul>
				</div>
						...
						<div class="evt_notice--cont">
							<div class="evt_notice--continner">
								...
								<dl>
									...
									<dd>									
										<ul>
											<li>참여방법 : 에누리 가격비교 모바일 앱 로그인 &rarr; 트리플적립 이벤트 신청 &rarr; 적립대상 쇼핑몰 이동 &rarr; <span class="stress">월 1천만원 이상 2~3달 연속 구매</span><br/>
												<span class="noti">※ 이벤트 신청의 경우 PC 및 모바일 앱/웹에서 로그인 후에도 가능합니다.</span>
											</li>
											<li>적립대상 쇼핑몰 : G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프, 쿠팡, GS SHOP, CJmall, SSG (신세계몰, 신세계백화점, 이마트몰, 트레이더스), SK스토아, 홈플러스<br/>
												<span class="stress noti">※ 구매 유의사항 및 구매적립 제외 카테고리는 이벤트 페이지 하단 'e머니 구매혜택' 유의사항을 꼭 확인하세요.</span>
											...
											<li>구매금액은 배송비, 설치비, 할인, 쇼핑몰 포인트 등 제외한 금액만 반영됩니다.</li>
											<li>이벤트 기간 내 5~6월 연속 구매 건 2021년 7월 31일, 5~7월 연속 구매 건 2021년 8월 31일까지의 구매확정(배송완료)건 기준으로 이벤트 대상자 선정됩니다.</li>
											<li>구매 후 취소하였으나 적립된 e머니가 있을 경우 해당 적립액은 혜택 지급 제외됩니다.</li>
											<li><span class="stress">이벤트 대상 제외 :</span> 아래의 경우에는 이벤트 대상 및 혜택 지급에서 제외됩니다. <br/>
												<ul class="sub">
...
$(function(){
    ...
    $("#unlimitSaving").click(function(){eventCall( {eventName : "트리플적립", eventCode : "<%=eventCode2%>" });});
	...
	function eventCall ( eventObj ){
		...
		$.post("/mobilefirst/event2016/ajax/ajax_event_buy.jsp" , {"osType" : getOsType(), eventCode : eventObj.eventCode , kind : "Y"  } ,function(json){
			if(json.payYN == 0){
			...
			$.post("/mobilefirst/event2016/ajax/ajax_event_buy.jsp" , {"osType" : getOsType(), eventCode : eventObj.eventCode } ,
				function(json){
					if(json.result == "chk1"){
						...
						var r = confirm("종료된 이벤트입니다.");
						if(r){
							location.href = "https://m.enuri.com/mobilefirst/evt/buy_event.jsp";
						}
					}else{
						alert("신청 완료!\n혜택 지급일을 기다려주세요!^^");
					}
