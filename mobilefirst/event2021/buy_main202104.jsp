...
<div class="wrap">
	...
	<div class="evt_content">
								...
								<dl>
									...
									<dd>
										<ul>
											...
											<li>이벤트 기간 내 구매 건 중 2021년 5월 31일까지의 구매확정(배송완료)건 기준으로 이벤트 대상자 선정됩니다.</li>
		...
		<div class="section crownsave" id="evt2" style="display:none;">
			<div class="contents">
...
$(function(){
	...
	function eventCall ( eventObj ){
		...
		if(eventObj.eventCode == "2021010103"){ // 트리플적립 제외
			return false;
