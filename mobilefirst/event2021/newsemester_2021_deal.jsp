...
if( ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPhone") > -1
	...
	if(strServerNm.indexOf("dev.enuri.com") > -1){
		response.sendRedirect("http://dev.enuri.com/event2021/newsemester_2021_deal.jsp"); //PC경로		
	}else{
		response.sendRedirect("http://www.enuri.com/event2021/newsemester_2021_deal.jsp"); //PC경로
	}
	return;
}
...
<!-- 비쥬얼,플로팅탭 -->
	...
	<!-- T2 이벤트 02 : 성탄절 타임특가 -->
	<div id="event02" class="section event_special">
		<div class="contents">
			<p class="tit_sub">매주 수요일 오후 2시 OPEN</p>
			<h2 id="htit" class="tit"><strong>2월 17일</strong><span class="img_tit">새학기 타임특가</span></h2>
			<!-- 딜 구매영역 -->
			<div class="dealwrap">
		...
		<div class="contents">
			...
			<div class="evt_area">
				<div class="evt_area__inner">
					<div class="blind">
						<ol>
							<li>1등 [삼성전자] 갤럭시 탭 A7 10.4 WiFi 64GB(실물배송/색상랜덤) 2명 추첨</li>
							<li>2등 [해피머니] 온라인 상품권 5천원권 (e 5,000점) 10명 추첨</li>
							<li>3등 [맥도날드] 에그 맥머핀 세트 (e 3,500점) 40명 추첨</li>
						</ol>				
					</div>
					<!-- 210225 : 버튼 추가 -->
					<a href="javascript:void(0);" class="btn_ready" id="btn_ready_id">새학기 준비하기</a>
				...
				<div class="evt_notice--cont">
					<div class="evt_notice--continner">
						<dl>								
							...
							<dd>
								<ul>
									<li>이벤트/구매 기간 : 2021년 2월 15일 ~ 2021년 3월 14일</li>
									<li>당첨자 발표 및 적립 : 2021년 6월 24일 [APP 이벤트/기획전 탭 &gt; 이벤트 하단 당첨자 발표]</li>
									<li>경품 :
										<ul class="sub">
											<li>1등 – 삼성전자 갤럭시탭 A7 10.4 WiFi 64GB - 2명 추첨 <span class="noti stress">※제세공과금 당첨자 부담</span></li>
											<li>2등 – 해피머니 온라인 상품권 5천원권 (e 5,000점) - 10명 추첨</li>
											<li>3등 – 맥도날드 에그맥머핀 세트 (e 3,500점) – 40명 추첨</li>
										</ul>
									</li>
			...
			<div class="inner">
				...
				<div class="vote_img">
					...
					<div class="result_01" style="display:none">
						<img src="//img.enuri.info/images/event/2020/xmas/w_result_img_01.png" alt="축하합니다! e머니 100점 적립 ">
					</div>
					<!-- 당첨 - GS25상품권 당첨(1,000점 적립) 이미지 -->
					<div class="result_02" style="display:none">
						<img src="//img.enuri.info/images/event/2020/xmas/w_result_img_02.png" alt="축하합니다! GS25상품권에 당첨됐어요!(1,000점 적립)">
					</div>
					<!-- 당첨 - GS25상품권 당첨(5,000점 적립) 이미지 -->
					<div class="result_03" style="display:none">
						<img src="//img.enuri.info/images/event/2020/xmas/w_result_img_03.png" alt="축하합니다! GS25상품권에 당첨됐어요!(5,000점 적립)">
					</div>
					<!-- 당첨 - 빅맥버거세트 당첨(5,900점 적립) 이미지 -->
					<div class="result_04" style="display:none">
						<img src="//img.enuri.info/images/event/2020/xmas/w_result_img_04.png" alt="축하합니다! 빅맥버거세트에 당첨됐어요!(5,900점 적립)">
					</div>
					<!-- 당첨 - 에어팟프로 당첨 이미지 -->
					<div class="result_05" style="display:none">
						<img src="//img.enuri.info/images/event/2020/xmas/w_result_img_05.png" alt="축하합니다! 에어팟프로에 당첨됐어요 실물경품은 이벤트 마감 후 일괄배송됩니다. 조금만 기다려주세요!">
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function view_moapp(){
		...
		var openAt = new Date;
		var url = "";
		url = encodeURIComponent("http://" + location.host + "/mobilefirst/event2021/newsemester_2021_deal.jsp?freetoken=event"); 
	...
	$(document).ready(function(){
	    ...
	    if(tab == '01'){
 		...
 		$("#btn_ready_id").click(function(){
 			ga_log(11);
 			location.href = "http://" + location.host + "/mobilefirst/event2021/newsemester_2021.jsp"; 
 		});
...
/* 		setTimeout(function(){
		...
		//딜 상품
		$.ajax({
			  url: "/mobilefirst/http/json/exh_deal_list_2021021500.json"
			, dataType : "json"
			, cache    : false
...
//	 				$('.dealwrap h2 .tit_date').css({ 'padding-top': '75px'});
	...
	function dealDate(){
		...
		$txt_month.html('<strong>'+dealDate[0]+'월 '+dealDate[1]+'일'+'</strong><span class="img_tit">새학기 타임특가</span>');
	}
