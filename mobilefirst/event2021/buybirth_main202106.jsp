	...
	<div class="contents">
		...
		<div class="birthday__cont">
			<div class="inner">
				<div class="info_list">
					<ul>
						<li><strong>이벤트 대상 </strong>: 6월 생일 이벤트 신청 고객</li>
						<li><strong>이벤트 기간 </strong>: 2021년 6월 1일 ~ 2021 년 6월 30일</li>
						...
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<!-- 210412 : 수정 -->
									<ul>
										<li>이벤트 대상 : 이벤트 기간 내 스탬프 1회 이상 참여 후 6월 생일 이벤트 신청 고객</li>
										<li>이벤트 기간 : 2021년 6월 1일 ~ 2021 년 6월 30일</li>
		...
		<div class="comeback__cont">
			<div class="inner">						
				<div class="info_list">
					<!-- 210412 : 수정 -->
					<ul>
						<li><strong>이벤트 대상 </strong>: 2021년 4월 1일 이후 구매 이력이 없는 고객</li>
						<li><strong>이벤트 기간 </strong>: 2021년 6월 1일 ~ 2021 년 6월 30일</li>
						...
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<!-- 210412 : 수정 -->
									<ul>
										<li>이벤트 대상 : 2016년 2월 1일 ~ 2021년 3월 31일 이내 에누리 모바일 앱을 통한 구매이력 있으나, 2021년 4월 1일 이후 구매이력 없는 고객 (※ 1천원 이상 구매 후 컴백 이벤트 신청한 고객)</li>
										<li>이벤트 기간 : 2021년 6월 1일 ~ 2021 년 6월 30일</li>
