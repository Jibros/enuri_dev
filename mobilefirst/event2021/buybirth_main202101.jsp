	...
	<div class="contents">
		...
		<div class="birthday__cont">
			<div class="inner">
				<div class="info_list">
					<ul>
						<li><strong>이벤트 대상 </strong>: 1월 생일 이벤트 신청 고객</li>
						<li><strong>이벤트 기간 </strong>: 2021년 1월 4일 ~ 1월 31일</li>
						<li><strong>혜택 지급일 </strong>: 2021년 3월 25일</li>
					</ul>
				</div>
			</div>
			<!-- // -->
						...
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<!-- 201209 : 내용 수정 -->	
									<ul>
										<li>이벤트 대상 : 이벤트 기간 내 스탬프 1회 이상 참여 후 1월 생일 이벤트 신청 고객</li>
		...
		<div class="comeback__cont">
			<div class="inner">						
				<div class="info_list">
					<!-- 201015 : 내용 수정 -->	
					<ul>
						<li><strong>이벤트 대상 </strong>: 2020년 11월 1일 이후 구매 이력이 없는 고객</li>
						<li><strong>이벤트 기간 </strong>: 2021년 1월 4일 ~ 1월 31일</li>
						...
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<!-- 201209 : 내용 수정 -->	
									<ul>
										<li>이벤트 대상 : 2016년 2월 1일 ~ 10월 31일 이내 에누리 모바일 앱을 통한 구매이력 있으나,&nbsp;2020년 11월 1일 이후 구매이력 없는 고객 (※ 1천원 이상 구매 후 컴백 이벤트 신청한 고객)</li>
										<li>이벤트 기간 : 2021년 1월 4일 ~ 1월 31일</li>
