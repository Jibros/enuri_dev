...
if( ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPhone") > -1
	...
	if(strServerNm.indexOf("dev.enuri.com") > -1){
		response.sendRedirect("http://dev.enuri.com/event2021/family_2021_deal.jsp"); //PC경로		
	}else{
		response.sendRedirect("http://www.enuri.com/event2021/family_2021_deal.jsp"); //PC경로
	}
	return;
}
...
<!-- 비쥬얼,플로팅탭 -->
	...
	<!-- T2 이벤트 02 : 성탄절 타임특가 -->
	<div id="event02" class="section event_special"> <!-- id ="evt1" -->
		<div class="contents">
			<p class="tit_sub">매주 수요일 오후 2시 OPEN</p>
			<h2 id="htit" class="tit"><strong>4월 14일</strong><span class="img_tit">가정의 달 타임특가</span></h2>
			<!-- 딜 구매영역 -->
			<div class="dealwrap">
	...
	<div class="section event_buy" id="event05">
		<div class="contents">
			<h2>가로, 세로, 대각선  상관없이 1줄 이상맞추면 상품이 팡팡! 빙고를 맞춰라 !</h2>
			<p class="blind">다양한 카테고리에서 많이 구매할수록 당첨확률 UP! UP!</p>
			...
			<div class="evt_area">
				<div class="evt_area__inner">
                    ...
                    <a href="javascript:void(0);" class="btn_ready" id="btn_ready_id">기획전 보러가기</a> <!-- tab3이동 -->
                    <button type="button" id="event2_join" class="btn_apply" tabType="05">응모하기</button>
                </div>
            </div>
            <div class="subevt_area">
                <p class="subevt_tit">다양한 카테고리에서 많이 구매할수록 당첨확률 UP! UP!</p>
                <div class="subevt_area__inner">
                    <div class="blind">
                        <ol>
                            <li>1등, [LG전자] 디오스 W087B 와인셀러 (실물배송) - 3명 추첨</li>
                            <li>2등, [깐부치킨] 순살크리스피 치킨 (e머니 18000점) - 10명 추첨</li>
                            <li>3등, [이디야커피] 우리함께해 세트 (e머니 5000점) - 50명 추첨</li>
						</ol>				
					</div>
				</div>
			</div>
		...
		<!-- 공통 : 꼭 확인하세요  -->
		<div class="com__evt_notice">
			<div class="evt_notice--btn_area"><button class="btn__evt_notice" data-laypop-id="slidePop4"><span>꼭! 확인하세요</span></button></div> <!-- 열기 : 유의사항 열기 -->
		</div>
				...
				<div class="evt_notice--cont">
					<div class="evt_notice--continner">
						<dl>								
							...
							<dd>
								<ul>
									<li>이벤트/구매 기간 : 2021년 4월 12일 ~ 2021년 5월 9일</li>
                                    <li>당첨자 발표 및 적립 : 2021년 8월 26일 [APP 이벤트/기획전 탭 &gt; 이벤트 하단 당첨자 발표]</li>
                                    <li>경품 :
                                        <ul class="sub">
                                            <li>1등 – LG전자 디오스 W087B 와인셀러 (실물배송) – 3명 추첨 <span class="noti stress">※제세공과금 당첨자 부담</span></li>
                                            <li>2등 – 깐부치킨 순살크리스피 치킨 (e 18,000점) - 10명 추첨</li>
                                            <li>3등 – 이디야커피 우리함께해 세트 (e 5,000점) – 50명 추첨</li>
										</ul>
									</li>
									...
									<li>동일한 이벤트 기간의 VIP맞춤적립 이벤트 혜택받은 경우 중복 혜택 지급이 불가합니다.</li>
								</ul>
							</dd>
						</dl>
						<dl>								
	...
	<div class="otherbene">
        <div class="inner">
            ...
            <ul class="ben_list">
                <li class="ben_item--01"><a href="http://m.enuri.com/mobilefirst/evt/welcome_event.jsp?freetoken=event" target="_blank">첫구매 고객이라면! Welcome 혜택</a></li>
...
<div class="complete_layer" id="completeJoin" style="display: none;">
	<div class="inner_layer">
		<div class="cont_area">
			...
			<div class="img_box">
				<a href="http://m.enuri.com/mobilefirst/evt/smart_benefits.jsp"><img src="//img.enuri.info/images/event/2021/new_semester/m_complete_img.jpg" alt="1만원 이상 구매했다면? 쇼핑에-누리다."></a>
			</div>
		</div>
		<a class="btn layclose" href="javascript:void(0);" onclick="onoff('completeJoin'); return false;"><em>팝업 닫기</em></a>
	</div>
</div>
...
$(document).ready(function(){
	//ga > pageview
	if(tab == '01'){
		$('html, body').stop().animate({scrollTop: Math.ceil($('#event02').offset().top- $(".navtab").outerHeight())}, 0);
	}
		
	$("#btn_ready_id").click(function(){
		ga_log(11);
		location.href = "http://" + location.host + "/mobilefirst/event2021/family_2021.jsp?tab=01"; 
	});
	...
	//#애드브릭스
	setTimeout(function(){
		welcomeGa("evt_family2021_deal_view");
	}, 500);

	//딜 상품
	$.ajax({
		  url: "/mobilefirst/http/json/exh_deal_list_2021041200.json"
		, dataType : "json"
		, cache    : false
...
function dealDate(){
	...
	$txt_month.html('<strong>'+dealDate[0]+'월 '+dealDate[1]+'일'+'</strong><span class="img_tit">가정의의 달 타임특가</span>');
}
...
function view_moapp(){
	var dealType = $('.btn_go_app').attr("dealType");
	var chrome25;
	var kitkatWebview;
	var uagentLow = navigator.userAgent.toLocaleLowerCase();
	var openAt = new Date;
	var url = "";
	url = encodeURIComponent("http://" + location.host + "/mobilefirst/event2021/family_2021_deal.jsp?tab="+dealType+"&freetoken=event"); 
