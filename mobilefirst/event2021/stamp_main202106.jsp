...
<div id="tab2" class="nuripang_stamp">
	<div class="inner">
		...
		<div class="view_cont">
			...
			<ul class="info_list">
				<li><strong>· 이벤트 기간 :</strong> 2021년 6월 1일 ~ 2021년 6월 30일</li>
				<li><strong>· 혜택 지급일 :</strong> 2021년 8월 19일</li>
			</ul>
		</div>
	</div>
			...
			<div class="evt_notice--cont">
				<div class="evt_notice--continner">
					...
					<dl>
						...
						<dd>
							<ul>
								<li>참여방법 : 에누리 가격비교 모바일 앱 로그인 → 적립대상 쇼핑몰 이동 →&nbsp;<span class="stress">1만원 이상 구매</span>&nbsp;→ 누리팡 스탬프 이벤트 참여<br>
								...
								<li>이미 찍은 스탬프는 상품의 취소/환불시에도 없어지지는 않으며, 스탬프 참여건수와 취소/환불건 제외 후 1만원 이상 구매건수를 매칭하여 이벤트 혜택이 지급됩니다.</li>
								<li>
