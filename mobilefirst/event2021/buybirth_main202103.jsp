	...
	<div class="contents">
		...
		<div class="birthday__cont">
			<div class="inner">
				<div class="info_list">
					<ul>
						<li><strong>이벤트 대상 </strong>: 3월 생일 이벤트 신청 고객</li>
						<li><strong>이벤트 기간 </strong>: 2021년 3월 2일 ~ 2021년3월 31일</li>
						<li><strong>혜택 지급일 </strong>: 2021년 5월 20일</li>
					</ul>
				</div>
			</div>
			<!-- // -->
						...
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<!-- 201209 : 내용 수정 -->
									<ul>
										<li>이벤트 대상 : 이벤트 기간 내 스탬프 1회 이상 참여 후 3월 생일 이벤트 신청 고객</li>
										<li>이벤트 기간 : 2021년 3월 2일 ~ 2021년3월 31일</li>
										<li>이벤트 혜택 : e머니 500점</li>
										<li>혜택 지급일 :&nbsp;2021년 5월 20일<br>
											- Push 메시지로 당첨을 알려 드립니다. (Push 알림 미동의자 제외)
										</li>
...
<div id="evt2" class="comeback">
	<div class="contents">
		<h2>EVENT 02 오랜만에누리다</h2>
		<p class="blind">보고 싶었어요! WELCOME BACK! 지금 구매하면 e머니 2000점 100% 적립!</p>
		<div class="comeback_img">e머니 2000포인트</div>
		...
		<div class="comeback__cont">
			<div class="inner">
				<div class="info_list">
					<!-- 201015 : 내용 수정 -->
					<ul>
						<li><strong>이벤트 대상 </strong>: 2021년 1월 1일 이후 구매 이력이 없는 고객</li>
						<li><strong>이벤트 기간 </strong>: 2021년 3월 2일 ~ 3월 31일</li>
						<li><strong>혜택 지급일 </strong>: 구매일로부터 최대 30일 이내</li>
					</ul>
					<!-- // -->
				</div>
			</div>
						...
						<div class="evt_notice--continner">
							<dl>
								...
								<dd>
									<!-- 201209 : 내용 수정 -->
									<ul>
										<li>이벤트 대상 : 2016년 2월 1일 ~ 2020년 12월 31일 이내 에누리 모바일 앱을 통한 구매이력 있으나,&nbsp;2021년 1월 1일 이후 구매이력 없는 고객 (※ 1천원 이상 구매 후 컴백 이벤트 신청한 고객)</li>
										<li>이벤트 기간 : 2021년 3월 2일 ~ 3월 31일</li>
										<li>이벤트 혜택 : e머니 2,000점</li>
							...
							<dl>
								...
								<dd>
									<ul>
										...
										<!-- 201209 : 내용 추가 -->
										<li>3개월 내 이미 혜택을 지급 받은 고객은 이벤트 대상에서 제외 됩니다.</li>
										<!-- // -->
										<li>구매금액은 배송비, 설치비, 할인, 쇼핑몰 포인트 등 제외한 금액만 반영됩니다.</li>
										<li>
											<span class="stress">이벤트 대상 제외 :</span> 아래의 경우에는 이벤트 대상 및 혜택 지급에서 제외됩니다. <br>
...
/* 		if(getCookie("appYN")!='Y'){
		...
		$.ajax({
			...
			success:function(json){
				result = json.result;
				if(result==0 || result>5 || result==2 || result==-2){
