...
if(com.enuri.util.date.DateStr.nowStr("yyyy.MM.dd. HH:mm").compareTo("2019.11.01. 00:00")>=0 && com.enuri.util.date.DateStr.nowStr("yyyy.MM.dd. HH:mm").compareTo("2019.12.25. 23:59")<0){
	bannerOn = "winter";
}
...
<div class="dim" style="display:none;" id="notetxt2">
	<div class="noteLayer" >
		...
		<ul class="txtlist">
			...
			<li>당첨자 혜택 : <em>[GS25] 모바일상품권 2천원권 (e머니 2,000점) - 추첨 30명</em></li>
			<li>e쿠폰스토어에서 해당 경품 외 다양한 e쿠폰으로 교환할 수 있는 e머니를 적립해드립니다. <br />(제휴처 사정에 따라 해당 쿠폰 품절, 단종, 가격 변동 있을 수 있습니다.)</li>
			<li>당첨자 발표: <em>2020년 1월 14일 화요일</em></li> 
			<li>e머니 유효기간: <em>적립일로부터 15일 (미사용시 자동소멸)</em></li>
			<li>본 이벤트는 당사 사정에 따라 사전고지없이 변경 또는 종료 될 수 있습니다</li>
        </ul>
        <!-- // -->
	</div>
...
<div class="dim" style="display:none;" id="notetxt3">
	<div class="noteLayer" >
        ...
        <!-- 191114 유의사항 수정 -->
		<ul class="txtlist">
            <li>ID당 1일 2회 참여 가능</li>
            <li>1차 타임  12:00:00 AM ~ 02:59:59 PM</li>
            <li>2차 타임  03:00:00 PM ~ 23:59:59 PM</li>
            <li>룰렛 경품: [이디야] 우리 함께해 세트 (스노우쿠키슈+아메리카노) (e 5,000),[해피머니] 온라인상품권 (e 3,000), e10</li>
            <li>경품 당첨 시, e쿠폰스토어에서 해당 경품 외 다양한 e쿠폰으로 교환할 수 있는 e머니를 적립해드립니다. <br />(제휴처 사정에 따라 해당 쿠폰 품절, 단종, 가격 변동 있을 수 있습니다.)</li>
            <li>e머니 유효기간: 적립일로부터 15일 (미사용시 자동소멸)</li>
            <li>본 이벤트는 당사 사정에 따라 사전고지없이 변경 또는 종료 될 수 있습니다.</li>
        </ul>
        <!-- // -->
		...
		<div class="inner">
			...
			<a href="javascript:///" class="btn adbanner" onclick="goNewFriendGo()">
				<%if(bannerOn.equals("winter")){ %>
					<img src="<%=ConfigManager.IMG_ENURI_COM%>/images/event/2019/attendance/dec/m_xmas_banner.jpg" alt="크리스마스">
				<%}else{%>
...
<!-- 상단비주얼 -->
	<div class="evt_visual">
		...
		<div class="blind">
			<h1>누리DAY</h1>
			<p>매일매일 터지는 에누리의 특별한 혜택!</p>				
			<p>다양한 이벤트로 혜택 받아가세요!!</p>
		</div>
	</div>
	<!-- //상단비주얼 -->
		...
		<div class="floattab">
			<div class="contents">
				<ul class="floattab__list">
					<li><a href="#evt1" class="movetab floattab__item floattab__item--01 ">01 : 빼놓을 수 없는 출석체크!</a></li>
					<li><a href="#evt2" class="movetab floattab__item floattab__item--02">02 : 혜택이 펑펑! 매일룰렛</a></li>
				</ul>
			</div>
		</div>
...
var vEvent_title = "19년 출석/룰렛";
var sdt = "<%=sdt%>";
var reply_event_code = "2019120106"; //오늘의한마디 댓글 이벤트코드
var PAGENO = 1;
var PAGESIZE = 5;
var BLOCKSIZE = 5;
...
function goNewFriendGo(){
	...
	if(bannerOn=="chuseok01"){
		...
		window.open("http://m.enuri.com/mobilefirst/event2019/xmas_2019.jsp");
	}else{
...
$(document).ready(function() {
	...
	function setTodayComment(){
		var str = "",
			fClass = "";
		switch (Number(<%=sdt%>)) {
			case 20191201 : fClass = "f2"; str = "<p class='txt'><span>건강이 최고입니다 건강 챙기세요 </br> -k**8259님의 한마디- </span>"; break;
			case 20191202 : fClass = "f2"; str = "<p class='txt'><span>많이 웃고 마음 편안한 하루 보내세요 </br> -k**inw님의 한마디- </span>"; break;
			case 20191203 : fClass = "f2"; str = "<p class='txt'><span>아브라카다브라 수리수리마수리 </br> -2**0aea432d님의 한마디- </span>"; break;
			case 20191204 : fClass = "f2"; str = "<p class='txt'><span>감기 조심하세요 환절기라 몸이 적응을 해가는 이시기를 조심하세요! </br> -h**ng0314님의 한마디- </span>"; break;
			case 20191205 : fClass = "f2"; str = "<p class='txt'><span>건강을 위해 매일 한가지라도 실천하세요. </br> -w**ini7389님의 한마디- </span>"; break;
			case 20191206 : fClass = "f2"; str = "<p class='txt'><span>따듯한 커피 한잔으로 스트레스 날려버리시길~ </br> -r**a2000님의 한마디- </span>"; break;
			case 20191207 : fClass = "f2"; str = "<p class='txt'><span>찬이슬 머금은 한로의 당당한 발걸음에~ 바빠진 만산이 화사한 채색을 준비합니다~!!! </br> -c**gnsdhkd님의 한마디- </span>"; break;
			case 20191208 : fClass = "f2"; str = "<p class='txt'><span>기분나쁜 일은 훨훨 털어버리는 하루가 되시길 </br> -d**4c3f486f님의 한마디- </span>"; break;
			case 20191209 : fClass = "f2"; str = "<p class='txt'><span>건강은 그 무엇과도 바꿀 수 없다 </br> -k**014님의 한마디- </span>"; break;
			case 20191210 : fClass = "f2"; str = "<p class='txt'><span>고민과 아이디어 모두를 적어보자 때로는 머리가 아니라 손이 고민과 영감을 이끌기도한다. </br> -c**esbacks님의 한마디- </span>"; break;
			case 20191211 : fClass = "f2"; str = "<p class='txt'><span>힘든 한주가 지나가네요. 주말 좀 쉬면서, 쌓인 스트레스 풀어야겠어요 </br> -s**be2님의 한마디- </span>"; break;
			case 20191212 : fClass = "f2"; str = "<p class='txt'><span>언제나 당신은 최고에요 </br> -y**jo님의 한마디- </span>"; break;
			case 20191213 : fClass = "f2"; str = "<p class='txt'><span>감기 조심 하시고 좋은 하루 보내세요. </br> -c**raa님의 한마디- </span>"; break;
			case 20191214 : fClass = "f2"; str = "<p class='txt'><span>나는 부딪혀 보기로 했다. 언제나 그랬듯 삶이 내게 오는 만큼. 그리고 내가 느낄 수 있는 딱 그만큼을. </br> -y**1429님의 한마디- </span>"; break;
			case 20191215 : fClass = "f2"; str = "<p class='txt'><span>나만의 행복한 습관을 만들자! </br> -l**oncool1님의 한마디- </span>"; break;
			case 20191216 : fClass = "f2"; str = "<p class='txt'><span>따뜻한 홍차 한잔과 쿠키로 시작하고 싶은 하루 </br> -k**ghcsy님의 한마디- </span>"; break;
			case 20191217 : fClass = "f2"; str = "<p class='txt'><span>즐겁고 기운찬 하루가 될 것이라 믿습니다 </br> -j**yo님의 한마디- </span>"; break;
			case 20191218 : fClass = "f2"; str = "<p class='txt'><span>행복하다 생각하면 오늘은 더 행복해집니다 </br> -p**0022님의 한마디- </span>"; break;
			case 20191219 : fClass = "f2"; str = "<p class='txt'><span>행복하세요 사랑합니다 고맙습니다 </br> -t**whddnsdl님의 한마디- </span>"; break;
			case 20191220 : fClass = "f2"; str = "<p class='txt'><span>환절기에 따스한 커피한잔의 여유를~♡ </br> -j**g7942님의 한마디- </span>"; break;
			case 20191221 : fClass = "f2"; str = "<p class='txt'><span>행복한 기억 가득 담을수 있는 하루 보내세요. </br> -l**qm23님의 한마디- </span>"; break;
			case 20191222 : fClass = "f2"; str = "<p class='txt'><span>따뜻한 허니티 마시며 몸을 녹인다. </br> -v**ile님의 한마디- </span>"; break;
			case 20191223 : fClass = "f2"; str = "<p class='txt'><span>어제도 오늘도 푸른 하늘처럼 푸른 마음 간직하길 </br> -a**llabella님의 한마디- </span>"; break;
			case 20191224 : fClass = "f2"; str = "<p class='txt'><span>난 행복할 자격이 있어요 </br> -p**y9203님의 한마디- </span>"; break;
			case 20191225 : fClass = "f2"; str = "<p class='txt'><span>쌀쌀해진 날씨 감기 조심하세요~ </br> -l**ias3님의 한마디- </span>"; break;
			case 20191226 : fClass = "f2"; str = "<p class='txt'><span>호빵이 생각나는 계절이 왔어요 </br> -m**ove212님의 한마디- </span>"; break;
			case 20191227 : fClass = "f2"; str = "<p class='txt'><span>나의 하루하루가 모여 내 인생이 된다. 열심히 삽시다. </br> -j**ee1230님의 한마디- </span>"; break;
			case 20191228 : fClass = "f2"; str = "<p class='txt'><span>매일 매일이 처음인 오늘도 즐겁게♡ </br> -s**g0288님의 한마디- </span>"; break;
			case 20191229 : fClass = "f2"; str = "<p class='txt'><span>밤 새 비가와서 추운 아침... 따듯한 차 한잔과 즐거운 하루 시작~ </br> -d**ahng님의 한마디- </span>"; break;
			case 20191230 : fClass = "f2"; str = "<p class='txt'><span>행운이 함께 하시기를 기원합니다 </br> -k**11hj1210님의 한마디- </span>"; break;
			case 20191231 : fClass = "f2"; str = "<p class='txt'><span>오늘 하루를 보내며 일기를 써보는 경험을 해보세요 </br> -a**or71님의 한마디- </span>"; break;
		...
		success:function(json){
			...
			if(result>=0){
				...
				if(result==0){
					...
					if(json.part == 1){
						itemObj.msg = "아쉽게도 당첨되이 않으셨습니다.<br>오후 3시에 재도전 하세요";
					}else if(json.part == 2){
						itemObj.msg = "아쉽게도 당첨되이 않으셨습니다.<br>내일 또 돌려요";
					}
				...
				if(json.part == 1){
					alert("1차 타임 이미 참여하셨습니다.\n2차 타임 또 돌려요~");
				}else if(json.part == 2){
					alert("2차 타임 이미 참여하셨습니다.\n내일 또 돌려요~");					
				}
