...
<div class="wrap">
							...
							<dl>
								...
								<dd>
									...
									<ul>
										...
										<li>이벤트 기간 : 2020년 11월 1일 ~ 11월 30일</li>
										<li>이벤트 혜택 : [맥도날드] 1955버거 세트 (e7,000) - 20명 추첨</li>
										<li>당첨자 발표 : 2020년 12월 15일 화요일</li>
							...
							<dl>
								...
								<dd>
									...
									<ul>
										...
										<li>당첨자 발표 : 2020년 12월 15일 화요일<br>
											<span class="noti">※ 당첨된 오늘의 한마디는 21년 1월 출석체크 팝업 화면에 노출됩니다.</span>
										</li>
										<li class="stress">e머니 유효기간 : 적립일로부터 15일 (유효기간 만료 후 재적립 불가)</li>
									</ul>
									<!-- // -->
	...
	<%if(numSdt <20201102){ %>
	<div class="bnr_wrap">
		<h3 class="blind">웰컴 배너</h3>
		<a href="/mobilefirst/evt/birthday_event.jsp?freetoken=event&tab=2" target="_blank" title="새 창에서 열립니다.">오랜만에 오셨나요? 지금 구매하면 e머니 2000점 100% 증정!</a>
	</div>
	<%}else{ %> 
	<div class="bnr_wrap">
		<h3 class="blind">앱푸시 배너 APP전용</h3>
		<a href="/mobilefirst/evt/apppush_event.jsp?freetoken=event" target="_blank" title="새 창에서 열립니다.">혜택엔 스피드가 생명! 제일 먼저 이벤트 소식 받고 5,000원 상품권도 받고!</a>			
	</div>
	<%} %>
	<!-- layer-->
...
var sdt = "<%=sdt%>";
var reply_event_code = "2020110106"; //오늘의한마디 댓글 이벤트코드
var PAGENO = 1;
var PAGESIZE = 5;
var BLOCKSIZE = 5;
...
$(document).ready(function() {
	...
	function setTodayComment(){
		...
		$.ajax({
			...
			url: url,
			data: {
				reply_eventcode : "2020090106",
				sdt : <%=numSdt%>
			},
		    dataType: "JSON",
		    success: function(result){
		        fClass = "f2"; str = "<p class='txt'><span> "+result.reply_list.reply_msg+" <br>  -"+result.reply_list.usrid+"님의 한마디- </span>";
