...
var sdt = "<%=sdt%>";
var reply_event_code = "2020020106"; //오늘의한마디 댓글 이벤트코드
var PAGENO = 1;
var PAGESIZE = 5;
var BLOCKSIZE = 5;
...
$(document).ready(function() {
	...
	function setTodayComment(){
		...
		case 20200201 : fClass = "f2"; str = "<p class='txt'><span>내일도 활기차게~~ <br> -a**adan8님의 한마디- </span>"; break;
		case 20200202 : fClass = "f2"; str = "<p class='txt'><span>오늘도 감사합니다 수고하세요 <br> -j**kdani님의 한마디- </span>"; break;
		case 20200203 : fClass = "f2"; str = "<p class='txt'><span>즐거운 하루 되세요 <br> -b**ymm33님의 한마디- </span>"; break;
		case 20200204 : fClass = "f2"; str = "<p class='txt'><span>오늘도 행복한 하루되세요 <br> -m**akhroim님의 한마디- </span>"; break;
		case 20200205 : fClass = "f2"; str = "<p class='txt'><span>활기찬 하루 보내세요 <br> -a**pz1111님의 한마디- </span>"; break;
		case 20200206 : fClass = "f2"; str = "<p class='txt'><span>좋은 일이 생길것 같은 오늘. 오늘도 화이팅입니다!! <br> -p**523님의 한마디- </span>"; break;
		case 20200207 : fClass = "f2"; str = "<p class='txt'><span>'오늘은 좋은날!!' 이라고 외치며 아침을 시작해보세요~ <br> -k**806님의 한마디- </span>"; break;
		case 20200208 : fClass = "f2"; str = "<p class='txt'><span>작은 일에도 목표를 세워라. 반드시 성공할 것이다 <br> -i**n1623님의 한마디- </span>"; break;
		case 20200209 : fClass = "f2"; str = "<p class='txt'><span>오늘도 즐거운 하루되세요. <br> -c**25님의 한마디- </span>"; break;
		case 20200210 : fClass = "f2"; str = "<p class='txt'><span>아침이 올 때마다 우리는 사랑할 하루를 선물 받아요 <br> -s**0302님의 한마디- </span>"; break;
		case 20200211 : fClass = "f2"; str = "<p class='txt'><span>모두모두 행복해져라 얍!! <br> -y**4024님의 한마디- </span>"; break;
		case 20200212 : fClass = "f2"; str = "<p class='txt'><span>행복한 하루 보내세요 <br> -h**004hj님의 한마디- </span>"; break;
		case 20200213 : fClass = "f2"; str = "<p class='txt'><span>즐거운 하루 보내세요 <br> -e**in1216님의 한마디- </span>"; break;
		case 20200214 : fClass = "f2"; str = "<p class='txt'><span>오늘도 화이팅하세요 <br> -j**hyuk1016님의 한마디- </span>"; break;
		case 20200215 : fClass = "f2"; str = "<p class='txt'><span>행운을 끌어 당기는 하루자 되자. <br> -j**2831022님의 한마디- </span>"; break;
		case 20200216 : fClass = "f2"; str = "<p class='txt'><span>오늘도 좋은 하루 되세요 <br> -m**ngpu님의 한마디- </span>"; break;
		case 20200217 : fClass = "f2"; str = "<p class='txt'><span>간절히 원하면 불가능이란 없다 <br> -f**egold님의 한마디- </span>"; break;
		case 20200218 : fClass = "f2"; str = "<p class='txt'><span>우리 모두 항상 웃어봅시다 <br> -p**mise2537님의 한마디- </span>"; break;
		case 20200219 : fClass = "f2"; str = "<p class='txt'><span>즐거운 하루들 되시길ㅎ <br> -f**2e5e28aa님의 한마디- </span>"; break;
		case 20200220 : fClass = "f2"; str = "<p class='txt'><span>다들 좋은 하루 되세요 <br> -r**berge님의 한마디- </span>"; break;
		case 20200221 : fClass = "f2"; str = "<p class='txt'><span>우리 모두 웃어보아요 <br> -a**ldk2님의 한마디- </span>"; break;
		case 20200222 : fClass = "f2"; str = "<p class='txt'><span>새마음 새뜻으로♡♡ <br> -z**4083님의 한마디- </span>"; break;
		case 20200223 : fClass = "f2"; str = "<p class='txt'><span>하루의 3분의2를 자기 마음대로 쓰지못하는 사람은 노예다 -니체- <br> -m**ang17님의 한마디- </span>"; break;
		case 20200224 : fClass = "f2"; str = "<p class='txt'><span>오늘도 즐거운 하루되자 <br> -j**yun01님의 한마디- </span>"; break;
		case 20200225 : fClass = "f2"; str = "<p class='txt'><span>행운과 함께 하자 언제나 <br> -c**kji님의 한마디- </span>"; break;
		case 20200226 : fClass = "f2"; str = "<p class='txt'><span>앞이 보이지 않을때는 잠깐 뒤를 보세요 <br> -v**v44님의 한마디- </span>"; break;
		case 20200227 : fClass = "f2"; str = "<p class='txt'><span>내 인생에 남은 날 중 오늘이 가장 젊은 날이다 <br> -d**2008님의 한마디- </span>"; break;
		case 20200228 : fClass = "f2"; str = "<p class='txt'><span>신은 우리가 견딜만한 고통만준다 <br> -8**cfb0c041님의 한마디- </span>"; break;
		case 20200229 : fClass = "f2"; str = "<p class='txt'><span>시간은 가장 훌륭한 재판관이다. <br> -j**7k님의 한마디- </span>"; break;
