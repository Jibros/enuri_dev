						...
						<dl>
							...
							<dd>
								<ul>
									...
									<li>이벤트 기간 : 2021년 5월 1일 ~ 5월 31일</li>
									<li>이벤트 혜택 : [스타벅스] 부드러운 디저트 세트 (e12,700) - 20명 추첨</li>
									<li>당첨자 발표 : 2021년 6월 15일 화요일</li>
						...
						<dl>
							...
							<dd>
								...
								<ul>
									...
									<li>당첨자 발표 : 2021년 6월 15일 화요일<br />
										<span class="noti">※ 당첨된 오늘의 한마디는 21년 7월 출석체크 팝업 화면에 노출됩니다.</span>
									</li>
									<li class="stress">e머니 유효기간 : 적립일로부터 15일 (유효기간 만료 후 재적립 불가)</li>
								</ul>
								<!-- // -->
...
var reply_event_code = "2021050106"; //오늘의한마디 댓글 이벤트코드
var PAGENO = 1;
var PAGESIZE = 5;
var BLOCKSIZE = 5;
...
function bonusPick(){
	...
	var vData = { "job" : "2",
			 	  ...
			 	  "strEventId2" : "2021050105", // 해당 월 참가상 이벤트 코드
				  "strStartDate" : "20210501", //해당 이벤트 시작날짜
				  "strEndDate" : "20210531" //해당 이벤트 마지막날짜
	};
	$.ajax({
		type: "POST",
