			...
			<ul class="evtnotice__list">
				...
				<li class="evtnotice__item item2">
					<div class="blind">
						...
						<p>[탐앤탐스] 핫 치킨 프레즐 - e머니 5000점 적립</p>
					</div>
						...
						<dl>
							...
							<dd>
								<ul>
									...
									<li>이벤트 기간 : 2021년 6월 1일 ~ 6월 30일</li>
									<li>이벤트 혜택 : [스타벅스] 부드러운 디저트 세트 (e12,700) - 20명 추첨</li>
									<li>당첨자 발표 : 2021년 7월 13일 화요일</li>
						...
						<dl>
							...
							<dd>
								<ul>
									...
									<li>이벤트 기간 : 2021년 6월 1일 ~ 6월 30일</li>
									<li>이벤트 혜택 : 탐앤탐스 핫 치킨 프레즐 (e5,000) - 30명 추첨</li>
									<li>당첨자 발표 : 2021년 7월 13일 화요일</li>
									<li class="stress">e머니 유효기간 : 적립일로부터 15일 (유효기간 만료 후 재적립 불가)</li>
								</ul>
							</dd>
						...
						<div class="hotevent__slide swiper-container">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<a href="http://m.enuri.com/mobilefirst/event2021/threegopc_evt.jsp"><img src="http://img.enuri.info/images/event/2021/attance/may/m_threegopcbn_640_260_01.jpg" alt=""></a>
								</div>
								<div class="swiper-slide">
									<a href="http://m.enuri.com/mobilefirst/evt/birthday_event.jsp?tab=2"><img src="http://img.enuri.info/images/event/2021/attance/may/mbn_04.jpg" alt="보고싶었어요! 오랜만에 구매하면 2,000점 100% 적립!"></a>
								</div>
								<div class="swiper-slide">
									<a href="http://m.enuri.com/mobilefirst/evt/smart_benefits.jsp?#tab4"><img src="http://img.enuri.info/images/event/2021/attance/may/mbn_05.jpg" alt="카테고리 추가적립, 이번달만 최대 5만점 추가적립!"></a>
								</div>
								<div class="swiper-slide">
									<a href="http://m.enuri.com/mobilefirst/evt/birthday_event.jsp"><img src="http://img.enuri.info/images/event/2021/attance/may/mbn_06.jpg" alt="생일축하합니다! 이번달 생일이라면? 500점 추가적립"></a>
								</div>
							</div>
						</div>
						...
						<dl>
							...
							<dd>
								<ul>
									...
									<li>당첨자 발표 : 2021년 7월 13일 화요일<br>
										<span class="noti">※ 당첨된 오늘의 한마디는 21년 8월 출석체크 팝업 화면에 노출됩니다.</span>
									</li>
									<li class="stress">e머니 유효기간 : 적립일로부터 15일 (유효기간 만료 후 재적립 불가)</li>
								</ul>
							</dd>
...
var reply_event_code = "2021060106"; //오늘의한마디 댓글 이벤트코드
var PAGENO = 1;
var PAGESIZE = 5;
var BLOCKSIZE = 5;
...
var ep1on = "<%=ep1on%>";
var ep2on = "<%=ep2on%>";
var event_Code="<%=eventCode%>"; // 출석체크 이벤트 코드
function view_moapp(){
	var chrome25;
	var kitkatWebview;
...
function bonusPick(){
	...
	var vData = { "job" : "2",
			 	  "sdt" : sdt,
			 	  "osType" : "MO",
			 	  "strEventId" : event_Code, //해당 월 매일출첵 이벤트 코드
			 	  "strEventId2" : "2021060105", // 해당 월 참가상 이벤트 코드
				  "strStartDate" : "20210601", //해당 이벤트 시작날짜
				  "strEndDate" : "20210630" //해당 이벤트 마지막날짜
	};
	$.ajax({
		type: "POST",
