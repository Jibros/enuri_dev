...
if(
	...
	response.sendRedirect("/eventPlanZone/jsp/HitBrand_201906.jsp");
	return;
}

String EVENTID="2019061701";
...
<head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="http://dev.enuri.com/css/event/y2019/hit_2019jun_m.css"/>
	<link rel="stylesheet" type="text/css" href="http://m.enuri.com/mobilefirst/css/lib/slick.css"> -->
	<link rel="stylesheet" type="text/css" href="/css/event/y2019/hit_2019jun_m.css"/>
...
<div class="wrap">
	...
	<div class="visual">
		<div class="inner">
			<img src="http://img.enuri.info/images/event/2019/hit_june/m_top.jpg" alt="2019 에누리 히트브랜드" class="imgs" />
			<div class="blind">
				<h1>2019 상반기 에누리 히트브랜드</h1>
				<p>
					2019년 상반기 소비자들에게 가장 사랑 받은 히트브랜드를 소개합니다.<br/>
					이벤트기간 : 2019.6.17 ~ 7.31
				</p>
			</div>
		</div>
	</div>
			...
			<div class="bingobox">				
				...
				<div class="inner">				
					<div class="bingo__tit">
						<img src="http://img.enuri.info/images/event/2019/hit_june/m_bingo_tit.png" alt="" />
											...
											<ol>
												<li>			
													<ul class="txt_indent">
														...
														<li>당첨자발표: <b>2019년 8월 2일</b><br />[에누리 고객센터 및 에누리 가격비교 APP&gt;당첨자발표]</li>
		...
		<div class="specialgiftbox">
			<div class="inner">
				<div class="specialgift__cont">
					<img src="http://img.enuri.info/images/event/2019/hit_june/m_gift_img_01.jpg" alt="" />
					<h2 class="blind">획득하신 응모권으로 원하시는 경품에 응모하세요</h2>
					<ul class="btn_group">
						<li class="btn__join"><img src="http://img.enuri.info/images/event/2019/hit_june/m_btn_gift_01.png" alt="스페셜 경품전 응모하기" /></li>
						<li class="btn__my" onclick="$('#giveaway').show(); return false;"><img src="http://img.enuri.info/images/event/2019/hit_june/m_btn_gift_02.png" alt="나의 응모 현황" /></li>
					</ul>
				</div>
			</div>
		</div>
...
$(document).ready(function(){
    ...
    if( navigator.userAgent.indexOf("iPhone") > -1 || navigator.userAgent.indexOf("iPod") > -1 || navigator.userAgent.indexOf("iPad") > -1){
        ga('send', 'pageview', {'page': '/mobilefirst/evt/event_hitbrand201906.jsp', 'title': '201906히트브랜드  pv_iphone'});
    }else if(navigator.userAgent.indexOf("Android") > -1){
       ga('send', 'pageview',  {'page': '/mobilefirst/evt/event_hitbrand201906.jsp',  'title': '201906히트브랜드  pv_android'});
    }
    ...
    $(".btn__my").click(function(){
    	...
    	var gourl = "/eventPlanZone/ajax/hitBrand201906_getData.jsp?procCode=7&sdt="+sdt;
...
function goQuiz(num){
	...
	var gourl = "/eventPlanZone/ajax/hitBrand201906_getData.jsp?procCode=2&sdt="+sdt+"&num="+num;
	$.ajax({
		type:"GET",
		url: gourl,
		dataType: "JSON",
...
function getBingo(){
	...
	var gourl = "/eventPlanZone/ajax/hitBrand201906_getData.jsp?procCode=5&sdt="+sdt;
...
function goJoin(){
	...
	function hitProc(param, callback) {
		...
		param.sdt = sdt;
		//}
		$.getJSON("/eventPlanZone/ajax/hitBrand201906_getData.jsp", param ,callback)
		.done(function(){
			isClick = true;
		});
	}
	...
	function evtCommonChk (procCode) {
		...
		var chkDate = [
			{	"startDate" : 20190617,	"endDate" : 20190731	}
		];
		...
		if(Number(sdt) < chkDate[0].startDate) {
			...
			//Cmd_Login('event');
			location.href = "/mobilefirst/login/login.jsp?backUrl=/mobilefirst/evt/event_hitbrand201906.jsp?freetoken=event";
		} else {
			chkResult = true;
		}
		return chkResult;
		...
		$("body").on('click', '.btn.layjoin', function(event) {
			...
			if(cls == "unchk2"){//체크 안함
				...
				try{
					...
					var goUrl = "/eventPlanZone/ajax/hitBrand201906_getData.jsp?procCode=6&uphone="+uphone+"&selectItem="+_selected+"&sdt="+sdt;
...
<div id="OXquiz" class="dim" style="display:none;">
	...
	<div class="appLayer quiz">
		...
		<div class="layercont">
			...
			<ul class="choice_box">
				<li><button type="button" id="btnO"><img src="http://img.enuri.info/images/event/2019/hit_june/m_oxselect_o.png" alt="O" /></button></li>
				<li><button type="button" id="btnX" ><img src="http://img.enuri.info/images/event/2019/hit_june/m_oxselect_x.png" alt="X" /></button></li>
			</ul>
...
<div id="joinExplainLayer" class="explain_layer" style="display:none;">
	...
	<div class="appLayer">
		...
		<div class="layercont">
			<img src="http://img.enuri.info/images/event/2019/hit_june/m_explain_img.png" alt="" />
						...
						<li class="chk">
							...
							<label for="opt1">
								<span class="thumb" onclick="event.stopPropagation();return false;">
									<img onclick="window.open('http://www.enuri.com/p/12325897','_blank');" src="http://img.enuri.info/images/event/2019/hit_june/m_prize_img1.jpg" alt="" />
								</span>
								<p class="proname">LG 의류 관리기<strong>1명</strong></p>
							</label>
						</li>
						<li>
							...
							<label for="opt2">
								<span class="thumb" onclick="event.stopPropagation();return false;">
									<img onclick="window.open('http://www.enuri.com/p/26000822','_blank');" src="http://img.enuri.info/images/event/2019/hit_june/m_prize_img2.jpg" alt="" />
								</span>
								<p class="proname">다이슨 무선청소기<strong>1명</strong></p>
							</label>
						</li>
						<li>
							...
							<label for="opt3">
								<span class="thumb" onclick="event.stopPropagation();return false;">
									<img onclick="window.open('http://www.enuri.com/p/36135154','_blank');" src="http://img.enuri.info/images/event/2019/hit_june/m_prize_img3.jpg" alt="" />
								</span>
								<p class="proname">삼성 갤럭시탭 S5e <strong>1명</strong></p>
							</label>
						</li>
					</ul>
				</div>
