...
|| ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPad") > -1 ){
	...
	response.sendRedirect("/event2018/tabletAppBuy_201809.jsp");	//pc url 
	return;
}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/event/y2018/tablet_app_autumn_m.css"/>
...
<div class="wrap">
	...
	<!-- 상단비주얼 -->
	<div class="visual">
        <img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/autumn/m_visual.jpg" alt="휴가 끝 아쉬우니 커피?" class="imgbox" />
        <div class="blind">
            <h1>휴가 끝~ 아쉬우니</h1>
            <em>에누리 APP에서 태블릿PC 구매하면 커피 Get~!!</em>
        </div>
	</div>
	...
	<div class="section promotionwrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/autumn/m_promotion_info.jpg" alt="구글 플레이 카드 이미지" class="imgs" />
			<div class="blind">
				<h2>스타벅스 커피 타자!</h2>
				<em>APP에서 태블릿PC 구매하고</em>
			</div>
			...
			<ul class="promotion__info">
				<li>이벤트 참여 및 구매 기간 : 2018년 9월 3일 ~ 9월 31일</li>
				<li>당첨자 발표 : 2018년 10월 29일 (월)</li>
	...
	<div class="section flowevtWrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/autumn/m_flowevent.jpg" alt="" class="imgs" />
			<div class="blind">
				<h2>이벤트 참여방법</h2>
				<ol>
					<li>
	...
	<div id="giftWrap1" class="giftWrap">
		<div class="heads">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/autumn/m_gift_title1.png" class="imgs" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
	...
	<div id="giftWrap2" class="giftWrap p-bgc">
		<div class="heads p-bgc">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/autumn/m_gift_title2.png" class="imgs" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap3" class="giftWrap">
		<div class="heads">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/autumn/m_gift_title3.png" class="imgs" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap4" class="giftWrap p-bgc">
		<div class="heads p-bgc">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/autumn/m_gift_title4.png" class="imgs" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
...
<div class="layer_back nofix" id="notetxt2" style="display:none;">
	...
	<div class="noteLayer no_fixed">
		...
		<div class="inner">
			<dl class="txtlist">
				<dt>이벤트/구매 기간 :</dt>
				<dd>2018년 9월 3일 ~ 9월 30일</dd>
			</dl>
			
			<dl class="txtlist">
				<dt>경품 : </dt>
				<dd>스타벅스 아이스 카페라떼 (T) 기프티콘 (20명 추첨)</dd> 
...
var ajaxUrl = "/mobilefirst/evt/chuseok_201709_ajax.jsp?exh_id=19";
...
function getEventAjaxData(params, callback) {
	...
	if(!isLogin()) {
		...
		var evtUrl = "/mobilefirst/evt/ajax/tabletAppBuy_201809_setlist.jsp";
