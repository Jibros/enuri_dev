...
if(
	...
	response.sendRedirect("/eventPlanZone/jsp/HitBrand_202006.jsp");
	return;
}
String event_id="2020061701";
...
<head>
	...
	<!-- 프로모션별 커스텀 CSS  -->
	<link rel="stylesheet" type="text/css" href="/css/event/y2020/hit_june_m.css"/>
...
<div class="wrap">
	...
	<div class="visual">
		<div class="inner">
			<div class="blind">
				<h1>2020 상반기 에누리 HIT BRAND</h1>
				<p>
					020년 상반기 소비자들에게 가장 사랑 받은 히트브랜드를 소개합니다.<br/>
					이벤트기간 : 2019.06.17 ~ 2020.07.31
				</p>
			</div>
		</div>
	</div>
	...
	<div class="event event__wrap">
			...
			<div class="slotm">				
				...
				<div class="inner">
					...
					<div id="slotarea" class="slotm_game">
							...
							<div class="slotm_con">
								<div class="box">
									<ul>
										...
										<li class="slot_item_22">22</li>
										<li class="slot_item_23">23</li>
										<li class="slot_item_24">24</li>
										<li class="slot_item_25">25</li>
										<li class="slot_item_26">26</li>
										<li class="slot_item_27">27</li>
										<li class="slot_item_28">28</li>
										<li class="slot_item_29">29</li>
										<li class="slot_item_30">30</li>
										<li class="slot_item_31">31</li>
										<li class="slot_item_32">32</li>
										<li class="slot_item_33">33</li>
										<li class="slot_item_34">34</li>
										<li class="slot_item_35">35</li>
										<li class="slot_item_36">36</li>
										<li class="slot_item_37">37</li>
										<li class="slot_item_38">38</li>
										<li class="slot_item_39">39</li>
										<li class="slot_item_40">40</li>
										<li class="slot_item_1">1</li>
										<li class="slot_item_2">2</li>
										<li class="slot_item_3">3</li>
										<li class="slot_item_4">4</li>
						...
						<!-- 200623 : SR#40661 : 추가 - HIT 스탬프 획득방법 -->
						...
						<div id="ApplyWay" class="explain_layer" style="display:none;">
							...
							<div class="appLayer">
								...
								<div class="layercont">
									<img src="http://img.enuri.info/images/event/2020/hitbrand/m_explain_img_01.jpg" alt="" />
									<div class="txt">
										<ul class="txt_indent">	
		...
		<div class="apply_box">
			<div class="inner">
				<div class="contents">
					<img src="http://img.enuri.info/images/event/2020/hitbrand/m_gift_img_01.jpg" alt="획득하신 응모권으로 원하시는 경품에 응모하세요" />
					<!-- 응모하기 -->
					<div class="btn_apply_group">
						<a id="goapplylayer"class="btn_apply_go"><em>스페셜 경품전 응모하기</em></a>
						<a id ="myapply" class="btn_my_apply"><em>나의 응모현황</em></a>
					</div>
					<div class="btn_group">
											...
											<ul class="txt_indent">
												<li><em>선정방법</em>
													<ul>
														...
														<li>-  e머니와 스탬프로 교환한 응모권은 당일 미사용시 자동 소진됨</li>
													</ul>
												</li>
												<li><em>경품증정</em>
													<ul>
												...
												<li><em>당첨자 발표</em>
													<ul>
														<li>-  2020년 8월 5일 [에누리 고객센터]에서 확인</li>
				...
				<div class="join_area">
					<div class="select_prize">
						<span class="tx_apply_prize">
							...
							당첨되신 분께는 해당 경품을, 당첨되지 못하신 분 중 3분을 추첨하여 참여상을 증정해 드립니다.
						</span>
						<div class="num_coin">
							현재 코인 : <em>0</em>개
						</div>
						<ul class="prize_list">
							...
							<li class="chk">
								...
								<label for="opt1">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2020/hitbrand/m_prize_img1.jpg" alt="" />
									</span>
									<p class="proname">삼성전자<br/>그랑데 건조기<br/>(1명)</p>
								</label>
							</li>
							<li>
								...
								<label for="opt2">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2020/hitbrand/m_prize_img2.jpg" alt="" />
									</span>
									<p class="proname">아이패드<br/>프로 4세대 11<br/>(1명)</p>
								</label>
							</li>
							<li>
								...
								<label for="opt3">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2020/hitbrand/m_prize_img3.jpg" alt="" />
									</span>
									<p class="proname">다이슨<br/>에어랩 스타일러<br/>(1명)</p>
								</label>
							</li>
						</ul>
					</div>
...
function loadPostData(type){
	...
	$.ajax({
		type: "POST", 
		url: "/eventPlanZone/ajax/hitBrand202006_getData.jsp",
		data : param,
		async: true,
		dataType:"JSON",   
		success: function(json){
...
function drawMyApply(json){
	...
	if(vCoinUseList.length > 0){
		...
		$.each(vCoinUseList,function(index,listdata){
			...
			if	   (listdata["select_seq"] =="1" )	html +="<td>삼성 그랑데AI 건조기</td>";  	  				
			else if(listdata["select_seq"] =="2" )	html +="<td>아이패드 프로 4세대 11</td>";
			else if(listdata["select_seq"] =="3" )	html +="<td>다이슨 에어랩 스타일러</td>";
...
function evtCommonChk (procCode) {
	...
	var chkDate = [
		{	"startDate" : 20200617,	"endDate" : 20200731	}
	];
...
function coinEvtChk () {
	...
	var chkDate = [
		{	"startDate" : 20200617,	"endDate" : 20200804	}
	];
	if(Number(sdt) < chkDate[0].startDate) {
		alert("이벤트 기간이 아닙니다.");
	} else if(chkDate[0].endDate < sdt) {
