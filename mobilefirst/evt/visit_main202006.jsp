...
var sdt = "<%=sdt%>";
var reply_event_code = "2020060106"; //오늘의한마디 댓글 이벤트코드
var PAGENO = 1;
var PAGESIZE = 5;
var BLOCKSIZE = 5;
...
$(document).ready(function() {
	...
	function setTodayComment(){
		...
		case 20200601 : fClass = "f2"; str = "<p class='txt'><span>가장 큰 위험은 시도하지 않는것이다.<br>-h**ntimes님의 한마디- </span>"; break;
		case 20200602 : fClass = "f2"; str = "<p class='txt'><span>행복한 하루 보내세요^^<br>-m**min3097님의 한마디- </span>"; break;
		case 20200603 : fClass = "f2"; str = "<p class='txt'><span>활기찬 하루 보내세요 감사합니다 감사합니다<br>-d**c61fd3d9님의 한마디- </span>"; break;
		case 20200604 : fClass = "f2"; str = "<p class='txt'><span>무조건 할수 있다는 믿음으로 도전해봐<br>-o**201님의 한마디- </span>"; break;
		case 20200605 : fClass = "f2"; str = "<p class='txt'><span>좋은 하루 보내세요<br>-w**d0605님의 한마디- </span>"; break;
		case 20200606 : fClass = "f2"; str = "<p class='txt'><span>따뜻한 말 한마디가 큰 위로가 됩니다<br>-b**esby님의 한마디- </span>"; break;
		case 20200607 : fClass = "f2"; str = "<p class='txt'><span>힘들땐 잠시 쉬어가도 좋아요!<br>-b**de5ce3f3님의 한마디- </span>"; break;
		case 20200608 : fClass = "f2"; str = "<p class='txt'><span>에너지 충전하세요^^<br>-b**f6629237님의 한마디- </span>"; break;
		case 20200609 : fClass = "f2"; str = "<p class='txt'><span>밥먹자밥먹자 밥먹고하자<br>-p**ith님의 한마디- </span>"; break;
		case 20200610 : fClass = "f2"; str = "<p class='txt'><span>행복은 언제나 행복하기로 선택한 사람의 몫이다<br>-b**t20님의 한마디- </span>"; break;
		case 20200611 : fClass = "f2"; str = "<p class='txt'><span>오늘도 행복하고 즐거운 하루가 되시길 진심으로 바랍니다..안녕히들 주무세요~^^<br>-c**59님의 한마디- </span>"; break;
		case 20200612 : fClass = "f2"; str = "<p class='txt'><span>오늘 모두 행복 하시고 안전운전 하세요<br>-e**316ebe66님의 한마디-</span>"; break;
		case 20200613 : fClass = "f2"; str = "<p class='txt'><span>오늘도 아무탈없이<br>-5**c9514482님의 한마디- </span>"; break;
		case 20200614 : fClass = "f2"; str = "<p class='txt'><span>기운뿜뿜!!! 즐거운 하루되세요😀<br>-s**plehi님의 한마디- </span>"; break;
		case 20200615 : fClass = "f2"; str = "<p class='txt'><span>오늘도 기쁘고 즐거운 하루되세요 ^^<br>-h**dsome1208님의 한마디-</span>"; break;
		case 20200616 : fClass = "f2"; str = "<p class='txt'><span>오늘도 무탈하길 바라며<br>-d**6fefc164님의 한마디- </span>"; break;
		case 20200617 : fClass = "f2"; str = "<p class='txt'><span>행복한 하루 되세요...!<br>-h**loo12님의 한마디- </span>"; break;
		case 20200618 : fClass = "f2"; str = "<p class='txt'><span>건강한 하루 보내세요<br>-h**ea님의 한마디- </span>"; break;
		case 20200619 : fClass = "f2"; str = "<p class='txt'><span>오늘도 하루 즐겁게 보내세요.<br>-m**kjh님의 한마디- </span>"; break;
		case 20200620 : fClass = "f2"; str = "<p class='txt'><span>오늘도 행복한 하루 되세요~<br>-e**wlee님의 한마디- </span>"; break;
		case 20200621 : fClass = "f2"; str = "<p class='txt'><span>모든 분들 화이팅입니다!<br>-m**a2님의 한마디- </span>"; break;
		case 20200622 : fClass = "f2"; str = "<p class='txt'><span>마무리 잘하세요.^^<br>-s**md12v님의 한마디- </span>"; break;
		case 20200623 : fClass = "f2"; str = "<p class='txt'><span>좋은 하루 되세요 감사합니다<br>-i**ocool57님의 한마디- </span>"; break;
		case 20200624 : fClass = "f2"; str = "<p class='txt'><span>건강한 하루 보내세요<br>-d**hsus님의 한마디- </span>"; break;
		case 20200625 : fClass = "f2"; str = "<p class='txt'><span>오늘 하루도 무사히<br>-n**ea님의 한마디- </span>"; break;
		case 20200626 : fClass = "f2"; str = "<p class='txt'><span>유종의미는 항상 중요하다<br>-s**8901님의 한마디- </span>"; break;
		case 20200627 : fClass = "f2"; str = "<p class='txt'><span>모두모두 행복한 하루 보내세요~!!<br>-i**o47님의 한마디- </span>"; break;
		case 20200628 : fClass = "f2"; str = "<p class='txt'><span>힘내자. 할수있어♡♡♡<br>-g**rys님의 한마디- </span>"; break;
		case 20200629 : fClass = "f2"; str = "<p class='txt'><span>오늘도 건강하고 행복하세요*^^*<br>-e**ul님의 한마디- </span>"; break;
		case 20200630 : fClass = "f2"; str = "<p class='txt'><span>행복은 가까운 곳에 자리하고 있어요 놓치지 말아요<br>-s**en30님의 한마디- </span>"; break;
		}
