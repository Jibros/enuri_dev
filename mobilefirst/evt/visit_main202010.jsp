							...
							<dl>
								...
								<dd>
									...
									<ul>
										...
										<li>이벤트 기간 : 2020년 10월 1일 ~ 10월 31일</li>
										<li>이벤트 혜택 : [맥도날드] 1955버거 세트 (e7,000) - 20명 추첨</li>
										<li>당첨자 발표 : 2020년 11월 17일 화요일</li>
							...
							<dl>
								...
								<dd>
									...
									<ul>
										...
										<li>당첨자 발표 : 2020년 11월 17일 화요일<br>
											<span class="noti">※ 당첨된 오늘의 한마디는 12월 출석체크 팝업 화면에 노출됩니다.</span>
										</li>
										<li class="stress">e머니 유효기간 : 적립일로부터 15일 (유효기간 만료 후 재적립 불가)</li>
									</ul>
									<!-- // -->
...
var sdt = "<%=sdt%>";
var reply_event_code = "2020100106"; //오늘의한마디 댓글 이벤트코드
var PAGENO = 1;
var PAGESIZE = 5;
var BLOCKSIZE = 5;
		...
		if(idx == 0){
	    	...
	    	var vLabel = "상단탭_"; //GA 라벨명
	     	if(idx == 1){
	    		...
	    		if(sdt<20201005){
	    			vUrl = "/mobilefirst/evt/firstbuy100_event.jsp?freetoken=eventclone&tab=1";
	    		}else{
