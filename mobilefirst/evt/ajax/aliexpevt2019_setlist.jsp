...
<%
	...
	procCode
		...
		2 : 구매응모 참여
	*/
	int procCode = ChkNull.chkInt(request.getParameter("procCode"),2);				//	이벤트 유형
	//int procCode = 2;
    	...
    	if(1 == procCode){
        	...
        	*/
        	...
        	intResultValue
    	    	...
    	    	2601		: 이미 신청
    		*/
	   		intResultValue = new Event_Lina_Proc().ins_event( userId , eventId ).getInt("result");
        }else if(3 == procCode){
        	intResultValue = new Event_Lina_Proc().selectLog(userId ,eventId);
        }
    }catch(Exception e){}
