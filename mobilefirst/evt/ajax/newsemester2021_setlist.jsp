    ...
    try{
    	if(1 == procCode){
        	...
        	*/
    		if(!userId.equals("")){
    			...
    			if(blIdChk){ // ID당 1회 / 참여 완료
        			...
        			intResultValue = new Event_Welcome_Proc().random_event_ins("2021021501", userId, strToday, osType);
        		}
     	    }
        }else if(2 == procCode){
        	/*
    		...
    		*/
        	...
        	intResultValue = new Event_Lina_Proc().ins_event_optpcd(userId, "2021021502", osType , ostpcd).getInt("result");
        }else if(3==procCode){
        	 ...
        	 if(strToday.substring(4,6).equals("03")){
         		mm = "3";
         	 }
        	 if(dd > 28){
    			mm = "3";
        	...
        	msg.append("새학기 이벤트 당첨 e머니가 지급됐습니다.\n\n");
