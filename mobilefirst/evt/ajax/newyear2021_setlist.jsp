...
<%
	...
	*/
	...
	int intCurEvntStep = ChkNull.chkInt(request.getParameter("evntStep"), 0);
	
    try{
    	
    	if(1 == procCode){
    		intResultValue = new Event_Welcome_Proc().newYearEvntProc("2021011805", userId, strToday, osType, intCurEvntStep);
    		intCurEvntStep = new Event_Welcome_Proc().eventUserStepByDate(userId);
    		jSONObject.put("evntStep",intCurEvntStep);
        }else if(2 == procCode){
        	/*
        	intResultValue
    	    	1			: 신청성공
    		...
    		*/
        	...
        	intResultValue = new Event_Lina_Proc().ins_event_optpcd(userId, "2021011807", osType , ostpcd).getInt("result");
        }else if(3==procCode){
        	 ...
        	 String template_code = "om_seasonevent01";
        	 Biz_Proc bizProc = new Biz_Proc();
        	 String mm = "1";
        	 int dd = Integer.parseInt(strToday.substring(6,8))+14;
        	 if(strToday.substring(4,6).equals("02")){
        		mm = "2";
        	 }
    		 if(dd > 31){
    			mm = "2";
        	...
        	msg.append("설날 이벤트 당첨 e머니가 지급됐습니다.\n\n");
        ...
        }else if(4==procCode){ // 카카오 메시지 보내기 이벤트
        	intResultValue = new Event_Welcome_Proc().random_event_ins("2021011806", userId, strToday, osType);
        }
    }catch(Exception e){}
