    	...
    	if(1 == procCode){
        	...
        	*/
    		if(!userId.equals("")){
    			...
    			blIdChk = new Event_Welcome_Proc().eventIdCntChk(userId);
    			if(blIdChk){ // ID당 1회 / 참여 완료
    				intResultValue = -10;
        		}else{
        			intResultValue = new Event_Welcome_Proc().random_event_ins_v3("2021041201", userId, strToday, osType);
        		}
     	    }
        }else if(2 == procCode){
        	/*
    		...
    		*/
        	...
        	intResultValue = new Event_Lina_Proc().ins_event_optpcd(userId, "2021041202", osType , ostpcd).getInt("result");
        }else if(3==procCode){
        	 ...
        	 if(strToday.substring(4,6).equals("04")){
         		mm = "4";
         	 }
        	 if(dd > 30){
    			mm = "5";
        	...
        	msg.append("가정의달 이벤트 당첨 e머니가 지급됐습니다.\n\n");
