...
<%
	...
	/* if (referer.indexOf("enuri.com") < 0 || Integer.parseInt(strToday) < 20201026 || 20201124 < Integer.parseInt(strToday) ) {
		return;
	} */
	/*
	procCode
	...
	*/
    ...
    try{
    	if(1 == procCode){
        	...
        	*/
     		if(!userId.equals("")){
    	        intResultValue = new Event_Welcome_Proc().random_event_ins_v2("2020102601", userId, strToday, osType);
     	    }else{
     	    	intResultValue = -6;
     	    }
        }else if(2 == procCode){
        	...
        	intResultValue
    	    	...
    	    	2601		: 이미 신청
    		*/
	   		//intResultValue = new Event_Lina_Proc().ins_event(userId, "2020062901").getInt("result");
        	...
        	intResultValue = new Event_Lina_Proc().ins_event_optpcd(userId, "2020102601", osType , ostpcd).getInt("result");
