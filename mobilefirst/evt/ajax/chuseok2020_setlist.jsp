	...
	*/
    ...
    try{
    	if(1 == procCode){
        	...
        	*/
     		if(!userId.equals("")){
    	        intResultValue = new Event_Welcome_Proc().random_event_ins("2020090120", userId, strToday, osType);
     	    }
        }else if(2 == procCode){
        	/*
        	intResultValue
    		...
    		*/
        	...
        	intResultValue = new Event_Lina_Proc().ins_event_optpcd(userId, "2020081902", osType , ostpcd).getInt("result");
