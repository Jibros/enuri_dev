...
<%
	...
	if (referer.indexOf("enuri.com") < 0 || Integer.parseInt(strToday) < 20210823 || 20210922 < Integer.parseInt(strToday) ) {
		return;
	}
	/*
	procCode
	...
	*/
    ...
    try{
    	if(1 == procCode){
        	...
        	*/
     		if(!userId.equals("")){
    	        intResultValue = new Event_Welcome_Proc().random_event_ins_v5("2021082303", userId, strToday, osType);
				if(intResultValue > 1 ){
					...
					/*
					String mm = strToday.substring(4,6);
					String dd = strToday.substring(6,8);
					*/
					String mm = strToday.substring(4,6);
					...
					msg.append("[추석 윷놀이] 이벤트 당첨 e머니가 지급됐습니다.\n\n");
					msg.append("■ 지급 e머니 : "+intResultValue+"원\n");
    		...
    		*/
			...
			intResultValue = new Event_Lina_Proc().ins_event_optpcd(userId, "2021082302", osType , ostpcd).getInt("result");
        }
    }catch(Exception e){}
