...
<%
	...
	if (referer.indexOf("enuri.com") < 0 || Integer.parseInt(strToday) < 20180902 || 20180922 < Integer.parseInt(strToday) ) {
		return;
	}
	...
	*/
    ...
    try{
    	if(1 == procCode){
        	...
        	*/
     		if(!userId.equals("")){
    	        intResultValue = new Event_Welcome_Proc().random_event_ins("2018090101", userId, strToday, osType);
     	    }
        }else if(2 == procCode){
        	/*
        	intResultValue
    	    	...
    	    	2601		: 이미 신청
    		*/
	   		intResultValue = new Event_Lina_Proc().ins_event(userId, "2018090102").getInt("result");
        }
    }catch(Exception e){}
