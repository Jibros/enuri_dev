    ...
    try{
    	if(1 == procCode){
        	...
        	*/
        	...
        	// 재료담기 이벤트 번호
        	String evnt_cd = "";
        	int evnt_step = ChkNull.chkInt(request.getParameter("evnt_step"), 1);
        	if(evnt_step == 6){
        	...
        	if(!userId.equals("")){
	        	if(evnt_step == 1){
	        		...
	        		jSONObject.put("result",-55);
	        		out.println(jSONObject.toString());
	        		return;
	        	}
	        	jSONObject.put("evnt_step",evnt_step);
	        	intResultValue = new Event_Welcome_Proc().random_event_ins(evnt_cd, userId, strToday, osType);
        	}
        }else if(2 == procCode){
        	/*
        	intResultValue
    		...
    		*/
        	...
        	intResultValue = new Event_Lina_Proc().ins_event_optpcd(userId, "2021011806", osType , ostpcd).getInt("result");
