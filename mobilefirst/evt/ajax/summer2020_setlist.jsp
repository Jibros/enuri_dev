...
<%
	...
	if (referer.indexOf("enuri.com") < 0 || Integer.parseInt(strToday) < 20200629 || 20200802 < Integer.parseInt(strToday) ) {
		return;
	}
	/*
	procCode
	...
	*/
    ...
    try{
    	if(1 == procCode){
        	...
        	*/
     		if(!userId.equals("")){
    	        intResultValue = new Event_Welcome_Proc().random_event_ins_v2("2020062901", userId, strToday, osType);
     	    }
        }else if(2 == procCode){
        	/*
        	intResultValue
    		...
    		*/
        	...
        	intResultValue = new Event_Lina_Proc().ins_event_optpcd(userId, "2020062901", osType , ostpcd).getInt("result");
