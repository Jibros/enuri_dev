    	...
    	if(1 == procCode){
        	...
        	*/
    		...
    		if(!userId.equals("")){
    			...
    			blIdChk = new Event_Welcome_Proc().eventIdSummerCntChk(userId);
    			if(blIdChk){ // ID당 1회 / 참여 완료
    				intResultValue = -10;
        		}else{
        			intResultValue = new Event_Welcome_Proc().random_event_ins_v4("2021070501", userId, strToday, osType);
        		}
     	    }
        }else if(2 == procCode){
        	/*
    		...
    		*/
        	...
        	intResultValue = new Event_Lina_Proc().ins_event_optpcd(userId, "2021070502", osType , ostpcd).getInt("result");
        }else if(3==procCode){
        	...
        	msg.append("무더위 이벤트 당첨 e머니가 지급됐습니다.\n\n");
