...
|| ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPad") > -1 ){
	...
	response.sendRedirect("/event2018/tabletAppBuy_201812.jsp");	//pc url 
	return;
}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/event/y2018/tablet_app_december_m.css"/>
...
<div class="wrap">
	...
	<!-- 상단비주얼 -->
	<div class="visual">
        <img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_visual.jpg" class="imgs" />
        <div class="blind">
            <h1>수고했어, 올해도!</h1>
            <em>에누리가 해피머니 쏠게요!</em>
        </div>
	...
	<div class="section promotionwrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_promotion_info.jpg" class="imgs" />
            <div class="blind">
                <h2>APP에서 태블릿PC 구매하고</h2>
                <strong>해피머니 상품권 커피 받자!</strong>
                <em>구매 후 응모시 추첨 증정! e머니 적립까지!</em>
            </div>
			<div class="btn__group">
				<a href="javascript:void(0);" id="button_2" class="btn"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_promotion_buy.jpg" alt="태블릿PC 구매하기" class="imgs" /></a>
				<a href="javascript:void(0);" id="button_1" class="btn"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_promotion_join.jpg" alt="응모하기" class="imgs" /></a>
            </div>
            
			<div class="promotion__info"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_pmevt_info.jpg" class="imgs"></div>
			<ul class="blind">
				<li>이벤트 참여 및 구매 기간 : 2018년 12월 7일 ~ 12월 31일</li>
				<li>당첨자 발표 : 2019년 1월 31일 (목)</li>
	...
	<div class="section flowevtWrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_flowevent.jpg" class="imgs" />
			<div class="blind">
				<h2>이벤트 참여방법</h2>
				<ol>
					<li>
	...
	<div id="giftWrap1" class="giftWrap">
        <div class="heads">
            <h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_gift_title1.png" class="imgs" alt="넷플릭스HD 지원 태블릿PC" /></h2>
		</div>
		<div class="contents">
            <!-- items_area -->
	...
	<div id="giftWrap2" class="giftWrap p-bgc">
		<div class="heads p-bgc">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_gift_title2.png" class="imgs" alt="안드로이드 태블릿PC" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap3" class="giftWrap">
		<div class="heads">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_gift_title3.png" class="imgs" alt="ios를 품은 아이패드" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap4" class="giftWrap p-bgc">
		<div class="heads p-bgc">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/december/m_gift_title4.png" class="imgs" alt="윈도10 탑재 태블릿PC" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
...
<div class="layer_back nofix" id="notetxt2" style="display:none;">
	...
	<div class="noteLayer no_fixed">
		...
		<div class="inner">
			<dl class="txtlist">
				<dt>이벤트/구매 기간 :</dt>
				<dd>2018년 12월 7일 ~ 12월 31일</dd>
			</dl>
			
			<dl class="txtlist">
				<dt>경품 : </dt>
                <dd>해피머니 3만원권 – e머니 3만점 지급 (5명 추첨)</dd>
                <dd>스타벅스 카페라떼 Tall - e머니 4천 6백점 지급 (10명 추첨)</dd>
...
var ajaxUrl = "/mobilefirst/evt/chuseok_201709_ajax.jsp?exh_id=20"; //11월 프로모션과 데이터 같아서 같이 쓴다
...
$(function() {
	...
	ga('send', 'pageview', {
		'page': '/mobilefirst/evt/tabletAppBuy_201812.jsp',
		'title': ''
	});
...
function getEventAjaxData(params, callback) {
	...
	if(!isLogin()) {
		...
		var evtUrl = "/mobilefirst/evt/ajax/tabletAppBuy_201812_setlist.jsp";
