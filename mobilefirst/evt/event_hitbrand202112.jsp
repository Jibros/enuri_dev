...
if(
	...
	response.sendRedirect("/eventPlanZone/jsp/HitBrand_202112.jsp");
	return;
}
...
//test
if( (request.getServerName().equals("stagedev.enuri.com") || request.getServerName().equals("dev.enuri.com")) &&  request.getParameter("sdt")!=null && !"".equals(request.getParameter("sdt"))){
...
<head>
	...
	<!-- 프로모션별 커스텀 CSS  -->
	<link rel="stylesheet" type="text/css" href="/css/event/y2021_rev/hit_dec_m.css"/>
...
<div class="wrap">
	...
	<div class="event event__wrap">
		...
		<div class="apply_box">
			<div class="inner">
				<div class="contents">
					<img src="http://img.enuri.info/images/event/2021/hitbrand/dec/m_gift_img_01.jpg" alt="획득하신 응모권으로 원하시는 경품에 응모하세요" />
					<!-- 응모하기 -->
									...
									<ol>
										<li>
											<ul class="txt_indent">
												...
												<li><em>당첨자 발표</em>
													<ul>
														<li>-  <b>2022년 2월 2일</b> [에누리 고객센터]에서 확인</li>
					...
					<div class="select_prize">
						...
						<ul class="prize_list">
							...
							<li class="chk">
								...
								<label for="opt1">
									<span class="thumb" >
										<img src="http://img.enuri.info/images/event/2021/hitbrand/dec/m_prize_img1.jpg" alt="">
									</span>
									<p class="proname">온수매트<br>(1명)</p>
								</label>
							</li>
							<li>
								...
								<label for="opt2">
									<span class="thumb" >
										<img src="http://img.enuri.info/images/event/2021/hitbrand/dec/m_prize_img2.jpg" alt="">
									</span>
									<p class="proname">에어팟<br>3세대<br>(1명)</p>
								</label>
							</li>
							<li>
								...
								<label for="opt3">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2021/hitbrand/dec/m_prize_img3.jpg" alt="" />
									</span>
									<p class="proname">bbq<br>황금올리브치킨<br>(100명)</p>
								</label>
							</li>
						</ul>
					</div>
...
function drawMyApply(json){
	...
	if(vCoinUseList.length > 0){
		...
		$.each(vCoinUseList,function(index,listdata){
			...
			if	   (listdata["select_seq"] =="1" )	html +="<td>온수매트</td>";
			else if(listdata["select_seq"] =="2" )	html +="<td>에어팟 3세대</td>";
			else if(listdata["select_seq"] =="3" )	html +="<td>bbq 황금올리브치킨</td>";
...
function evtCommonChk (procCode) {
	...
	var chkDate = [
		{"startDate" : 20211215, "endDate" : 20220128}
	];
