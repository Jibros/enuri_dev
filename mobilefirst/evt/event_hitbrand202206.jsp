...
if(
	...
	response.sendRedirect("/eventPlanZone/jsp/HitBrand_202206.jsp");
	return;
}
...
//test
if( ( request.getServerName().equals("testdev1.enuri.com") || request.getServerName().equals("stagedev.enuri.com") || request.getServerName().equals("dev.enuri.com")) &&  request.getParameter("sdt")!=null && !"".equals(request.getParameter("sdt"))){
...
<head>
	...
	<!-- 프로모션별 커스텀 CSS  -->
	<link rel="stylesheet" type="text/css" href="/css/event/y2022/hit_m.css">
...
<div class="wrap">
	...
	<div class="event event__wrap">
			...
			<div class="slotm">
				...
				<div class="inner">
					<h3>
						...
						<span class="blind">
							히트스탬프로 응모권 교환 / 매일 e머니로 응모권 최대 5회 교환<br/>
					...
					<div id="slotarea" class="slotm_game">
						...
						<div id="ApplyWay2" class="explain_layer" style="display:none;">
							...
							<div class="appLayer">
								<h4 style="background: #7d7d7d;">HIT 스탬프 획득방법</h4>
						...
						<div id="ApplyWay" class="explain_layer" style="display:none;">
							<div class="backdim" onclick="$('#ApplyWay').fadeOut(100);"></div>
							<div class="appLayer" >
								<h4 style="background: #7d7d7d;">이벤트 참여 방법</h4>
								<a href="javascript:///" class="close" onclick="$('#ApplyWay').hide();">창닫기</a>
								<div class="layercont">
									<img src="http://img.enuri.info/images/event/2022/hitbrand/m_explain_img_01.jpg" alt="" />
									<div class="txt">
										<ul class="txt_indent">
		...
		<div class="apply_box">
			<div class="inner">
				<div class="contents">
					<img src="http://img.enuri.info/images/event/2022/hitbrand/m_gift_img_01.jpg" alt="획득하신 응모권으로 원하시는 경품에 응모하세요" />
					<!-- 응모하기 -->
									...
									<ol>
										<li>
											<ul class="txt_indent">
												...
												<li><em>당첨자 발표</em>
													<ul>
														<li>-  <b>2022년 8월 2일</b> [에누리 고객센터]에서 확인</li>
			...
			<div class="layercont">
				...
				<div class="join_area">
					<div class="select_prize">
						...
						<ul class="prize_list">
							...
							<li class="chk">
								...
								<label for="opt1">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2022/hitbrand/m_prize_img1.jpg" alt="" />
									</span>
									<p class="proname">아이패드 프로<br/>5세대 Wi-Fi 256GB <br/>(1명)</p>
								</label>
							</li>
							<li>
								...
								<label for="opt2">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2022/hitbrand/m_prize_img2.jpg" alt="" />
									</span>
									<p class="proname">엠지텍<br/>로봇청소기<br/>(1명)</p>
								</label>
							</li>
							<li>
								...
								<label for="opt3">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2022/hitbrand/m_prize_img3.jpg" alt="" />
									</span>
									<p class="proname">해피머니<br/>e 20,000<br/>(400명)</p>
								</label>
							</li>
						</ul>
					</div>
					...
					<div class="btn__group">
						...
						<a class="btn laycancel" onclick="$('#applyPrize').hide(); return false">취소</a>
					</div>
				</div>
				<!-- //popup_box -->
			</div>
...
<div id="winJackpot" class="pop-layer" style="display:none;">
	...
	<div class="popup_box result">
		<h4>잭팟 당첨</h4>
		<div class="inner">
            <span class="tx_emoney">획득한 e머니 : <em>0</em>점</span>
	...
	<div class="appLayer mycheck">
		...
		<div class="layercont">
			...
			<div class="mycheck_box">
				<ul>
					<li class="get">
						<strong>획득 코인 : <em>0</em>개</strong>
					</li>
					<li class="remain">
						<strong>남은 코인 : <em>0</em>개</strong>
					</li>
				</ul>
			</div>
			...
			<div class="detail_box">
					<div class="used">
						<strong>사용한 코인 : <em>0</em>개</strong>
					</div>
...
function loadPostData(type){
	var param = {"procCode" : type ,"sdt" : sdt };
	var vSuccess = false;
	if(type == 2){
		var _selected ="";
...
function drawTopList(json){
	if(json.length > 0){
		...
		$.each(json,function(i,v){
			if(i == 0)	vOnClass = "on";
			topUlObject.append("<li ordno=\""+v.ord+"\"><a href=\"javascript:void(0);\" class=\""+vOnClass+"\">"+v.choice_part+"</a></li>");
		});

		topUlObject.find("li").on("click", function(){
			var vThis = $(this);
...
function drawMyApply(json){
	...
	if(vCoinUseList.length > 0){
		...
		$.each(vCoinUseList,function(index,listdata){
			...
			if	   (listdata["select_seq"] =="1" )	html +="<td>아이패드 프로 5세대</td>";
			else if(listdata["select_seq"] =="2" )	html +="<td>엠지텍 로봇청소기</td>";
			else if(listdata["select_seq"] =="3" )	html +="<td>해피머니 상품권</td>";
...
function evtCommonChk (procCode) {
	...
	var chkDate = [
		{"startDate" : 20220622, "endDate" : 20220801}
	];
