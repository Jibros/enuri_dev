...
|| ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPad") > -1 ){
	...
	response.sendRedirect("/event2018/tabletAppBuy_201808.jsp");	//pc url 
	return;
}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/event/y2018/tablet_app_august_m.css"/>
...
<div class="wrap">
	...
	<div class="visual">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/august/m_visual.png" alt="격한 흥행! 검은사막 모바일 태블릿PC 크게 즐기자!" class="imgs" />
			<div class="blind">
				<h1>구글 플레이 카드로 시원하게 아이템 지르자!</h1>
				<em>올 여름엔 에누리가 쏜다</em>
			</div>
		</div>
	</div>
	...
	<div class="section promotionwrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/august/m_promotion_info.jpg" alt="구글 플레이 카드 이미지" class="imgs" />
			<div class="blind">
				<h2>구글 플레이 카드 획득!</h2>
				<em>app에서 태블릿 PC 구매!</em>
				<ol>
					<li>구글 플레이 카드 5만원권 1등(1명)</li>
					<li>구글 플레이 카드 3만원권 2등(3명)</li>
					<li>구글 플레이 카드 1만원권 행운상(6명)</li>
				</ol>
			</div>
			
			<div class="btn__group">
				<a href="javascript:void(0);" id="button_2" class="btn"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/m_promotion_buy.jpg" alt="태블릿PC 구매하기" class="imgs" /></a>
				<a href="javascript:void(0);" id="button_1" class="btn"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/m_promotion_join.jpg" alt="응모하기" class="imgs" /></a>
			</div>
			
			<ul class="promotion__info">
				<li>이벤트 참여 및 구매 기간 : 2018년 8월 1일 ~ 8월 31일</li>
				<li>당첨자 발표 : 2018년 9월 28일</li>
	...
	<div class="section flowevtWrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/august/m_flowevent.jpg" alt="" class="imgs" />
			<div class="blind">
				<h2>이벤트 참여방법</h2>
				<ol>
					<li>
					...
					<li>
						STEP 4<br />
						1등 5만원~ 당첨소식 기다리기! <strong>구글 플레이카드 5만원권을 드립니다.</strong>				
					</li>
				</ol>
			</div>
		</div>
	...
	<div id="giftWrap1" class="giftWrap">
		<div class="heads">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/august/m_gift_title1.jpg" class="imgs" alt="태블릿PC 점유율 1위 아이패드" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
	...
	<div id="giftWrap2" class="giftWrap">
		<div class="heads">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/august/m_gift_title2.jpg" class="imgs" alt="AS는 삼성이 제일!! 삼성 태블릿PC" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap3" class="giftWrap">
		<div class="heads">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/august/m_gift_title3.jpg" class="imgs" alt="업무 생산량은 서피스로 UP! 뉴 서피스 프로" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap4" class="giftWrap">
		<div class="heads">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/august/m_gift_title4.jpg" class="imgs" alt="합리적인 가격의 태블릿PC는? 가성비 뿜뿜!!" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
...
<div class="layer_back nofix" id="notetxt2" style="display:none;">
	...
	<div class="noteLayer no_fixed">
		...
		<div class="inner">
			<dl class="txtlist">
				<dt>이벤트/구매 기간 :</dt>
				<dd>2018년 8월 1일 ~ 8월 31일</dd>
			</dl>
			
			<dl class="txtlist">
				<dt>경품 : </dt>
				<dd>1등: 구글 플레이카드 5만원권 (1명 추첨)</dd> 
 				<dd>2등: 구글 플레이카드 3만원권 (3명 추첨)</dd>
 				<dd>행운상: 구글 플레이카드 1만원권 (6명 추첨)</dd>
...
var ajaxUrl = "/mobilefirst/evt/chuseok_201709_ajax.jsp?exh_id=17";
