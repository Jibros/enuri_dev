...
<div class="wrap">
							...
							<dl>
								...
								<dd>
									...
									<ul>
										...
										<li>이벤트 기간 : 2020년 12월 1일 ~ 12월 31일</li>
										<li>이벤트 혜택 : [맥도날드] 1955버거 세트 (e7,000) - 20명 추첨</li>
										<li>당첨자 발표 : 2021년 1월 12일 화요일</li>
	...
	<div class="bnr_wrap bnr_xmas">
		<h3 class="blind">크리스마스 시즌 배너</h3>

		<a href="/mobilefirst/event2020/christmas_2020_evt.jsp" target="_blank" title="새 창에서 열립니다.">크리스마스 배너</a>			
	</div>
	<div class="bnr_wrap">
...
var sdt = "<%=sdt%>";
var reply_event_code = "2020120106"; //오늘의한마디 댓글 이벤트코드
var PAGENO = 1;
var PAGESIZE = 5;
var BLOCKSIZE = 5;
