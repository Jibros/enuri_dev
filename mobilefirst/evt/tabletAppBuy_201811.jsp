...
|| ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPad") > -1 ){
	...
	response.sendRedirect("/event2018/tabletAppBuy_201811.jsp");	//pc url 
	return;
}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/event/y2018/tablet_app_november_m.css"/>
...
<div class="wrap">
	...
	<!-- 상단비주얼 -->
	<div class="visual">
        <img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/november/m_visual.jpg" alt="" class="imgs" />
        <div class="blind">
            <h1>빨간날 없는 잔인한 11월 에누리에선 빨간맛</h1>
            <em>에누리 APP에서 태블릿 구매하면 빨간맛 드림</em>
        </div>
	</div>
	...
	<div class="section promotionwrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/november/m_promotion_info.jpg" alt="" class="imgs" />
            <div class="blind">
                <h2>APP에서 태블릿PC 구매하고</h2>
                <strong>죠스떡볶이 커피 받자!!</strong>
                <em>구매 후 응모시 추첨 증정! e머니 적립까지!</em>
            </div>
			<div class="btn__group">
				<a href="javascript:void(0);" id="button_2" class="btn"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_promotion_buy.jpg" alt="태블릿PC 구매하기" class="imgs" /></a>
				<a href="javascript:void(0);" id="button_1" class="btn"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_promotion_join.jpg" alt="응모하기" class="imgs" /></a>
            </div>
            
			<div class="promotion__info"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/november/m_pmevt_info.jpg" class="imgs" alt=""></div>
			<ul class="blind">
				<li>이벤트 참여 및 구매 기간 : 2018년 11월 1일 ~ 11월 30일</li>
				<li>당첨자 발표 : 2018년 12월 27일 (목)</li>
	...
	<div class="section flowevtWrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/november/m_flowevent.jpg" alt="" class="imgs" />
			<div class="blind">
				<h2>이벤트 참여방법</h2>
				<ol>
					<li>
	...
	<div id="giftWrap1" class="giftWrap">
        <div class="heads">
            <h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/november/m_gift_title1.png" class="imgs" alt="태블릿PC 점유율 1위 아이패드" /></h2>
		</div>
		<div class="contents">
            <!-- items_area -->
			<div class="items_area">
				...
				<a href="javascript:void(0);" onclick="window.open('/mobilefirst/list.jsp?cate=0305');" class="itemlist_more"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/november/btn_more.png" alt="상품더보기" class="imgs"></a>
			</div>
			<!-- items_area -->
		</div>
	</div>
	...
	<div id="giftWrap2" class="giftWrap p-bgc">
		<div class="heads p-bgc">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/november/m_gift_title2.png" class="imgs" alt="AS는 삼성이 제일!! 삼성 태블릿PC" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap3" class="giftWrap">
		<div class="heads">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/november/m_gift_title3.png" class="imgs" alt="업무 생산량은 서피스로 UP! 뉴 서피스 프로" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap4" class="giftWrap p-bgc">
		<div class="heads p-bgc">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/november/m_gift_title4.png" class="imgs" alt="합리적인 가격의 태블릿PC는? 가성비 뿜뿜!!" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
...
<div class="layer_back nofix" id="notetxt2" style="display:none;">
	...
	<div class="noteLayer no_fixed">
		...
		<div class="inner">
			<dl class="txtlist">
				<dt>이벤트/구매 기간 :</dt>
				<dd>2018년 11월 1일 ~ 11월 30일</dd>
			</dl>
			
			<dl class="txtlist">
				<dt>경품 : </dt>
                <dd>죠스 떡볶이 모바일 상품권 2만 원권 1매 (1명 추첨)</dd>
                <dd>죠스 떡볶이 모바일 상품권 1만 원권 1매 (5명 추첨)</dd>
                <dd>스타벅스 카페라떼 (T) 1매 (6명 추첨)</dd>
				<dd><strong class="emp">이벤트 응모시 입력한 e-메일 주소를 통해 키프티콘 전송</strong><br /><u>※ 사정에 따라 경품이 변경될 수 있습니다.</u></dd>
			</dl>

			<dl class="txtlist">
				<dt>당첨자 발표 및 경품 전송</dt>
				<dd>2018년 12월 27일</dd>
			</dl>
...
var ajaxUrl = "/mobilefirst/evt/chuseok_201709_ajax.jsp?exh_id=20"; //10월 프로모션과 데이터 같아서 같이 쓴다
...
$(function() {
	...
	ga('send', 'pageview', {
		'page': '/mobilefirst/evt/tabletAppBuy_201811.jsp',
		'title': ''
	});
...
function getEventAjaxData(params, callback) {
	...
	if(!isLogin()) {
		...
		var evtUrl = "/mobilefirst/evt/ajax/tabletAppBuy_201811_setlist.jsp";
