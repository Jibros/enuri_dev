...
if(
	...
	response.sendRedirect("/eventPlanZone/jsp/HitBrand_202012.jsp");
	return;
}
...
<head>
	...
	<!-- 프로모션별 커스텀 CSS  -->
	<link rel="stylesheet" type="text/css" href="/css/event/y2020/hit_dec_m.css"/>
...
<div class="wrap">
    ...
    <div class="visual">
		<div class="inner">
			<div class="blind">
				<h1>2020 하반기 에누리 HIT BRAND</h1>
				<p>
					2020년 상반기 소비자들에게 가장 사랑 받은 히트브랜드를 소개합니다.<br/>
					이벤트기간 : 2020.12.16 ~ 2021.01.29
				</p>
			</div>
		</div>
	</div>
	...
	<div class="event event__wrap">
		...
		<div class="apply_box">
			<div class="inner">
				<div class="contents">
					<img src="http://img.enuri.info/images/event/2020/hitbrand_dec/m_gift_img_01.jpg" alt="획득하신 응모권으로 원하시는 경품에 응모하세요" />
					<!-- 응모하기 -->
									...
									<ol>
										<li>
											<ul class="txt_indent">
												...
												<li><em>당첨자 발표</em>
													<ul>
														<li>-  <b>2021년 2월 3일</b> [에누리 고객센터]에서 확인</li>
					...
					<div class="select_prize">
						...
						<ul class="prize_list">
							...
							<li class="chk">
								...
								<label for="opt1">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2020/hitbrand_dec/m_prize_img1.jpg" alt="" />
									</span>
									<p class="proname">애플<br/>아이폰12 프로 5G<br/>(1명)</p>
								</label>
							</li>
							<li>
								...
								<label for="opt2">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2020/hitbrand_dec/m_prize_img2.jpg" alt="" />
									</span>
									<p class="proname">갤럭시탭<br/>S7 11인치 WiFi<br/>(1명)</p>
								</label>
							</li>
							<li>
								...
								<label for="opt3">
									<span class="thumb">
										<img src="http://img.enuri.info/images/event/2020/hitbrand_dec/m_prize_img3.jpg" alt="" />
									</span>
									<p class="proname">다이슨 코랄<br/>헤어 스트레이트너<br/>(1명)</p>
								</label>
							</li>
						</ul>
					</div>
...
function drawMyApply(json){
	...
	if(vCoinUseList.length > 0){
		...
		$.each(vCoinUseList,function(index,listdata){
			...
			if	   (listdata["select_seq"] =="1" )	html +="<td>아이폰12 프로</td>";
			else if(listdata["select_seq"] =="2" )	html +="<td>갤럭시탭 S7 11 WiFi</td>";
			else if(listdata["select_seq"] =="3" )	html +="<td>다이슨 코랄 스트레이트너</td>";
...
function evtCommonChk (procCode) {
	...
	var chkDate = [
		{"startDate" : 20201216, "endDate" : 20210129}
	];
...
function coinEvtChk () {
	...
	var chkDate = [
		{"startDate" : 20201216, "endDate" : 20210202}
	];
	if(Number(sdt) < chkDate[0].startDate) {
		alert("이벤트 기간이 아닙니다.");
	} else if(chkDate[0].endDate < sdt) {
