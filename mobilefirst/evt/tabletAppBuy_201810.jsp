...
|| ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPad") > -1 ){
	...
	response.sendRedirect("/event2018/tabletAppBuy_201810.jsp");	//pc url 
	return;
}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/event/y2018/tablet_app_october_m.css"/>
...
<div class="wrap">
	...
	<!-- 상단비주얼 -->
	<div class="visual">
        <img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_visual.jpg" alt="휴가 끝 아쉬우니 커피?" class="imgbox" />
        <div class="blind">
            <h1>가을은 이제 그만 타요 에누리에서 치킨타요</h1>
            <em>에누리에서 태블릿 구매하면 치킨!</em>
        </div>
	</div>
	...
	<div class="section promotionwrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_promotion_info.jpg" alt="구글 플레이 카드 이미지" class="imgs" />
            <div class="blind">
                <h2>APP에서 태블릿PC 구매하고</h2>
                <strong>치킨 편의점 상품권 타요!</strong>
                <em>굽네 허니멜로 치킨 1명, GS모바일 상품권1만원 5명, GS모바일 상품권5천원 6명</em>
            </div>
			...
			<div class="promotion__info"><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_pmevt_info.jpg" class="imgs" alt=""></div>
			<ul class="blind">
				<li>이벤트 참여 및 구매 기간 : 2018년 10월 8일 ~ 10월 31일</li>
				<li>당첨자 발표 : 2018년 11월 29일 (목)</li>
	...
	<div class="section flowevtWrap">
		<div class="contents">
			<img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_flowevent.jpg" alt="" class="imgs" />
			<div class="blind">
				<h2>이벤트 참여방법</h2>
				<ol>
					<li>
	...
	<div id="giftWrap1" class="giftWrap">
        <div class="heads">
            <h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_gift_title1.png" class="imgs" alt="태블릿PC 점유율 1위 아이패드" /></h2>
		</div>
		<div class="contents">
            <!-- items_area -->
			<div class="items_area">
				...
				<a href="javascript:void(0);" onclick="window.open('/mobilefirst/list.jsp?cate=0305');" class="itemlist_more"><span>상품 더보기</span></a>
			</div>
			<!-- items_area -->
		</div>
	</div>
	...
	<div id="giftWrap2" class="giftWrap p-bgc">
		<div class="heads p-bgc">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_gift_title2.png" class="imgs" alt="AS는 삼성이 제일!! 삼성 태블릿PC" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap3" class="giftWrap">
		<div class="heads">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_gift_title3.png" class="imgs" alt="업무 생산량은 서피스로 UP! 뉴 서피스 프로" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
	...
	<div id="giftWrap4" class="giftWrap p-bgc">
		<div class="heads p-bgc">
			<h2><img src="http://imgenuri.enuri.gscdn.com/images/event/2018/tablet_app/october/m_gift_title4.png" class="imgs" alt="합리적인 가격의 태블릿PC는? 가성비 뿜뿜!!" /></h2>
		</div>
		<div class="contents">
			<!-- items_area -->
			<div class="items_area">
...
<div class="layer_back nofix" id="notetxt2" style="display:none;">
	...
	<div class="noteLayer no_fixed">
		...
		<div class="inner">
			<dl class="txtlist">
				<dt>이벤트/구매 기간 :</dt>
				<dd>2018년 10월 8일 ~ 10월 31일</dd>
			</dl>
			
			<dl class="txtlist">
				<dt>경품 : </dt>
                <dd>굽네 허니멜로 치킨 기프티콘 1매 (1명 추첨)</dd>
                <dd>GS25 모바일 상품권 1만 원권 1매 (5명 추첨)</dd>
                <dd>GS25 모바일 상품권 5천 원권 1매 (6명 추첨)</dd>
...
var ajaxUrl = "/mobilefirst/evt/chuseok_201709_ajax.jsp?exh_id=20";
...
$(function() {
	...
	ga('send', 'pageview', {
		'page': '/mobilefirst/evt/tabletAppBuy_2018.jsp',
		'title': ''
	});
...
function getEventAjaxData(params, callback) {
	...
	if(!isLogin()) {
		...
		var evtUrl = "/mobilefirst/evt/ajax/tabletAppBuy_201810_setlist.jsp";
