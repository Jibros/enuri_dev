		...
		<div class="inner">
			...
			<a href="javascript:///" class="btn adbanner" onclick="goNewFriendGo()">
				<%if(bannerOn.equals("winter")){ %>
					<img src="<%=ConfigManager.IMG_ENURI_COM%>/images/event/2020/attendance/jan/m_newyear_banner.jpg" alt="새해이벤트">
				<%}else{%>
...
var sdt = "<%=sdt%>";
var reply_event_code = "2020010106"; //오늘의한마디 댓글 이벤트코드
var PAGENO = 1;
var PAGESIZE = 5;
var BLOCKSIZE = 5;
...
function goNewFriendGo(){
	...
	if(bannerOn=="chuseok01"){
		...
		window.open("http://m.enuri.com/mobilefirst/event2020/newyear_2020_evt.jsp?freetoken=event");
	}else{
...
$(document).ready(function() {
	...
	function setTodayComment(){
		...
		case 20200101 : fClass = "f2"; str = "<p class='txt'><span>좋은 일만 생겼으면 합니다. <br> -v**n1320님의 한마디- </span>"; break;
		case 20200102 : fClass = "f2"; str = "<p class='txt'><span>행복하자 아프지말고 <br> -g**okr님의 한마디- </span>"; break;
		case 20200103 : fClass = "f2"; str = "<p class='txt'><span>오늘도 화이팅~~!! <br> -b**ou0729님의 한마디- </span>"; break;
		case 20200104 : fClass = "f2"; str = "<p class='txt'><span>즐거운 토요일 행복한 주말을 위하여~ <br> -c**nchonin님의 한마디- </span>"; break;
		case 20200105 : fClass = "f2"; str = "<p class='txt'><span>주말 재밌게 보내세요. <br> -y**su77님의 한마디- </span>"; break;
		case 20200106 : fClass = "f2"; str = "<p class='txt'><span>삶은 계속되고 아직 꿈꿀 시간은 많다 <br> -b**you00님의 한마디- </span>"; break;
		case 20200107 : fClass = "f2"; str = "<p class='txt'><span>상념을 가질수록 스스로를 누르는 무게가 커집니다 <br> -l**0093님의 한마디- </span>"; break;
		case 20200108 : fClass = "f2"; str = "<p class='txt'><span>행복하고 즐겁게 보내세요 <br> -l**13579123님의 한마디- </span>"; break;
		case 20200109 : fClass = "f2"; str = "<p class='txt'><span>행복한 하루되시고 늘 건강하세요 <br> -s**71님의 한마디- </span>"; break;
		case 20200110 : fClass = "f2"; str = "<p class='txt'><span>행복한 불금 되세요!^-^ <br> -e**5bed4141님의 한마디- </span>"; break;
		case 20200111 : fClass = "f2"; str = "<p class='txt'><span>오 해피데이! 즐거운 주말되세요 <br> -d**dmau82님의 한마디- </span>"; break;
		case 20200112 : fClass = "f2"; str = "<p class='txt'><span>오늘의 나 너 우리가 행복했던 오늘을 무사히 보내고 더 행복한 내일을 꿈꾸길 <br> -1**c652d8fb님의 한마디- </span>"; break;
		case 20200113 : fClass = "f2"; str = "<p class='txt'><span>인생 뭐있나?즐겁게 살아요 <br> -e**kaeng님의 한마디- </span>"; break;
		case 20200114 : fClass = "f2"; str = "<p class='txt'><span>불행하다고 느끼는건 정상이다. 모든 것을 다 가진 사람도 그런 감정을 가진다. <br> -8**104d485f님의 한마디- </span>"; break;
		case 20200115 : fClass = "f2"; str = "<p class='txt'><span>부정보단 긍정을 생각하자구요! <br> -v**uesky님의 한마디- </span>"; break;
		case 20200116 : fClass = "f2"; str = "<p class='txt'><span>홧팅! 좋은 시간 되시고 힘내세요 <br> -c**030님의 한마디- </span>"; break;
		case 20200117 : fClass = "f2"; str = "<p class='txt'><span>내게 주어진 것들에 감사하는 하루가 되어요~~♡♡♡ <br> -6**d7edb5e9님의 한마디- </span>"; break;
		case 20200118 : fClass = "f2"; str = "<p class='txt'><span>힘을 내요 모두 얍얍 기합을 <br> -c**ff47f71c님의 한마디- </span>"; break;
		case 20200119 : fClass = "f2"; str = "<p class='txt'><span>인생뭐 있나요 즐깁시다요!! <br> -e**otjdwo님의 한마디- </span>"; break;
		case 20200120 : fClass = "f2"; str = "<p class='txt'><span>삶은 바르게 사는것이 최고에 삶인것같다 <br> -m**joo0316님의 한마디- </span>"; break;
		case 20200121 : fClass = "f2"; str = "<p class='txt'><span>지나가는 오늘은 다시 돌아오지 않는다 <br> -p**kday님의 한마디- </span>"; break;
		case 20200122 : fClass = "f2"; str = "<p class='txt'><span>늘 같은 일상에 활력이 도네요 오늘도 모두들 화이팅하세요 <br> -k**ngj50님의 한마디- </span>"; break;
		case 20200123 : fClass = "f2"; str = "<p class='txt'><span>가만이 있어서 해결되는 일은 아무것도 없다 <br> -j**ngood님의 한마디- </span>"; break;
		case 20200124 : fClass = "f2"; str = "<p class='txt'><span>오늘도 우리 모두 즐거운 하루 <br> -7**59e06e72님의 한마디- </span>"; break;
		case 20200125 : fClass = "f2"; str = "<p class='txt'><span>시계는 돌아가기만 하고 돌아오진 않는다 <br> -0**3b1bfd8f님의 한마디- </span>"; break;
		case 20200126 : fClass = "f2"; str = "<p class='txt'><span>앞이 보이지 않을때는 잠깐 뒤를 보세요 <br> -n**w님의 한마디- </span>"; break;
		case 20200127 : fClass = "f2"; str = "<p class='txt'><span>오늘같은 날씨 핫팩으로 따뜻한 하루 보내세요 <br> -0**e51a2dda님의 한마디- </span>"; break;
		case 20200128 : fClass = "f2"; str = "<p class='txt'><span>오늘은 오늘인것만으로 즐거운 날이 되길 희망합니다. <br> -4**6d7d1066님의 한마디- </span>"; break;
		case 20200129 : fClass = "f2"; str = "<p class='txt'><span>언젠가 할 일이면 지금 하자 <br> -6**1ca24178님의 한마디- </span>"; break;
		case 20200130 : fClass = "f2"; str = "<p class='txt'><span>오늘도 해피 건강 행복 하세요 굿럭 행운 만땅 <br> -b**uty4jw님의 한마디- </span>"; break;
		case 20200131 : fClass = "f2"; str = "<p class='txt'><span>행복하고 건강한 하루 보내세요^^ <br> -i**sil123i님의 한마디- </span>"; break;
