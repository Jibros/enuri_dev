...
<div id="wrap">
	    ...
	    <header id="header" class="m_header head__type_d">
	        <div class="header_wrap">
	            <h1 class="m_txt">이전 방침 (수정일 : 2020.11.30)</h1>
			...
			<div class="policy_wrap">
				<div class="tab_policy_cnt">
					<div class="policy_inner" style="display:block">
                        ...
                        <h2>13. 고지의 의무</h2>
                        <p>
                        본 개인정보처리방침은 2020년 11월 30일부터 적용되며, 법령, 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 시에는 변경사항 시행일의 7일 전부터 에누리 웹 사이트의 공지사항을 통하여 고지할 것 입니다.
                        </p>
                        <br><br>
                        <p>
