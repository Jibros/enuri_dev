...
<div id="wrap">
	    ...
	    <header id="header" class="m_header head__type_d">
	        <div class="header_wrap">
	            <h1 class="m_txt">이전 방침 (수정일 : 2017.08.07)</h1>
			...
			<div class="policy_wrap">
				<div class="tab_policy_cnt">
					<div class="policy_inner" style="display: block !important">
                            <p>주식회사 써머스플랫폼(이하 “회사”라 함)에서 운영하는 서비스인 에누리가격비교(이하 “에누리”라 함)는 이용자들의 개인정보보호를 매우 중요시하며, 정보통신서비스 제공자가 준수하여야 하는 관련 법령 및 규정을 준수하고 있습니다.
                            ...
                            <p>
                            	회사에서는 이용자에게 다양하고 편리한 서비스를 제공하기 위하여 아래와 같은 개인정보를 수집하고 있습니다.<br><br>
							...
							<table class="tb_box">
								...
								<tr>
									<td>성명, ID, 비밀번호, 휴대폰번호, 이메일주소, 주소, 일반전화번호</td>
									<td>에누리 조립PC 서비스 이용에 따른 주문, 배송, 고객상담, 반품, 환불 등의 서비스</td>
									<td>웹사이트 및 모바일웹에서 상품 주문/결제시</td>
								</tr>
								</tbody>
							</table>
							<br>
						...
						<h2>14. 고지의 의무</h2>
						<p>
						본 개인정보처리방침은 2017년 08월 07일부터 적용되며, 법령, 정책 또는 보안기술의 변경에 따라<br>
