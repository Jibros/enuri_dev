...
<div id="wrap">
	    ...
	    <header id="header" class="m_header head__type_d">
	        <div class="header_wrap">
	            <h1 class="m_txt">이전 방침 (수정일 : 2021.03.10)</h1>
		...
		<section id="container">
			<div class="policy_wrap">
				<div class="tab_policy_cnt">
					<div class="policy_inner" style="display:block">
						...
						<table class="tb_box">
							<colgroup>
								...
								<tbody>
									...
									<tr>
										<td>쇼핑 리포트 동의 회원</td>
										<td>쇼핑몰 주문내역(주문일자, 주문금액, 구매수량, 주문상태), 상품정보(상품명, 가격, URL, 이미지)</td>
										<td>쇼핑 리포트 제공 및 전용 서비스(제품) 개발 및 제공을 위한 사용</td>
										<td>쇼핑 리포트 서비스 이용 시</td>
									</tr>
								</tbody>
						</table>
						<br>
					...
					<h2>13. 고지의 의무</h2>
					<p>
					본 개인정보처리방침은 2021년 3월 10일부터 적용되며, 법령, 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 시에는 변경사항 시행일의 7일 전부터 에누리 웹 사이트의 공지사항을 통하여 고지할 것 입니다.
					</p>
					<br><br>
					<p>
					- 공고일자: 2021년 03월 02일<br>
					- 시행일자: 2021년 03월 10일
					</p>
                        <br>
                    </div>
