...
<div id="wrap">
	    ...
	    <header id="header" class="m_header head__type_d">
	        <div class="header_wrap">
	            <h1 class="m_txt">이전 방침 (수정일 : 2017.06.01)</h1>
			...
			<div class="policy_wrap">
				<div class="tab_policy_cnt">
                    ...
                    <p>주식회사 써머스플랫폼(이하 “회사”라 함)에서 운영하는 인터넷서비스인 에누리가격비교(이하 “에누리”라 함)는 이용자들의 개인정보보호를 매우 중요시하며, 정보통신서비스 제공자가 준수하여야 하는 관련 법령 및 규정을 준수하고 있습니다.
                            ...
                            그리고 개인정보처리방침을 개정하는 경우 회사는 개인정보처리방침 변경 시행 7일전부터 회사 공지사항을 통하여 공지하고 개정일자 등을 부여하여 개정된 사항을 이용자들이 쉽게 알아볼 수 있도록 하고 있습니다.<br>
                            회사의 개인정보처리방침은 아래와 같은 내용을 담고 있습니다.

                            <br><br>

                            1. 개인정보의 수집목적 및 이용목적<br>
                            2. 회사가 수집하는 개인정보 항목 및 수집방법<br>
                            3. 개인정보 수집에 대한 동의<br>
                            4. 쿠키(cookie)의 운영 및 활용<br>
                            5. 회사가 수집한 개인정보의 공유 및 제공<br>
                            6. 회사가 수집하는 개인정보의 보유 및 이용기간<br>
                            7. 개인정보 열람, 정정<br>
                            ...
                            <p>
                            “회사”는 아래와 같은 목적으로 서비스 제공을 위한 최소한의 개인정보만을 수집하며, 수집하는 정보를 목적 외로 사용하거나, 이용자의 동의 없이 외부에 공개하지 않습니다.<br><br>
                            ...
                            <p>
                            회사에서는 이용자에게 다양하고 편리한 인터넷 서비스를 제공하기 위하여 아래와 같은 개인정보를 수집하고 있습니다.<br><br>
                            ...
                            <p>
                            이용자들에게 특화된 맞춤서비스를 제공하기 위해서 회사는 이용자들의 정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버(HTTP)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 암호화되어 저장됩니다.<br>
                            이용자들이 에누리에 접속한 후 로그인(LOG-IN)하여 서비스를 이용하기 위해서는 쿠키를 허용하셔야 합니다.<br>
                            회사는 이용자들에게 적합하고 보다 유용한 서비스를 제공하기 위해서 쿠키를 이용하여 아이디에 대한 정보를 찾아냅니다.<br>
                            ...
                            <p>회사는 이용자들의 동의가 있거나 법률의 규정에 의한 경우를 제외하고는 어떠한 경우에도 "2. 회사가 수집하는 개인정보 항목 및 수집방법"에서 고지한 범위를 넘어서 이용자들의 개인정보를 이용하거나 타인 또는 타기업, 기관에게 제공하지 않습니다.</p>

                            <h2>6. 회사가 수집하는 개인정보의 보유 및 이용기간</h2>
                            <p>
                            회사는 원칙적으로 이용자의 개인정보 수집 및 이용 목적이 달성되면 개인정보를 지체 없이 파기합니다. 또한 1년 이상 로그인하지 않은 미사용 계정의 경우 개인정보를 접속권한이 제한되어 있는 별도의 서버에 안전하게 분리 저장합니다.<br>
                            ...
                            <br>
                            회사의 개인정보보호를 위한 기술적, 관리적 대책은 아래와 같습니다.<br>
                            ...
                            *개인정보 분쟁조정위원회(한국인터넷 진흥원 운영)<br>
                            ...
                            <p>회사는 원활하고 향상된 서비스를 위하여 개인정보 취급을 타인에게 위탁할 수 있습니다. 이 경우 회사는 사전에 다음 각 호의 사항을 모두 이용자에게 미리 알리고 동의를 받습니다.<br>
						...
						<h2>14. 고지의 의무</h2>
						<p>
						본 개인정보처리방침은 2017년 06월 01일부터 적용되며, 법령, 정책 또는 보안기술의 변경에 따라<br>
