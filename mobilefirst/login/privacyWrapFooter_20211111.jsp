...
<div id="wrap">
	    ...
	    <header id="header" class="m_header head__type_d">
	        <div class="header_wrap">
	            <h1 class="m_txt">이전 방침 (수정일 : 2021.11.11)</h1>
					...
					<div id="tab3" class="policy_inner" style="display:block">
						<p>주식회사 써머스플랫폼(이하 “회사”라 함)에서 운영하는 서비스인 에누리가격비교(이하 “에누리”라 함)는 이용자들의 개인정보보호를 매우 중요시하며, 정보통신서비스 제공자가 준수하여야 하는 관련 법령 및 규정을 준수하고 있습니다.<br>
							...
							* 이용자 피해구제 방법 : 고객센터 (전화번호: 02-6345-3601 / 이메일: master@enuri.com)</p><p>
							...
							<h2>7. 동의철회 및 개인정보 파기절차와 그 방법</h2>
							<p>
							...
							<h2>9. 회사 개인정보 보호책임자 및 담당자의 소속-성명 및 연락처</h2>
							...
							특히 "8. 개인정보보호를 위한 기술적-관리적 대책"에서 명시한 것과 같이 공공장소에서 온라인상에서 접속해 있을 경우에는 더욱 유의하셔야 합니다.<br>
							...
							<h2>10. 개인정보관련 의견수렴 및 불만처리에 관한 사항</h2>
							<p>
							회사는 개인정보보호와 관련하여 이용자 여러분들의 의견을 수렴하고 있으며 불만을 처리하기 위하여 모든 절차와 방법을 마련하고 있습니다.<br>
							이용자들은 상단에 명시한 "9. 회사 개인정보 보호책임자 및 담당자의 소속-성명 및 연락처"를 참고하여 전화나 메일을 통하여 불만사항을 신고할 수 있고, 회사는 이용자들의 신고사항에 대하여 신속하고도 충분한 답변을 해 드릴 것입니다.<br>
							<br>
							...
							*개인정보 분쟁조정위원회(개인정보보호위원회 운영)<br>
							...
							또한, 회사는 개인정보의 처리와 관련하여 아래와 같이 업무를 각 수탁업체에게 위탁하고 있으며, 관계법령에 따라 위탁계약 체결시 개인정보가 안전하게 관리될 수 있도록 필요한 조치를 하고 있습니다.<br> 하단의 수탁업체는 이용자에게 사전 통지 또는 동의를 얻어 위탁 업무를 대행하고 있습니다.
								...
								<div class="dim" id="prv_layer" style="display:none;">
									<div class="privacy_layer" style="">
										...
										<div class="pr_layercon">
											<span class="update">*업데이트 : 2018.08.13</span>
											<p class="box">
												(주)스코코, (주)디에스인터내셔널, (주)바이오믹스, (주)베스트픽업, (주)썬웨이브, (주)솔로몬닷컴, (주)유니콘정보시스템, (주)벤로코리아, (주)누리원씨앤비, (주)이지케어, (주)크레용아이, (주)요이치, (주)마크앤드로우, (주)시스템게이트, (주)뉴런상사, (주)데코정보, (주)디뷰코리아, (주)몬스팩토리, (주)넥소, (주)에스알커머스, (주)피타소프트, (주)오쎄, (주)컨슈머리테일, (주)비엠씨, (주)오제플러스, (주)그레이스씨앤씨, (주)데이비드테크, (주)씨앤에스파워 ,크라이저, (주)에스지컴퓨터, (주)엔즈, (주)도도랩코리아, (주)제닉스,
												(주)에이블커머스, (주)인디썬, (주)로건, (주)블리스앤블레스, (주)스카이디지탈, (주)바론미디어
											</p>
								...
								<table class="tb_box">
									...
									<tr>
										<td>(주)LG CNS</td>
										<td>- 목적: 클라우드 인프라의 관리 및 운영<br>
										- 취급정보: 회원정보 일체<br>
										- 개인정보 보유 및 이용기간: 회원탈퇴 또는 위탁계약 종료 시 삭제
										</td>
									</tr>
								</tbody>
							</table>
							...
							<br>
						<p>
						개인정보 처리 위탁계약 체결시 회사는 수탁업체에 대하여 회사의 개인정보보호 관련 지시의 엄수, 개인정보에 관한 비밀유지, 개인정보의 제3자 제공 금지 및 사고시의 책임부담, 위탁기간, 재위탁에 대한 사항, 위탁계약 종료 후의 개인정보파기 등을 규정하고, 당해 계약내용을 서면 또는 전자적으로 보관합니다.
						</p>
						...
						<h2>13. 고지의 의무</h2>
						<p>
						본 개인정보처리방침은 2021년 11월 11일부터 적용되며, 법령, 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 시에는 변경사항 시행일의 7일 전부터 에누리 웹 사이트의 공지사항을 통하여 고지할 것 입니다.
						</p>
						<br><br>
						<p>
						- 공고일자: 2021년 11월 11일<br>
						- 시행일자: 2021년 11월 11일
						</p>
					</div>
				</div>
