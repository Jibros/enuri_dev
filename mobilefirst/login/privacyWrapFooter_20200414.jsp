...
<div id="wrap">
	    ...
	    <header id="header" class="m_header head__type_d">
	        <div class="header_wrap">
	            <h1 class="m_txt">이전 방침 (수정일 : 2020.04.14)</h1>
		...
		<section id="container">
			<div class="policy_wrap">
				<div class="tab_policy_cnt">
					...
					<h2>13. 고지의 의무</h2>
					<p>
					본 개인정보처리방침은 2020년 04월 14일부터 적용되며, 법령, 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 시에는 변경사항 시행일의 7일 전부터 에누리 웹 사이트의 공지사항을 통하여 고지할 것 입니다.
					</p>
					<br><br>
					<p>
					- 공고일자: 2020년 04월 07일<br>
					- 시행일자: 2020년 04월 14일
					</p>
						</div>
				</div>
