			...
			<div class="policy_wrap">
				<div class="tab_policy_cnt">
					<div class="policy_inner" style="display: block !important">
                            ...
                            <p>
                            “에누리”는 아래와 같은 목적으로 서비스 제공을 위한 최소한의 개인정보만을 수집하며, 수집하는 정보를 목적 외로 사용하거나, 이용자의 동의 없이 외부에 공개하지 않습니다.<br><br>
							...
							[회원관리]<br>
							 ...
							 또한 회사는 회원가입을 만14세 이상인 경우에 가능하도록 하며, 법정대리인의 동의가 필요한 만14세 미만 아동의 개인정보는 원칙적으로 수집 및 이용하지 않습니다. 단,. 법정대리인의 동의를 얻은 경우에는 만14세미만 이용자의 개인정보를 수집 및 이용할 수 있습니다.
                            </p>

                            <h2>2. 에누리가 수집하는 개인정보 항목 및 수집방법</h2>
                            <p>
                            에누리에서는 이용자에게 다양하고 편리한 인터넷 서비스를 제공하기 위하여 아래와 같은 개인정보를 수집하고 있습니다.<br><br>

                            1) 필수항목<br>
                            - 필수항목으로 수집한 개인정보는 회원탈퇴 즉시 파기합니다. <br>
							- 단, 부정이용 방지를 위해 회원ID, IP, 로그기록은 3년까지 보관할 수 있습니다.<br>
							...
							<table class="tb_box">
								...
								<tr>
									...
									<td>웹사이트 및 모바일웹/모바일앱에서 회원가입 시</td>
								</tr>
								</tbody>
							</table>
							<br>
							...
							<table class="tb_box">
								...
								<tr>
									<td>성별, 생년월일, 주소, 닉네임, 휴대폰본인인증결과값(CI,DI,휴대폰번호,성별,생년월일)</td>
									<td>신규 서비스 개발과 마케팅 및 광고에 활용, 본인식별 절차에 이용, 성인컨텐츠 이용시 성인인증, 부정사용 방지</td>
									<td>웹사이트 및 모바일웹/모바일앱에서 회원가입 시</td>
								</tr>
								</tbody>
							</table>
							...
							<table class="tb_box">
								...
								<tr>
									...
									<td>신규 서비스 개발과 마케팅 및 광고에 활용, 부정이용기록 확인</td>
									<td>웹사이트 및 모바일웹/모바일앱을 통한 서비스 이용 시</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>모바일앱 설치 및 구매활동에 따른 이벤트 등 전용 서비스 제공을 위한 사용</td>
							...
							<table class="tb_box">
								...
								<tr>
									...
									<td rowspan="3">최대 3년</td>
								</tr>
								<tr><td>계약 또는 청약철회 등에 관한 기록</td></tr>
                            ...
                            <p>
                            이용자는 회원가입 시 개인정보의 수집, 이용 및 제공에 동의하신 내용을 언제든지 철회하실 수 있습니다. 개인정보수집 동의철회 및 개인정보 파기절차와 그 방법은 아래와 같습니다.<br><br>
							...
							2) 파기절차<br>
                            이용자가 회원가입 등을 위해 입력한 정보는 수집 목적이 달성된 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류)내부 방침 및 기타 관련 법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다. <br>
						...
						<h2>14. 고지의 의무</h2>
						<p>
						본 개인정보처리방침은 2017년 4월 27일부터 적용되며, 법령, 정책 또는 보안기술의 변경에 따라<br>
