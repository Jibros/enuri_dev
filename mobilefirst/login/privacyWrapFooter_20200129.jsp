...
<div id="wrap">
	    ...
	    <header id="header" class="m_header head__type_d">
	        <div class="header_wrap">
	            <h1 class="m_txt">이전 방침 (수정일 : 2020.01.29)</h1>
					...
					<div class="policy_inner" style="display: block !important">
							...
							<table class="tb_box">
									...
									<tbody>
										...
										<tr>
											<td rowspan="2">일반/SDU/SDUL 회원</td>
											<td>이름, 주소, 휴대폰번호, 이메일</td>
											<td>체험단 참여 확인, 본인확인, 제품배송, 서비스이용 통계</td>
											<td>웹사이트 또는 모바일웹/모바일앱에서 체험단 참여 시</td>
										</tr>
										<tr>
							...
							* 형태정보의 수집 항목: 디바이스 정보(광고 식별자, 국가, 언어, 모델명, OS버전, 네트워크 환경)<p>
							* 형태정보의 이용 목적: 이용자의 특성을 고려한 서비스를 제공하기 위함<p>
							* 형태정보의 보유ㆍ이용 기간:<p>
							- 페이스북 : ‘이벤트 데이터‘는 최대 2년간 보존<p>
							- IGAWorks : 반영구적 보관, 요청 시 데이터 삭제<p>
							- Criteo : 21일간<p>
							* 형태정보의 수집 방법: 이용자가 사이트를 방문하거나 앱을 실행할 때 자동 수집, 전송<p>
							* 이용자 피해구제 방법 : 고객센터 (전화번호: 02-6345-3601 / 이메일: master@enuri.com)<p>
							이용자는 아래와 같은 방법으로 행태정보가 수집되지 않도록 거부할 수 있습니다.<p>
							다만, 설정하시더라도 일반적인 상품 광고는 노출될 수 있습니다.<p>
							&lt;WEB&gt;
							<p>
							- Internet Explorer: 인터넷 옵션 > 개인정보 > 고급 > 쿠키의 차단 또는 허용<p>
							- Chrome: 설정 > 고급 설정 표시 > 개인정보의 콘텐츠 설정 버튼 > 쿠키<p>
						...
						<h2>13. 고지의 의무</h2>
						<p>
						본 개인정보처리방침은 2020년 01월 29일부터 적용되며, 법령, 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 시에는 변경사항 시행일의 7일 전부터 에누리 웹 사이트의 공지사항을 통하여 고지할 것 입니다.
						</p>
						<br><br>
						<p>
						- 공고일자: 2020년 01월 22일<br>
						- 시행일자: 2020년 01월 29일
						</p>
						</div>
				</div>
