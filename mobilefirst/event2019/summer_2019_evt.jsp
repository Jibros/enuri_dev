...
if( ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPhone") > -1
	...
	response.sendRedirect("/event2019/summer_2019_evt.jsp");
	return;
}
...
String strFb_description = "무더위 프로모션";
...
<head>
	...
	<META NAME="description" CONTENT="매일 게임참여하고, 스타벅스 음료 받아가세요!">
	<META NAME="keyword" CONTENT="에누리가격비교, 통합기획전, 무더위, 여름준비, 여름상품, 바캉스">
	<meta property="og:title" content="여름준비 프로모션 – 최저가 쇼핑은 에누리">
	<meta property="og:description" content="매일 게임참여하고, 스타벅스 음료 받아가세요!">
	<meta property="og:image" content="<%=strFb_img%>">
	<meta name="format-detection" content="telephone=no" />
	<link rel="stylesheet" type="text/css" href="/css/event/y2019/hotsummer_pro_m.css"/>
...
<div id="eventWrap">
    ...
    <div id="floating_bnr" class="floating_bnr">
        <a href="/mobilefirst/event2019/summer_2019.jsp?tab=1" onclick="da_ga(5);" target="_blank"><img src="http://img.enuri.info/images/event/2019/hot_summer_pro/fl_bnr.png" alt="최대94% 타임딜"></a>
        <!-- 닫기 -->
	...
	<div class="toparea">		
		...
		<div class="visual">
			...
			<div class="inner">
				<div class="txt_tit">
					<div class="txt_wrap">
						<span class="txt_01">여</span><span class="txt_02">름</span><span class="txt_03">준</span><span class="txt_04">비</span>
					</div>
				</div>
				<span class="txt_stit">매일매일 스타벅스 공짜   +   쇼핑하면 아이패드 증정</span>
				<span class="obj-leaf">
					<span class="leaf_01"></span>
					<span class="leaf_02"></span>
					<span class="leaf_03"></span>
					<span class="leaf_04"></span>
					<span class="leaf_05"></span>
					<span class="leaf_06"></span>
					<span class="leaf_07"></span>
				</span>
				<span class="obj-crab"></span>
			</div>
			<script>
				// 상단 등장 모션
		...
		<div class="section floattab">
			<div class="contents">
				<ul class="floattab__list">
					<li><a href="#evt1" onclick="da_ga(2)" class="floattab__item floattab__item--01 is-on">게임하면 스타벅스</a></li>
					<li><a href="#evt2" onclick="da_ga(3)" class="floattab__item floattab__item--02">APP구매시 아이패드</a></li>
					<li><a href="/mobilefirst/event2019/summer_2019.jsp?tab=1" onclick="da_ga(4)" class="floattab__item floattab__item--03">최대 94% 타임딜</a></li>
				</ul>
			</div>
		</div>
	...
	<div id="evt1" class="section evt_1st scroll">
		<div class="contents">
			<h2><img src="http://img.enuri.info/images/event/2019/hot_summer_pro/m_event_01_tit.png" alt="매일 참여하면 시원하게 쏜다"></h2>
			<span class="evt_gift"><img src="http://img.enuri.info/images/event/2019/hot_summer_pro/m_event_01_gift.jpg" alt="스타벅스 패션 탱고티 레모네이트 피지오 Tall (e5,400)"></span>
			<!-- 게임화면 -->
			<div class="game_wrap">
				<div class="game_main">
					<span class="txt_game">게가 숨어있는 곳을 찾아주세요!</span>
					<span class="obj_balloon"><!-- 말풍선 --></span>
					<span class="obj_crab"><!-- 게 --></span>
					<ul>
						<!-- 구멍1 -->
						<li class="btn_hole_01">
							<span class="hole_area"></span>
						</li>
						<!-- 구멍2 -->
						<li class="btn_hole_02">
							<span class="hole_area"></span>
						</li>
						<!-- 구멍3 -->
						<li class="btn_hole_03">
							<span class="hole_area"></span>
						</li>
					</ul>
				</div>
				...
				<div class="layer_area">
					<!-- case 1 : 축하합니다! 친구를 찾으셨네요! -->
					<div class="layer_success">
						<img src="http://img.enuri.info/images/event/2019/hot_summer_pro/m_game_result_01.png" alt="축하합니다! 친구를 찾으셨네요!">
					</div>
					<!-- case 2 : 아쉽지만 친구를 찾지 못하셨어요. -->
					<div class="layer_fail">
						<img src="http://img.enuri.info/images/event/2019/hot_summer_pro/m_game_result_02.png" alt="아쉽지만 친구를 찾지 못하셨어요">
					</div>
				</div>
                <!-- // -->
			</div>
	...
	<div class="section pro_itemlist">
		<div class="contents">
			...
			<!-- 추천상품 탭 -->
			<ul class="pro_tabs">
				<li class="active"><a href="#protab1">#계절가전</a></li>
				<li><a href="#protab2">#여름패션</a></li>
				<li><a href="#protab3">#바캉스용품</a></li>
				<li><a href="#protab4">#홈캉스</a></li>
				<li><a href="#protab5">#여름별미</a></li>
			</ul>
			<!-- //추천상품 탭 -->
		...
		<div class="contents">			
			<div class="evt2_area">
				<div class="evt2_area__inner">
					<div class="blind">
						<h2>여름 시즌템 구매하고 "행운당첨"</h2>
						<p>앱에서 많이 구매할수록 당첨확률 UP!</p>
						<ol>
							<li>1등 아이패드 6세대 32G(실물배송) 1명 추첨</li>
							<li>2등 설빙 리얼 그린티 설빙 (e 9,500점) 15명 추첨</li>
				...
				<ul class="evt_info">					
					<li>이벤트 참여 및 구매 기간 : 2019년 6월 25일 ~ 7월 28일</li>
					<li>참여 방법 : APP &gt; 적립대상 쇼핑몰에서 구매하고 응모하기</li>
					<li>당첨자 발표 : 2019년 8월 29일 수요일 [에누리 앱 &gt; 이벤트/기획전 &gt; 이벤트 하단 당첨자 발표]</li>
		...
		<div class="caution-wrap">
			...
			<div class="moreview" style="border-bottom:1px solid #222">
				...
				<div class="txt">
					<dl class="txtlist">
						<dt>이벤트/구매 기간 :</dt>
						<dd>2019년 6월 25일 ~ 7월 28일</dd>
					</dl>
					
					<dl class="txtlist">
						<dt>경품 : </dt>
						<dd>1등 – 아이패드 6세대 32G (실물배송) - 1명 추첨 <strong class="emp">※제세공과금 당첨자 부담</strong></dd>
						<dd>2등 - 설빙 리얼그린티 설빙 (e머니 9,500점)-  15명 추첨</dd>
						<dd>3등 – 투썸플레이스 오렌지에이드 (e머니 5,500점) – 40명 추첨<br></dd>
					...
					<dl class="txtlist">
						<dt>당첨자 발표 및 적립</dt>
						<dd>2019년 8월 29일 [APP 이벤트/기획전 탭 &gt; 이벤트 하단 당첨자 발표]</dd>
					</dl>
					...
					<dl class="txtlist">
						...
						<dd>구매 e머니는 구매 확인완료 시점(구매 후 최대 30일)부터 모바일 앱 → 마이 에누리 → 적립내역 페이지에서 [적립받기] 선택시 적립(수동적립)</dd>
		...
		<div class="cont_area">
			<div class="img_box">
				...
				<div class="result_01" style="display:none">
					<img src="http://img.enuri.info/images/event/2019/hot_summer_pro/m_result_img_01.jpg" alt="축하해요~!! e머니 5,400점 적립 내일 또 만나요~">
				</div>
				<!-- 5점 적립 이미지 -->
				<div class="result_02" style="display:none">
					<img src="http://img.enuri.info/images/event/2019/hot_summer_pro/m_result_img_02.jpg" alt="5점 적립~">
				</div>
			</div>
...
function da_ga(num){
	...
	if(num == 2){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_탭_이벤트1");
	}else if(num == 3){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_탭_이벤트2");
	}else if(num == 4){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_탭_타임딜");
	}else if(num == 5){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_이벤트1참여");
	}else if(num == 6){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_이벤트1참여");
	}else if(num == 7){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_상품탭_계절가전");
	}else if(num == 8){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_상품탭_여름패션");
	}else if(num == 9){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_상품탭_바캉스");
	}else if(num == 10){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_상품탭_홈캉스");
	}else if(num == 11){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_상품탭_여름별미");
	}else if(num == 12){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_상품구매");
	}else if(num == 13){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_상품더보기");
	}else if(num == 14){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_기획전보러가기");	
	}else if(num == 15){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_응모하기");
	}else if(num == 16){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_응모하기_상품구매");
	}else if(num == 17){
		ga('send', 'event', 'mf_event', vEvent_title, "19 무더위 프로모션_혜택배너");
	}
}
...
$(document).ready(function() {
	...
	ga('send', 'pageview', {'page': vEvent_page,'title': '19 무더위 프로모션_PV'});
			         ...
			         var html = "";
			 		 if(goodsList.length >0){
			 			for(var i=0;i<goodsList.length;i++){
			 				...
			 				html+= "<li>";
			 				html+= "	<a href=\"javascript:;\" onclick=\"window.open('/mobilefirst/detail.jsp?modelno="+modelno+"&freetoken=vip');da_ga(16);\" title=\"새 탭에서 열립니다.\">";
	...
	$(".btn_goevt").click(function(){
		da_ga(14);
		window.open("/mobilefirst/event2019/summer_2019.jsp");
		return false;
	});
	...
	$(".sprite.btn_more").click(function(){
		var tabnum = nowTab+1;
		var goods_more = "/mobilefirst/event2019/summer_2019.jsp?tab="+tabnum;
		da_ga(13);
		window.open(goods_more); 
	});
	
	$("#snslayer li").click(function(){
		var shareUrl = "http://" + location.host + "/mobilefirst/event2019/summer_2019_evt.jsp";
			 ...
			 try{ 
				...
				Kakao.Link.sendDefault({
				      ...
				      content: {
				        title: shareTitle,
				        description: "무더위타파!\n여름시즌상품 구매하면\n애플 아이패드 추첨증정!\n지금 당장 에누리로~!",
				        imageUrl: "<%= ConfigManager.IMG_ENURI_COM%>/images/mobilenew/images/sns_1200_630.jpg",
				        link: {
		...
		for(var i=0;i<goodsList.length;i++){
			if(i<12){
				if(i%4==0) html += "<ul class=\"items clearfix\">";
					...
					html+= "<li class=\"item\">";
					html+= "	<a href=\"javascript:;\" onclick=\"itemClick("+goodsData["MODELNO"]+","+goodsData["MINPRICE"]+");da_ga(12);\" target=\"_blank\" title=\"새 탭에서 열립니다.\">";
...
function getEventAjaxData(params, callback){
	...
	var evtUrl = "/mobilefirst/evt/ajax/summer2019_setlist.jsp";
...
$(document).ready(function(){
	...
	var holeFindGame = {
		...
		reset : function(){ // 오브젝트 재배치
			this.el.hole.removeClass("selected").parent().removeClass("selected");
	...
	function rewards(result){
		...
		setTimeout(function(){
			// 레이어 띄우기
			var $Layer = holeFindGame.el.layer;
			// 결과 레이어 노출
			if (result==5){ // 낙첨
				...
				setTimeout(function(){										
					// 팝업 띄우기
					onoff('prizes');
					$("#prizes").find(".result_01").show(); // 5,400점
					// 게임 초기화
					holeFindGame.reset();
				},1000);
			}
