...
if( ChkNull.chkStr(request.getHeader("User-Agent")).indexOf("iPhone") > -1
	...
	response.sendRedirect("/event2019/winter_2019_evt.jsp");
	return;
}
...
String strFb_description = "월동 프로모션";
...
<head>
	...
	<META NAME="description" CONTENT="매일 게임참여하고, 스타벅스 커피 받아가세요!">
	<META NAME="keyword" CONTENT="에누리가격비교, 프로모션, 월동준비, 겨울, 월동, 매일참여, 겨울이벤트">
	<meta property="og:title" content="월동준비 프로모션 - 최저가 쇼핑은 에누리">
	<meta property="og:description" content="매일 게임참여하고, 스타벅스 커피 받아가세요!">
	<meta property="og:image" content="<%=strFb_img%>">
	<meta name="format-detection" content="telephone=no" />
	<link rel="stylesheet" type="text/css" href="/css/event/y2019/prewinter_pro_m.css"/>
...
<div id="eventWrap">
    ...
    <div id="floating_bnr" class="floating_bnr">
        <a href="/mobilefirst/event2019/winter_2019.jsp?tab=1" target="_blank" onclick="da_ga(5)"><img src="http://img.enuri.info/images/event/2019/pre_winter_pro/fl_bnr.png" alt="가정의달 선물 반값특가"></a>
        <!-- 닫기 -->
		...
		<div class="section floattab">
			<div class="contents">
				<ul class="floattab__list">
					<li><a href="#evt1" onclick="da_ga(2)" class="floattab__item floattab__item--01">게임하면 스타벅스 공짜</a></li>
					<li><a href="#evt2" onclick="da_ga(3)" class="floattab__item floattab__item--02">쇼핑하면 카카오프렌즈</a></li>
					<li><a href="/mobilefirst/event2019/winter_2019.jsp?tab=1" target="_blank" onclick="da_ga(5)" class="floattab__item floattab__item--03">겨울 필수템 반값세일</a></li>
				</ul>
			</div>
		</div>
	...
	<div id="evt1" class="section evt_1st scroll">
		<div class="contents">
			<h2><img src="http://img.enuri.info/images/event/2019/pre_winter_pro/m_event_01_tit.png" alt="게임만 해도 매일매일 스타벅스 공짜!"></h2>
			<span class="evt_gift"><img src="http://img.enuri.info/images/event/2019/pre_winter_pro/m_event_01_gift.jpg" alt="스타벅스 아이스 아메리카노 (e4,100)"></span>
			<!-- 게임화면 -->
			<div class="game_wrap">
				<div class="game_main">
					<div class="wrap_gauge">
						<div class="obj_gauge"></div>
					</div>
					<button class="btn_game">눈 던지기</button>
				</div>

				<!-- 결과 레이어 영역 -->
				<div class="layer_area">
					<!-- case 1 : 축하합니다! 눈싸움에서 이기셨어요! -->
					<div class="layer_success">
						<img src="http://img.enuri.info/images/event/2019/pre_winter_pro/m_game_result_01.jpg" alt="축하합니다! 눈싸움에서 이기셨어요!">
					</div>
					<!-- case 2 : 아쉽지만 눈싸움에서 졌어요. -->
					<div class="layer_fail">
						<img src="http://img.enuri.info/images/event/2019/pre_winter_pro/m_game_result_02.jpg" alt="아쉽지만 눈싸움에서 졌어요.">
					</div>
				</div>
                <!-- // -->
			</div>
	...
	<div class="section pro_itemlist">
		<div class="contents">
			<h3 class="tit">더위타파를 위한 추천상품</h3>
			
			<!-- 추천상품 탭 -->
			<ul class="pro_tabs">
				<li class="active"><a href="#protab1">#리빙월동준비</a></li>
				<li><a href="#protab2">#패션월동준비</a></li>
				<li><a href="#protab3">#방한월동준비</a></li>
				<li><a href="#protab4">#단열월동준비</a></li>
				<li><a href="#protab5">#가전월동준비</a></li>
			</ul>
			<!-- //추천상품 탭 -->
	...
	<div id="evt2" class="section evt_2rd scroll">
		<h3 class="tit">APP에서 겨울 준비하고 경품 행운당첨!</h3>
		<p class="blind">앱에서 많이 구매할수록 당첨확률 UP!</p>
		<div class="contents">			
			<div class="evt2_area">
				<div class="evt2_area__inner">
					<div class="blind">
						<ol>
							<li>1등 라이언메가 바디필로우 인형 쿠션(실물배송) 1명 추첨</li>
							<li>2등 피자마루 불고기피자 + 콜라1.25L (e 11,900점) 15명 추첨</li>
							<li>3등 GS25 상품권 5천원권 (e 5,000점) 55명 추첨</li>
						</ol>				
					</div>
				</div>
				<div class="btn_wrap">
				...
				<ul class="evt_info">					
					<li>이벤트 참여 및 구매 기간 : 2019년 10월 28일 ~ 11월 22일 </li>
					<li>참여 방법 : APP &gt; 적립대상 쇼핑몰에서 구매하고 응모하기</li>
					<li>당첨자 발표 : 2019년 12월 24일 화요일 [에누리 앱 &gt; 이벤트/기획전 &gt; 이벤트 하단 당첨자 발표]</li>
		...
		<div class="caution-wrap">
			...
			<div class="moreview" style="border-bottom:1px solid #222">
				...
				<div class="txt">
					<dl class="txtlist">
						<dt>이벤트/구매 기간 :</dt>
						<dd>2019년 10월 28일 ~ 11월 22일</dd>
					</dl>
					
					<dl class="txtlist">
						<dt>경품 : </dt>
						<dd>1등 - 라이언 메가 바디필로우 인형 쿠션 - 4명 추첨 <strong class="emp">※제세공과금 당첨자 부담</strong></dd>
						<dd>2등 - [피자마루] 불고기피자+ 콜라1.25L (e 11,900점) -  15명 추첨</dd>
						<dd>3등 - GS편의점 상품권 5천원권 (e 5,000점) - 55명 추첨<br/><br/></dd>
					...
					<dl class="txtlist">
						<dt>당첨자 발표 및 적립</dt>
						<dd>2019년 12월 24일 [APP 이벤트/기획전 탭 > 이벤트 하단 당첨자 발표]</dd>
					</dl>
					...
					<dl class="txtlist">
						<dt><strong class="emp">※ 백화점 상품권 적립기준</strong></dt>
						<dd>1) 상품명에 '백화점 상품권' 명시된 상품 또는 백화점에서만 사용할 수 있는 상품권만 적립</dd>
						<dd>2) 복합상품권 적립불가(삼성 상품권/신세계 기프트카드/롯데카드 상품권/이랜드 상품권/AK플라자 상품권/통합 상품권 등)</dd>
						<dd>3) 복합 상품권의 경우 사용처에 백화점이 기재되어 있는 경우에도 적립불가</dd>
						<dd>4) 백화점 상품권으로 전환 가능한 포인트 구매시 적립불가</dd>
					</dl>
		...
		<div class="cont_area">
			<div class="img_box">
				...
				<div class="result_01" style="display:none">
					<img src="http://img.enuri.info/images/event/2019/pre_winter_pro/m_result_img_01.jpg" alt="축하해요~!! e머니 4,100점 적립 내일 또 만나요~" />
				</div>
				<!-- 5점 적립 이미지 -->
				<div class="result_02" style="display:none">
					<img src="http://img.enuri.info/images/event/2019/pre_winter_pro/m_result_img_02.jpg" alt="5점 적립~" />
				</div>
			</div>
...
function da_ga(num){
	...
	if(num == 2){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_탭_이벤트1");
	}else if(num == 3){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_탭_이벤트2");
	}else if(num == 4){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_탭_타임딜");
	}else if(num == 5){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_상단플로팅배너");
	}else if(num == 6){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_이벤트1참여");
	}else if(num == 7){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_상품탭_리빙월동");
	}else if(num == 8){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_상품탭_패션월동");
	}else if(num == 9){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_상품탭_방한월동");
	}else if(num == 10){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_상품탭_단열월동");
	}else if(num == 11){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_상품탭_가전월동");
	}else if(num == 12){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_상품클릭");
	}else if(num == 13){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_상품더보기");
	}else if(num == 14){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_기획전보러가기");	
	}else if(num == 15){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_구매응모하기");
	}else if(num == 16){
		ga('send', 'event', 'mf_event', vEvent_title, "19 월동 프로모션_혜택배너");
	}
}
...
$(document).ready(function() {
	...
	ga('send', 'pageview', {'page': vEvent_page,'title': '19 월동 프로모션_PV'});
	...
	$(".btn_goevt").click(function(){
		da_ga(14);
		window.open("/mobilefirst/event2019/winter_2019.jsp");
		return false;
	});
	...
	$(".sprite.btn_more").click(function(){
		var tabnum = nowTab+1;
		var goods_more = "/mobilefirst/event2019/winter_2019.jsp?tab="+tabnum;
		da_ga(13);
		window.open(goods_more); 
	});
	
	$("#snslayer li").click(function(){
		var shareUrl = "http://" + location.host + "/mobilefirst/event2019/winter_2019_evt.jsp";
		var shareTitle = "[에누리 가격비교]\월동 이벤트!";
		var idx = $(this).index();
		...
		if(idx == 1) {
			 try{ 
				...
				Kakao.Link.sendDefault({
				      ...
				      content: {
				        title: shareTitle,
				        description: "성큼 다가온 겨울\n완벽하게 월동준비하면\n라이언 바디필로우 추첨증정!\n지금 당장 에누리로~!",
				        imageUrl: "<%= ConfigManager.IMG_ENURI_COM%>/images/mobilenew/images/sns_winter_1200_630.jpg",
				        link: {
...
function getEventAjaxData(params, callback){
	...
	var evtUrl = "/mobilefirst/evt/ajax/winter2019_setlist.jsp";
			...
			setTimeout(function(){
				...
				if (result==5){ // 낙첨
					...
					setTimeout(function(){										
						// 팝업 띄우기
						onoff('prizes');
						$("#prizes").find(".result_01").show(); // 4,100점
						// 게임 초기화
						holeFindGame.reset();
					},1000);
				}
