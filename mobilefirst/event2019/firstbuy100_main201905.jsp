...
<!-- 이벤트01 -->
		...
		<div class="event_noti">
			<div class="noti_cnt">
				<ul>
					...
					<li>
						· 적립대상 쇼핑몰: G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프,</br>쿠팡, GS SHOP, CJmall, SSG ,마이크로소프트(스마트 스토어)
					</li>
					<li>
			...
			<div class="txt">
				...
				<dl class="txtlist">
					...
					<dd class="num">1. 에누리 모바일 앱 &gt; 로그인 &gt; 100원딜 상품 구매 &gt; [페이백 신청] 버튼 클릭<br>
						<span class="emp">※ 100원딜 상품 외에도 앱에서 1만원 이상 구매시 신청가능</span><p>
						<!-- 
						<span class="emp">※ 티몬의 경우 PC 및 모바일 웹에서 로그인 후 구매시 e머니 적립!</span>
						 -->
					</dd>
					<dd class="num">
						<!-- 2. 마이에누리 &gt; 적립내역에서 [적립받기] 버튼 클릭 &gt; 구매적립 완료<br>
						<span>※ 구매한 날로부터 최대 30일 이내에 적립받기 버튼 생성</span>
						 -->
						 2. 구매일로부터 최대 30일 이내에 페이백 지급 <strong class="emp">(해외직구 상품 구매시 최대  70일 소요)</strong>
					</dd>
					<dd>적립대상 쇼핑몰: G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프,<br/>쿠팡, GS SHOP, Cjmall, SSG (신세계몰, 신세계백화점, 이마트몰, 트레이더스) , 마이크로소프트(스마트 스토어)</dd>
					<dd>1만원 이상 구매금액은 배송비, 설치비, 할인, 쇼핑몰 포인트 등 제외한 상품의 실제 결제금액만 반영됨</dd>
				</dl>
	
				<dl class="txtlist">
					<dt>이벤트 유의사항</dt>
					<!-- <dd>ID당 1회 참여 가능하며, 1개의 기기에서 여러 ID로 참여 불가</dd> -->
					<!-- 
					<dd>기기와 ID 모두 ‘첫구매’인 경우에만 참여 가능하며, 이미 구매이력이 있는 기기(또는 구매이력 있는 중고기기)일 경우에는 참여불가</dd>
					<dd>본인인증 및 이벤트 정보동의 후 참여 가능</dd>
					 -->
					 <dd>ID당 1회 참여가능</dd>
					...
					<!-- <dd>구매적립 이후 이벤트 적립 진행되며, 구매 후 10일~최대 30일 이내 에누리 앱 → my → 적립내역 → 적립받기 클릭시 구매적립 </dd> -->
				...
				<dl class="txtlist">
					...
					<!-- <dd>모바일앱 → my → 적립내역 페이지에서 구매적립 받지 않은 경우</dd>  -->
					<dd>본인인증값이 동일할 경우</dd>
					...
					<dl class="txt_indent">
						...
						<dd><span class="stress">※ 백화점 상품권 적립기준</span></dd>
						<dd style="background-image:none; padding-left:10px;">
	...
	<div id="evt2" class="section evt_2nd scroll">				
		<div class="contents">
			<h3><img src="http://img.enuri.info/images/event/2019/w100deal/m_sec2_tit.png" alt="파워적립 - 첫구매 후 100일간 최대 6,000점"></h3>
			<div class="stamp_con">
				<ul id="powerList">
					<!-- 활성화 .on 붙여주세요 -->
		...
		<div class="caution-wrap">
			...
			<div class="moreview">
				<div class="txt">
					...
					<dl class="txtlist">
						<dt>이벤트 대상자 및 혜택</dt>
						<dd><strong>이벤트 대상:</strong> 첫구매 후 100원딜 페이백 신청한 회원 대상</dd>
						<dd class="emp"><strong class="emp">파워적립:</strong> 구매적립 완료 다음날 파워적립 e머니 지급</dd>
						<dd><strong class="emp">E머니 유효기간: 적립일로부터 15일 (유효기간 만료 후 재적립 불가)</strong> ※ 적립된 e머니는 e쿠폰 스토어에서 다양한 쿠폰으로 교환가능합니다.</dd>
					</dl>
					
					<dl class="txtlist">
						<dt>이벤트 참여방법</dt>
						<dd class="num">
							1. 에누리앱 모바일 앱 &gt; 로그인 &gt; 적립대상 쇼핑몰 이동 &gt; 
							<span class="emp">첫구매일로부터 100일 이내에 1만원 이상 구매</span><p>
							<!-- 
							<span class="emp">※ 티몬의 경우 PC 및 모바일 웹에서 로그인 후 구매시 e머니 적립!</span>
							 -->
						</dd>
						<dd class="num">
						<!-- 
							2. 마이에누리 &gt; 적립내역에서 [적립받기] 버튼클릭 &gt; 구매적립 완료<br>
							※ 구매한 날로부터 최대 30일 이내에 적립받기 버튼 생성
						 -->
						 . 구매일로부터 최대 30일 이내에 파워적립 완료 <strong class="emp">(해외직구 상품 구매시 최대 70일 소요)</strong>
						</dd>
						<dd>적립대상 쇼핑몰: G마켓, 옥션, 11번가, 인터파크, 티몬, 위메프,</br>쿠팡, GS SHOP, Cjmall, SSG (신세계몰, 신세계백화점, 이마트몰, 트레이더스), 마이크로소프트(스마트 스토어)</dd>
						<dd>1만원 이상 구매금액은 배송비, 설치비, 할인, 쇼핑몰 포인트 등 제외한 상품의 실제 결제금액만 반영됨</dd>
					</dl>
					...
					<dl class="txtlist">
						<dt>이벤트 유의사항</dt>
						<dd>100원딜 페이백에 참여하지 않은 경우에는 파워적립 불가</dd>
						<dd>친구초대 첫구매 혜택 신청한 경우에도 파워적립 혜택 지급가능</dd>
						<!-- <dd>1개의 기기에서 여러 ID로 참여 불가</dd> -->
						<dd>첫구매, 페이백 신청, 100일 이내 재구매 <span class="emp">모두 동일한 기기에서 진행시에만 참여가능</span> (1개의 ID로 각기 다른 기기에서 진행한 경우 참여 불가)</dd>
						<!-- <dd>구매적립 이후 이벤트 적립 진행되며, 구매 후 10일~최대 30일 이내 에누리 앱 → my → 적립내역 → 적립받기 클릭시 구매적립 </dd> -->
						<dd>첫구매일로부터 100일 이후에는 파워적립 대상에서 제외</dd>
					</dl>
