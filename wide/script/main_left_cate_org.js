...
jQuery(document).ready(function(){
	...
	jQuery(document).on("click", "#main_left_cate > li", function(){
		if(!gnbBannerInit) {
			fnSetGnbBanner();
			gnbBannerInit = true;
		}
...
function fnGnbInit(){
	...
	$1DepthList = jQuery("#main_left_cate > li");
...
function loadGnbAllMenu(idx){
	...
	jQuery.ajax({
		url : isDev ? "/wide/main/ajax/Ajax_Gnb_Src_2021_main.jsp?stype=allCate" : "/common/jsp/AllCateList_2020.html",
		data : "html",
...
function fnSetGnbBanner(){
	var url = isDev > 0 ? "/wide/main/ajax/Ajax_Gnb_Src_2021_main.jsp?stype=banner" : "/common/js/eb/nGnbBanner_data_2018.json";
		...
		jQuery.each(bannerList,function(i,banners){
			jQuery.each(banners["banner"],function(j,banner){
				...
				if(parseInt(banner["source"])==0){
					...
					switch(parseInt(banner["linktype"])){
						case 1 : {
							html = "<li class='cate-main-bnr__item'><a href=\"javascript://\" onclick=\"window.open('" + banner["link"]+ "');"+bannerLog+"\"><img alt=\"\" src=\"" + banner["img"] + "\"></a></li>";break;
						}
						case 2 : {
							html = "<li class='cate-main-bnr__item'><a href=\"javascript://\" onclick=\"top.location.href = '" + banner["link"]+ "';\"><img alt=\"\" src=\"" + banner["img"] + "\"></a></li>";break;
						}
						case 3 : {
							html = "<li class='cate-main-bnr__item'><a href=\"javascript://\" onclick=\"Main_OpenWindow('" + banner["link"]+ "','','804', " + window.screen.height + ", 'yes');\"><img alt=\"\" src=\"" + banner["img"] + "\"></a></li>";break;
						}
					}
				}else{
				...
				//var $bannerArea = $1DepthList.eq(i).next().find("#banner__inner");
			...
			jQuery.getJSON(varFilePath, {_: new Date().getTime()} , function(banner){
				...
				switch(parseInt(banner["TARGET"])){
					case 1 : {
						html = "<li class='cate-main-bnr__item' ><a href=\"javascript://\" onclick=\"window.open('" + banner["JURL1"]+ "');\"><img alt=\"\" src=\"" + banner["IMG1"] + "\"></a></li>";break;
					}
					case 2 : {
						html = "<li class='cate-main-bnr__item'><a href=\"javascript://\" onclick=\"top.location.href = '" + banner["JURL1"]+ "';\"><img alt=\"\" src=\"" + banner["IMG1"] + "\"></a></li>";break;
					}
					case 3 : {
						html = "<li class='cate-main-bnr__item'><a href=\"javascript://\" onclick=\"Main_OpenWindow('" + banner["JURL1"]+ "','','804', " + window.screen.height + ", 'yes');\"><img alt=\"\" src=\"" + banner["IMG1"] + "\"></a></li>";break;
					}
				}
				...
				if(html != ""){
					...
					try{
						var dotint = $bannerArea.find(".ul > li").size();
			...
			var varBannerUrl = "";
			switch(parseInt(i+1)){
				case 1 : varBannerUrl = "http://ad-api.enuri.info/enuri_PC/pc_home/B211/req";break;
				case 2 : varBannerUrl = "http://ad-api.enuri.info/enuri_PC/pc_home/B221/req";break;
				case 3 : varBannerUrl = "http://ad-api.enuri.info/enuri_PC/pc_home/B231/req";break;
				case 4 : varBannerUrl = "http://ad-api.enuri.info/enuri_PC/pc_home/B241/req";break;
				case 5 : varBannerUrl = "http://ad-api.enuri.info/enuri_PC/pc_home/B251/req";break;
				case 6 : varBannerUrl = "http://ad-api.enuri.info/enuri_PC/pc_home/B261/req";break;
				case 7 : varBannerUrl = "http://ad-api.enuri.info/enuri_PC/pc_home/B271/req";break;
				case 8 : varBannerUrl = "http://ad-api.enuri.info/enuri_PC/pc_home/B281/req";break;
			}
	...
	$1DepthList.each(function(i,v){
		...
		_this.click(function(e){
				...
				if(jQuery.trim(jQuery("#first_depth" + i).html()) == ""){
					...
					jQuery.ajax({
						url : isDev ? "/wide/main/ajax/Ajax_Gnb_Src_2021_main.jsp?g_seq="+g_seq[i] : "/common/jsp/CateList_2020_"+i+".html",
						data : "html",
						async : false,
						success:function(data){
