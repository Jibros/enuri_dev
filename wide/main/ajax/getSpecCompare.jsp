...
<%
    ...
    **/
    ...
    Pricelist_Proc pp = new Pricelist_Proc();
    ...
    if(intModelno==0){
        ...
        if(goodsData.length() > 0){
            ...
            specModelData = msp.getSpecCompareModelNo(strType,intModelno,strCate,strBrand);
            ...
            for(int i = 0;i<arrModelNos.length;i++){
                ...
                //System.out.println("tmpModelno : "+tmpModelno);
                ...
                if(tmpObj !=null){
                    ...
                    String[] shop = pp.getMinPriceImageUrl(tmpModelno);
                    
                    tmpObj.put("shopnm",shop[1]);
