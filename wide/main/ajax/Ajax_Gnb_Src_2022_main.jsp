			...
			if(gnb_list_1!=null && gnb_list_1.length>0){
			    ...
			    for(int j=0; j<gnb_list_1.length; j++){
			    	...
			    	if(!StringUtils.equals(groupCate, bd_lcate_nm)){
                        ...
                        sbGnbList.append("<a class='cate__tit'>");
                        sbGnbList.append(bd_lcate_nm);
                        sbGnbList.append("</a>");
                            sbGnbList.append("<ul class='cate--depth3 cate--common_trigger'>");
			    	}
			    	
			    		if(j == 0)	sbGnbList.append("<li class='cate-item--depth3'>");	
			    		else		sbGnbList.append("<li class='cate-item--depth3'>");
			    		
			    			sbGnbList.append("<div class='cate__tit'>"+gnb_list_1[j].getG_name()+"</div>");
					        ...
					        if(gnb_list_2!=null && gnb_list_2.length>0){
	                            ...
	                            sbGnbList.append("<ul class='cate--depth4 cate--common_trigger'>");
	                            
					        	//sbGnbList.append("<li class='cate-item--depth4 view_allitem'>"+gnb_list_1[j].getG_name().trim());
					        	
					        	sbGnbList.append("<li class='cate-item--depth4 active'>");
	                              //전체보기 버튼
	        			        	...
	        			        	if(strG_Link != null && strG_Link.length() > 0){
	        			        		...
	        			        		if(strG_Link.indexOf("http") > -1) strHtmlTarget = "target = \"_blank\""; 
	        			        			 if(g_seq == 1) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24311);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 2) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24312);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 3) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24313);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 4) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24314);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 5) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24315);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 6) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24316);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 7) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24317);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 8) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24318);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 9) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24319);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 10) sbGnbList.append("<a href='"+strG_Link+"' onclick='insertLog(24320);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
	        			        		else if(g_seq == 11) sbGnbList.append("<a href='"+strG_Link+"' onclick='insertLog(24321);' class='cate__tit' "+strHtmlTarget+">전체보기</a>");
					            ...
					            for(int k=0; k<gnb_list_2.length && k<18; k++){
					                ...
					                if(k == 0 ) sbGnbList.append("<li class='cate-item--depth4'>");	
					                else       	sbGnbList.append("<li class='cate-item--depth4'>");
					                
					                //sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' >");
        			        		
					                if(k == 0) sbGnbList.append( 	  "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24300);'  "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 1) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24301);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 2) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24302);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 3) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24303);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 4) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24304);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 5) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24305);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 6) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24306);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 7) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24307);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 8) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24308);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 9) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24309);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 10) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24310);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 11) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24311);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 12) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24312);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 13) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24313);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 14) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' class='cate__tit' onclick='insertLog(24314);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
					                ...
					                if(gnb_list_3!=null && gnb_list_3.length>0){
					                	...
					                	sbGnbList.append("<ul class='cate--depth5 cate--common_trigger'>");
					                	
					                	sbGnbList.append("	<li class='cate-item--depth5 view_allitem'><a href='javascript:'>"+gnb_list_2[k].getG_name().replaceAll("\\<(br|BR)/{0,1}\\>","")+"</a></li>");
					                    ...
					                    for(int l=0; l<gnb_list_3.length && l<18; l++){
					                        ...
					                        if("Y".equals(g_indent) && !indentYN){  //들여쓰기여부
					                        	sbGnbList.append("<li class='cate-item--depth5 has--tree'>");
					                        	sbGnbList.append("<ul class='cate-item--tree'>");
					                        	indentYN = true;
					                        }
					                        
					                        if("Y".equals(g_indent)){
					                        	sbGnbList.append("<li class='cate-item--depth5'>");
						                    	sbGnbList.append("	<a href='"+gnb_list_3[l].getG_link()+"' class='cate__tit'  "+insertlog+" >"+gnb_list_3[l].getG_name().replaceAll("\\<(br|BR)/{0,1}\\>",""));
