					        ...
					        if(gnb_list_2!=null && gnb_list_2.length>0){
                              ...
                              String strG_Link = "javascript:";
					            ...
					            for(int k=0; k<gnb_list_2.length && k<14; k++){
					                ...
					                String cate = StringUtils.replace(gnb_list_2[k].getG_link(), "/list.jsp?cate=" , "");
					                String g_link = gnb_list_2[k].getG_link();
					                ...
					                if(k == 0) sbGnbList.append( 	  "<a href='"+g_link+"' onclick='insertLog(24300);'  "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 1) sbGnbList.append( "<a href='"+g_link+"' onclick='insertLog(24301);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 2) sbGnbList.append( "<a href='"+g_link+"' onclick='insertLog(24302);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 3) sbGnbList.append( "<a href='"+g_link+"' onclick='insertLog(24303);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 4) sbGnbList.append( "<a href='"+g_link+"' onclick='insertLog(24304);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 5) sbGnbList.append( "<a href='"+g_link+"' onclick='insertLog(24305);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 6) sbGnbList.append( "<a href='"+g_link+"' onclick='insertLog(24306);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 7) sbGnbList.append( "<a href='"+g_link+"' onclick='insertLog(24307);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 8) sbGnbList.append( "<a href='"+g_link+"' onclick='insertLog(24308);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 9) sbGnbList.append( "<a href='"+g_link+"' onclick='insertLog(24309);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 10) sbGnbList.append("<a href='"+g_link+"' onclick='insertLog(24310);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 11) sbGnbList.append("<a href='"+g_link+"' onclick='insertLog(24311);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 12) sbGnbList.append("<a href='"+g_link+"' onclick='insertLog(24312);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 13) sbGnbList.append("<a href='"+g_link+"' onclick='insertLog(24313);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(k == 14) sbGnbList.append("<a href='"+g_link+"' onclick='insertLog(24314);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
