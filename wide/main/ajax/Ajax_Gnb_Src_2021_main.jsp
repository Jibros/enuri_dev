					        ...
					        if(gnb_list_2!=null && gnb_list_2.length>0){
                              ...
                              //전체보기 버튼
        			        	...
        			        	if(strG_Link != null && strG_Link.length() > 0){
        			        			 ...
        			        			 if(g_seq == 1) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24311);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 2) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24312);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 3) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24313);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 4) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24314);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 5) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24315);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 6) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24316);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 7) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24317);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 8) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24318);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 9) sbGnbList.append( "<a href='"+strG_Link+"' onclick='insertLog(24319);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 10) sbGnbList.append("<a href='"+strG_Link+"' onclick='insertLog(24320);' class='cate__btn--all comm__sprite'>전체보기</a>");
        			        		else if(g_seq == 11) sbGnbList.append("<a href='"+strG_Link+"' onclick='insertLog(24321);' class='cate__btn--all comm__sprite'>전체보기</a>");
					            ...
					            for(int k=0; k<gnb_list_2.length && k<14; k++){
					                ...
					                if(k == 0) sbGnbList.append( 	  "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24300);' >");
        			        		else if(k == 1) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24301);' >");
        			        		else if(k == 2) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24302);' >");
        			        		else if(k == 3) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24303);' >");
        			        		else if(k == 4) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24304);' >");
        			        		else if(k == 5) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24305);' >");
        			        		else if(k == 6) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24306);' >");
        			        		else if(k == 7) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24307);' >");
        			        		else if(k == 8) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24308);' >");
        			        		else if(k == 9) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24309);' >");
        			        		else if(k == 10) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24310);' >");
        			        		else if(k == 11) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24311);' >");
        			        		else if(k == 12) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24312);' >");
        			        		else if(k == 13) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24313);' >");
        			        		else if(k == 14) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24314);' >");
