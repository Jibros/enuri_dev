...
if(stype.equals("")){
			    		...
			    		if(gnb_list_2.length > 0){
					        ...
					        if(gnb_list_2!=null && gnb_list_2.length>0){
					            ...
					            for(int k=0; k<gnb_list_2.length && k<18; k++){
					                ...
					                if( g_seq == 1) sbGnbList.append(  "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24300);'  "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 2) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24301);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 3) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24302);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 4) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24303);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 5) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24304);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 6) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24305);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 7) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24306);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 8) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24307);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 9) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24308);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 10) sbGnbList.append( "<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24309);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
        			        		else if(g_seq == 11) sbGnbList.append("<a href='"+gnb_list_2[k].getG_link()+"' onclick='insertLog(24310);' "+(gnb_list_2[k].getG_link().indexOf("http") > -1 ? "target=\"_blank\"" : "")+">");
					                ...
					                if(gnb_list_3!=null && gnb_list_3.length>0){
					                    ...
					                    for(int l=0; l<gnb_list_3.length && l<18; l++){
					                        ...
					                        if("Y".equals(g_indent) && !indentYN){  //들여쓰기여부
					                        	...
					                        	sbGnbList.append("<ul class='cate--tree'>");
					                        	indentYN = true;
					                        }
					                        
					                        if("Y".equals(g_indent)){
					                        	sbGnbList.append("<li class='cate--tree-item'>");
	...
	for(int i=0; i<gnb_list_0.length; i++){
        ...
        if((i+1) == 1)			insertLog = "onclick='insertLog(24288)'";
        else if((i+1) == 2)		insertLog = "onclick='insertLog(24289)'";
        else if((i+1) == 3)		insertLog = "onclick='insertLog(24290)'";
        else if((i+1) == 4)		insertLog = "onclick='insertLog(24291)'";
        else if((i+1) == 5)		insertLog = "onclick='insertLog(24292)'";
        else if((i+1) == 6)		insertLog = "onclick='insertLog(24293)'";
        else if((i+1) == 7)		insertLog = "onclick='insertLog(24294)'";
        else if((i+1) == 8)		insertLog = "onclick='insertLog(24295)'";
        else if((i+1) == 9)		insertLog = "onclick='insertLog(24296)'";
        else if((i+1) == 10)	insertLog = "onclick='insertLog(24297)'";
        else if((i+1) == 11)	insertLog = "onclick='insertLog(24298)'";
        ...
        if(gnb_list_2!=null && gnb_list_2.length>0){
            ...
            if(moreFlag){
            	sbAllCateList.append("<li class='cate-item--depth3'><a href='"+gnb_list_1[j].getG_link()+"' class='view_morecate'>카테고리 더보기</a></li>");
            }
        }
        ...
        sbAllCateList.append("<li class='cate-item--depth2'></li>");
        sbAllCateList.append("<li class='cate-item--depth2'></li>");
        sbAllCateList.append("<li class='cate-item--depth2'></li>");
        sbAllCateList.append("<li class='cate-item--depth2'></li>");
