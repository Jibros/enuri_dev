...
<%
	...
	*/
	...
	// 비타트라상품 유무
	String strOv = ChkNull.chkStr(request.getParameter("ov"), "");
	if(strOv.equals("Y")) strParamShopCode = "30130"; //비타트라 상품만 노출
...
%>
<%@ include file="/wide/include/IncGroupModelListJsonVitatra.jsp"%>
<%
			// 재검색 옵션 ( 돋보기 )
